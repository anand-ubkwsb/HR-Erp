<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frm_ItemReportOpenning.aspx.cs" Inherits="frm_Period" %>
                ...
                <div class="box box-solid shadowbox " style="border-radius: 15px;">
                    <div class="box-header with-border" style="height: 75px;">
                        <div style="padding-top: 0px; width: 120px; float: left;">
                            <div id="tabmenu">
                                <h3 class="box-title" style="color: #fff; padding-left: 10px;"><strong>REPORT ITEM OPENNING</strong></h3>
                            </div>
                        </div>
                            ...
                            <div id="fieldbox" runat="server">
                                         ...
                                         <table id="tablecontent1" runat="server" style="width: 100%;">
                                            <tr>
                                                ...
                                                <td class="auto-style11">
                                                    <asp:DropDownList ID="ddlBusinessPartner" Width="250px" CssClass=" form-control select2" runat="server" ></asp:DropDownList>
                                                    <asp:RequiredFieldValidator runat="server" ID="req2" ControlToValidate="ddlBusinessPartner" InitialValue="Please select..." Display="None" ErrorMessage="<b> Missing Field</b><br />Please Select Item Head." ValidationGroup="aaa" />
                                            ...
                                            <tr>
                                                ...
                                                <td class="auto-style11">
                                                    ...
                                                    <div style="display:inline-block">
                                                        ...
                                                        <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1" ControlToValidate="txtGLDate" Display="None" ErrorMessage="<b> Missing Field</b><br />A Date is required." ValidationGroup="aaa" />
                                                 ...
                                                 <td class="auto-style6"><strong>Purcahse/Sale<asp:Label ID="lblSteriek" runat="server" Text="" ForeColor="Red"></asp:Label></strong></td>
                                                <td class="auto-style11">
                                                    <asp:Panel ID="Panel1" runat="server">
                                                        <asp:RadioButton ID="rdbpur" Text="Purcahse" runat="server" GroupName="Group_L_I"  />
