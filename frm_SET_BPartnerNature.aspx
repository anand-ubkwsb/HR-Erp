<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frm_SET_BPartnerNature.aspx.cs" Inherits="frm_Period" %>
                ...
                <div class="box box-solid shadowbox " style="border-radius: 15px;">
                    <div class="box-header with-border" style="height:75px;">
                        <div style="padding-top:0px; width: 120px; float: left;">
                            <div id="tabmenu">
                                <h3 class="box-title" style="color: #fff; padding-left: 10px;"><strong>Business Partner Nature</strong></h3>
                            </div>
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="box-body" style="background-color: #cddbf2;">
                            ...
                            <table id="tablecontent1" runat="server" style="width: 100%;">
                                <tr>
                                    <td class="auto-style6"><strong>Business Partner Nature</strong></td>
                                    <td class="auto-style11">
                                        <asp:TextBox ID="txtBPNature" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px" ValidationGroup="aaa"></asp:TextBox>
                                          <asp:RequiredFieldValidator runat="server" ID="Req" ControlToValidate="txtBPNature" Display="None" ErrorMessage="<b> Missing Field</b><br />A name is required." ValidationGroup="aaa" />
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table style="width: 100%;">
                         <tr>
                            <td><strong>Business Partner Nature</strong> </td>
                            <td>
                                <%--<asp:TextBox ID="txtEdit_TaxDescription" CssClass="form-control gap" runat="server"></asp:TextBox>--%>
                                <asp:DropDownList ID="txtEdit_BPnature" CssClass="form-control select2" Width="100%" runat="server"></asp:DropDownList>
                    ...
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:DropDownList ID="txtFind_BpNature" CssClass="form-control select2" Width="100%" runat="server"></asp:DropDownList>
                   ...
                   <table style="width: 100%;">
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:DropDownList ID="txtdelete_BPNature" CssClass="form-control select2" Width="100%" runat="server"></asp:DropDownList>
