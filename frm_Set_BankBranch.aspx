<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frm_Set_BankBranch.aspx.cs" Inherits="frm_Period" %>
                ...
                <div class="box box-solid shadowbox " style="border-radius: 15px;">
                    <div class="box-header with-border" style="height: 75px;">
                        <div style="padding-top: 0px; width: 120px; float: left;">
                            <div id="tabmenu">
                                <h3 class="box-title" style="color: #fff; padding-left: 10px;"><strong>BANK BRANCH</strong></h3>
                            </div>
                        </div>
                                    ...
                                    <ContentTemplate>
                                        <table id="tablecontent1" runat="server" style="width: 100%;">
                                            <tr>
                                                ...
                                                <td class="auto-style6"><strong>Bank branch Name</strong></td>
                                                <td class="auto-style11">
                                                    <asp:TextBox ID="txtBankbranchName" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                                    <asp:RequiredFieldValidator runat="server" ID="Req" ControlToValidate="txtBankbranchName" InitialValue="" Display="None" ErrorMessage="<b> Missing Field</b><br />Please enter bank branch name." ValidationGroup="aaa" />
                                                ...
                                                <td class="auto-style11">
                                                    <asp:DropDownList ID="ddlBankName" CssClass="form-control select2" Width="250px" runat="server"></asp:DropDownList>
                                                    <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1" ControlToValidate="ddlBankName" InitialValue="Please select..." Display="None" ErrorMessage="<b> Missing Field</b><br />Please Select Item Type." ValidationGroup="aaa" />
                                           ...
                                           <tr>
                                                <td class="auto-style6"><strong>Bank Branch Code</strong></td>
                                                <td class="auto-style11">
                                                    <asp:TextBox ID="txtBankBranchCode" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                                </td>
                                                <td class="auto-style6"><strong>Contact Person Name</strong></td>
                                                <td class="auto-style11">
                                                    <asp:TextBox ID="txtContactPersonName" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                            ...
                                            <tr>
                                                ...
                                                <td class="auto-style11">
                                                    <asp:TextBox ID="txtMobileNo" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                                </td>
                                                <td class="auto-style6"><strong>Email</strong></td>
                                                <td class="auto-style11">
                                                    <asp:TextBox ID="txtEmail" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                    ...
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td class="rowpadd" >
                                ...
                                <asp:DropDownList ID="ddlEdit_B_BRAnch" CssClass="form-control select2" Width="100%" runat="server"></asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                     ...
                     <table style="width: 100%;">
                          <tr>
                            ...
                            <td class="rowpadd" >
                                ...
                                <asp:DropDownList ID="ddlFind_B_Branch" CssClass="form-control select2" Width="100%" runat="server"></asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td class="rowpadd"><strong>Bank Name</strong> </td>
                  ...
                  <table style="width: 100%;">
                       <tr>
                            ...
                            <td class="rowpadd" >
                                ...
                                <asp:DropDownList ID="ddlDel_B_Branch" CssClass="form-control select2" Width="100%" runat="server"></asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td class="rowpadd"><strong>Bank Name</strong> </td>
