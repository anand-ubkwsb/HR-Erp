<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frm_SET_UserGrpModule.aspx.cs" Inherits="frm_SET_COA_Master" %>
     ...
     <script>
        function alertme() {
            swal("Insert Successfuly!", "record has been saved!!!", "success")
                .then(function () {
                    window.location = "frm_SET_UserGrpModule.aspx?UserID=" + userid + "&UsergrpID=" + UserGrpID + "&fiscaly=" + fiscal + "&FormID=" + FormID + "";
            });
                ...
                <div class="box box-solid shadowbox " style="border-radius: 15px;">
                    <div class="box-header with-border" style="height:75px;">
                        ...
                        <div style=" padding-top:0px; width:120px;float:left;">
                            <div id="tabmenu">
                                <h3 class="box-title" style="color: #fff; padding-left: 10px;"><strong>User Group Module</strong></h3>
                            </div>
                        </div>
                             ...
                             <div id="fieldbox" runat="server">
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style7">
                                        <div>
                                         <asp:DropDownList ID="lblUserGrpName" CssClass="ddlHeight" Width="250px" runat="server" ></asp:DropDownList>
                                            <%--<asp:Label ID="lblUserGrpName" runat="server" Font-Italic="False" ForeColor="Black"></asp:Label>--%>

                                            <asp:RequiredFieldValidator runat="server" ID="Req2" ControlToValidate="lblUserGrpName" InitialValue="Please select..." Display="None" ErrorMessage="<b> Missing Field</b><br />Please Select User Group Name." ValidationGroup="aaa" />
                                    ...
                                    <td class="auto-style4"><span class="auto-style9">Module </span></td>
                                    <td class="auto-style1 ">
                                       <div>
                                           ...
                                           <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1" ControlToValidate="lblModule" InitialValue="Please select..." Display="None" ErrorMessage="<b> Missing Field</b><br />Please Select Module." ValidationGroup="aaa" />
                                        ...
                                        <%--  ENd Modals --%>
                                         <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover tableFixHead" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" >
                                           <Columns>
                                                ...
                                                <asp:BoundField DataField="Serial" HeaderText="ID" SortExpression="Serial" ReadOnly="True" >
                                                 <HeaderStyle Width="20px" />
                                                 </asp:BoundField>
              ...
              <table style="width: 100%;">
                   <tr>
                        ...
                        <tr>
                            ...
                            <td>
                               <%-- <asp:TextBox ID="txtEdit_Module" CssClass="form-control gap" runat="server"></asp:TextBox>--%>
                                <asp:DropDownList ID="txtEdit_Module" CssClass="form-control select2" width="100%"  runat="server"></asp:DropDownList>
                ...
                <table style="width: 100%;">
                    <tr>
                        ...
                        <tr>
                            <td><strong>Module</strong> </td>
                            <td>
                                <%--<asp:TextBox ID="txtFind_Module" CssClass="form-control gap" runat="server"></asp:TextBox>--%>
                                <asp:DropDownList ID="txtFind_Module" CssClass="form-control select2" width="100%"  runat="server"></asp:DropDownList>
                            </td>
                     ...
                     <table style="width: 100%;">
                         <tr>
                            ...
                            <td>
                               ...
                               <%-- <asp:TextBox ID="txtDelete_UserGrpName" CssClass="form-control gap" runat="server"></asp:TextBox>--%>
                                <asp:DropDownList ID="txtDelete_UserGrpName" CssClass="form-control select2" width="100%"  runat="server"></asp:DropDownList>
                            </td>
                        ...
                        <tr>
                            <td><strong>Module</strong> </td>
                            <td>
                               <%-- <asp:TextBox ID="txtDelete_Module" CssClass="form-control gap " runat="server"></asp:TextBox>--%>
                                <asp:DropDownList ID="txtDelete_Module" CssClass="form-control select2" width="100%"  runat="server"></asp:DropDownList>
                            </td>
