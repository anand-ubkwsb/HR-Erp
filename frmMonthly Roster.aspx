<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frmMonthly Roster.aspx.cs" Inherits="frm_Period" %>
                ...
                <div class="box box-solid shadowbox " style="border-radius: 15px;">
                    <div class="box-header with-border" style="height: 75px;">
                        <div style="padding-top: 0px; width: 120px; float: left;">
                            <div id="tabmenu">
                                <h3 class="box-title" style="color: #fff; padding-left: 10px;"><strong>Monthly Roster</strong></h3>
                            </div>
                        </div>
                            ...
                            <div id="fieldbox" runat="server">
                                ...
                                <table id="tablecontent1" runat="server" style="width: 100%;">
                                     ...
                                     <tr>
                                               ...
                                               <td class="auto-style6"><strong>EmpID From</strong></td>
                                                <td class="auto-style1">
                                    ...
                                    <tr>
                                                <td class="auto-style6"><strong>EmpID. To</strong></td>
                                                <td class="auto-style1">
                                               ...
                                               <td class="auto-style6"><strong>Shift</strong></td>
                                                <td class="auto-style1">
                                    ...
                                    <tr>
                                                ...
                                                <td class="auto-style1">
                                                    <asp:RadioButton ID="RadioButton1" runat="server" Text="Department" />
                                                     
                                                     
                                                </td>
                                                <td>
                                                    <asp:RadioButton ID="RadioButton2" runat="server" Text="Emp wise" />
                                                </td>
                                                <td></td>
                                               <td class="auto-style6">&nbsp;</td>
                                                <td class="auto-style1">
