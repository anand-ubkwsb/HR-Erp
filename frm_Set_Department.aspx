<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frm_Set_Department.aspx.cs" Inherits="frm_Period" %>
                ...
                <div class="box box-solid shadowbox " style="border-radius: 15px;">
                    <div class="box-header with-border" style="height:75px;">
                        <div style="padding-top:0px; width: 120px; float: left;">
                            <div id="tabmenu">
                                <h3 class="box-title" style="color: #fff; padding-left: 10px;"><strong>DEPARTMENT</strong></h3>
                            </div>
                        </div>
                        <div style="height: 60px; width: 650px; margin-left: 310px;"">
                            <asp:LinkButton ID="btnInsert" Height="40" CssClass="btn btn-app btn123" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing Order" runat="server" Style="left: 180px; background-color: #1f4f8a; color: white;" OnClick="btnInsert_Click" ValidationGroup="changest">
                        ...
                        <div class="box-body" style="background-color: #cddbf2;">
                            ...
                            <table id="tablecontent1" runat="server" style="width: 100%;">
                                <tr>
                                    ...
                                    <td class="padspace">
                                        <asp:TextBox ID="txtDeparment" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px" OnTextChanged="txtDeparment_TextChanged" AutoPostBack="True"></asp:TextBox>
                                        <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator2" ControlToValidate="txtDeparment" Display="None" ErrorMessage="<b> Missing Field</b><br />A Department Name is required." ValidationGroup="aaa" />
                                ...
                                <tr>
                                    ...
                                    <td class="padspace">
                                        <div class="backcolorlbl texthieht">
                                            <asp:Label ID="lblUserName" runat="server" Font-Italic="False" ForeColor="Black"></asp:Label>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style8">
                                        <div class="backcolorlbl texthieht">
                                            <asp:Label ID="lblSysdate" runat="server" Font-Italic="False" ForeColor="Black"></asp:Label>
                                        </div>
                                    </td>
                                     <td class="auto-style3"><span class="auto-style9">Is Warehouse?</span></td>
                                    <td class="auto-style8">
                                        <asp:Panel ID="Panel2" runat="server">
                                            <asp:CheckBox ID="chkwarehouse" runat="server" Text="Yes" OnCheckedChanged="chkwarehouse_CheckedChanged" AutoPostBack="True" />
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        </asp:Panel>
                                    </td>
                                </tr>
                                 <tr>
                                    <td class="auto-style10">Location</td>
                                    <td class="padspace">
                                       
                                            <div class="backcolorlbl texthieht">
                                            <asp:Label ID="lblLocation" runat="server" Font-Italic="False" ForeColor="Black"></asp:Label>
                                        </div>
                                       
                                    </td>
                                    <td class="auto-style10">Location Name</td>
                                    <td class="padspace">
                                        <asp:TextBox ID="txtLoctaionName" CssClass="form-control texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black"></asp:TextBox>
                                        </td>
                                   
                                    
                                </tr>
                                <tr>
                                    <td class="auto-style10">Location Description</td>
                                    <td class="padspace">
                                        <asp:TextBox ID="txtLocationDesc" CssClass="form-control texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black"></asp:TextBox>
                                        </td>
                ...
                <div class="modal-body">
                    ...
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td>
                                <%--<asp:TextBox ID="txtEdit_DepartName" CssClass="form-control gap" runat="server"></asp:TextBox>--%>
                                 <asp:DropDownList ID="txtEdit_DepartName" CssClass="form-control select2" Width="100%" runat="server"></asp:DropDownList>

                               
                                </td>
                            </tr>
                        <tr><td><strong>Location Name :</strong> </td>
                            <td>
                                <asp:TextBox ID="txtEdit_LocationName" CssClass="form-control gap" runat="server"></asp:TextBox>
                            </td>

                        </tr>
                         <tr>
                            <td><strong>IswareHouse? :</strong> </td>
                            <td>
                                  <asp:CheckBox ID="chkEdit_ISwareHouse" runat="server" Checked="false" Text="Active" />
                            </td>
                ...
                <div class="modal-body">
                    ...
                    <table style="width: 100%;">
                       <tr>
                            <td><strong>Department Name :</strong> </td>
                            <td>
                                <%--<asp:TextBox ID="txtFind_Departname" CssClass="form-control gap" runat="server"></asp:TextBox>--%>
                                <asp:DropDownList ID="txtFind_Departname" CssClass="form-control select2" Width="100%" runat="server"></asp:DropDownList>
                               
                                </td>
                            </tr>
                        <tr><td><strong>Location Name :</strong> </td>
                            <td>
                                <asp:TextBox ID="txtFind_Location" CssClass="form-control gap" runat="server"></asp:TextBox>
                            </td>
                         ...
                         <tr>
                            <td><strong>IswareHouse? :</strong> </td>
                            <td>
                                  <asp:CheckBox ID="chkFind_IswareHouse" runat="server" Checked="false" Text="Active" />
                            </td>
                ...
                <div class="modal-body">
                   ...
                   <table style="width: 100%;">
                      <tr>
                            <td><strong>Department Name :</strong> </td>
                            <td>
                                <%--<asp:TextBox ID="txtDelete_DepartName" CssClass="form-control gap" runat="server"></asp:TextBox>--%>
                                <asp:DropDownList ID="txtDelete_DepartName" CssClass="form-control select2" Width="100%" runat="server"></asp:DropDownList>
                               
                                </td>
                            </tr>
                        <tr><td><strong>Location Name :</strong> </td>
                            <td>
                                <asp:TextBox ID="txtDelete_Location" CssClass="form-control gap" runat="server"></asp:TextBox>
                            </td>
                         ...
                         <tr>
                            <td><strong>IswareHouse? :</strong> </td>
                            <td>
                                  <asp:CheckBox ID="chkDelete_Isware" runat="server" Checked="false" Text="Yes" />
