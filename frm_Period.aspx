<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frm_Period.aspx.cs" Inherits="frm_Period" %>
    ...
    <script>
        function alertme() {
            swal("Insert Successfuly!", "record has been saved!!!", "success")
                .then(function () {
                    window.location = "frm_Period.aspx?UserID=" + userid + "&UsergrpID=" + UserGrpID + "&fiscaly=" + fiscal + "&FormID=" + FormID + "";
            });
                    ...
                    <div class="form-row">
                        ...
                        <div class="box-body" style="background-color: #cddbf2;">
                            ...
                            <table id="tablecontent1" runat="server" style="width: 100%;">
                                <tr>
                                    <td class="auto-style6"><strong>Period Id:</strong></td>
                                    <td class="auto-style7">
                                        <div class="backcolorlbl">
                                            <asp:Label ID="lblPeriod_Id" runat="server" Font-Bold="True" Font-Italic="False" ForeColor="Black"></asp:Label>

                                        </div>
                                    </td>
                                    <td class="auto-style4"><span class="auto-style9">Period Description</span></td>
                                    <td class="auto-style1 ">
                                        <asp:TextBox ID="txtPeriod_Description" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="auto-style3"><span class="auto-style9">Start Date</span></td>
                                    <td class="auto-style8">
                                            ...
                                            <div style="display:inline-block">
                                                        ...
                                                        <div class="input-group input-group-sm">
                                                            <asp:TextBox ID="txtStart_Date" CssClass="form-control texthieht" Width="220px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black"  ValidationGroup="aaa"></asp:TextBox>
                                                             <ajaxToolkit:CalendarExtender ID="CalendarExtender1" PopupButtonID="ImageButton1" TargetControlID="txtStart_Date" Format="dd-MMM-yyyy" runat="server" />
                                                        <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1" ControlToValidate="txtStart_Date" Display="None" ErrorMessage="<b> Missing Field</b><br />A Date is required." ValidationGroup="aaa" />
                                    ...
                                    <td class="auto-style5"><strong>End Date</strong></td>
                                    <td>

                                        <%--<asp:TextBox ID="txtEnd_Date" CssClass="form-control texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" OnTextChanged="txtEnd_Date_TextChanged" AutoPostBack="True"></asp:TextBox>
                                        <ajaxToolkit:CalendarExtender ID="CalendarExtender2" runat="server" Enabled="True" TargetControlID="txtEnd_Date" Format="dd-MMM-yyyy"/>--%>
                                            ...
                                            <div style="display:inline-block">
                                                        ...
                                                        <div class="input-group input-group-sm">
                                                            <asp:TextBox ID="txtEnd_Date" CssClass="form-control texthieht" Width="220px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black"  ValidationGroup="aaa"></asp:TextBox>
                                                             <ajaxToolkit:CalendarExtender ID="CalendarExtender2" PopupButtonID="ImageButton2" TargetControlID="txtEnd_Date" Format="dd-MMM-yyyy" runat="server" />
                                                        <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator2" ControlToValidate="txtEnd_Date" Display="None" ErrorMessage="<b> Missing Field</b><br />A Date is required." ValidationGroup="aaa" />
                                ...
                                <tr>
                                    <td class="auto-style5"><strong>No. of Fiscal Years in this period</strong></td>
                                    <td class="padspace">
                                        <div class="backcolorlbl">
                                            <asp:Label ID="lblNo_of_Fiscal_Years" runat="server" Font-Italic="False" ForeColor="Black"></asp:Label>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td class="auto-style3"><span class="auto-style9">Db Name</span></td>
                                    <td class="auto-style8">
                                        <div class="backcolorlbl">
                                            <asp:Label ID="lblDb_Name" runat="server" Font-Italic="False" ForeColor="Black"></asp:Label>
                                        </div>
                                    </td>
                                    ...
                                    <td class="padspace">
                                        ...
                                        <ajaxToolkit:CalendarExtender ID="CalendarExtender3" runat="server" Enabled="True" TargetControlID="txtEntry_Date" Format="dd-MMM-yyyy"/>--%>
                                         ...
                                         <div style="display:inline-block">
                                                        ...
                                                        <div class="input-group input-group-sm">
                                                            <asp:TextBox ID="txtEntry_Date" CssClass="form-control texthieht" Width="220px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black"  ValidationGroup="aaa"></asp:TextBox>
                                                             <ajaxToolkit:CalendarExtender ID="CalendarExtender3" PopupButtonID="imgPopup" TargetControlID="txtEntry_Date" Format="dd-MMM-yyyy" runat="server" />
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style8">
                                        <div class="backcolorlbl texthieht">
                                            <asp:Label ID="lblSystem_Date" runat="server" Font-Italic="False" ForeColor="Black"></asp:Label>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style10">Company Name</td>
                                    <td class="padspace">
                                        ...
                                        <asp:DropDownList ID="ddlCompany_Name" CssClass="ddlHeight" Width="250px" runat="server" AutoPostBack="True"></asp:DropDownList>
                                    </td>
                ...
                <div class="modal-body">
                    ...
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td>
                                <%--<asp:TextBox ID="txtEdit_PDID" CssClass="form-control gap" runat="server"></asp:TextBox>--%>
                                <asp:DropDownList ID="txtEdit_PDID" CssClass="form-control select2" Width="100%" runat="server"></asp:DropDownList>
                               
                                </td>
                            </tr>
                        <tr><td><strong>Start date :</strong> </td>
                            <td>
                                <%--<asp:TextBox ID="txtEdit_SD" CssClass="form-control gap" runat="server"></asp:TextBox>--%>

                                <div style="display:inline-block">

                                                        <div class="input-group input-group-sm">
                                                            <asp:TextBox ID="txtEdit_SD" CssClass="form-control texthieht" Width="420px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black"  ValidationGroup="aaab"></asp:TextBox>
                                                            <ajaxToolkit:CalendarExtender ID="CalendarExtender6" PopupButtonID="ImageButton5" TargetControlID="txtEdit_SD" Format="dd-MMM-yyyy" runat="server" />
                                                        <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator4" ControlToValidate="txtEdit_SD" Display="None" ErrorMessage="<b> Missing Field</b><br />A Date is required." ValidationGroup="aaab" />
                    ...
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:DropDownList ID="txtUserIdEdit" CssClass="form-control select2" Width="100%" runat="server"></asp:DropDownList>
                            ...
                            <td>
                                <%--<asp:TextBox ID="txtSD" CssClass="form-control gap" runat="server"></asp:TextBox>--%>
                                 ...
                                 <div style="display:inline-block">
                                                        ...
                                                        <div class="input-group input-group-sm">
                                                            <asp:TextBox ID="txtSD" CssClass="form-control texthieht" Width="420px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black"  ValidationGroup="aaab"></asp:TextBox>
                                                            <ajaxToolkit:CalendarExtender ID="CalendarExtender5" PopupButtonID="ImageButton3" TargetControlID="txtSD" Format="dd-MMM-yyyy" runat="server" />
                                                        <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator6" ControlToValidate="txtSD" Display="None" ErrorMessage="<b> Missing Field</b><br />A Date is required." ValidationGroup="aaab" />
                ...
                <div class="modal-body">
                   ...
                   <table style="width: 100%;">
                        <tr>
                            <td><strong>Period :</strong> </td>
                            <td>
                                <%--<asp:TextBox ID="txtdelete_PeriodID" CssClass="form-control gap" runat="server"></asp:TextBox>--%>
                                <asp:DropDownList ID="txtdelete_PeriodID" CssClass="form-control select2" Width="100%" runat="server"></asp:DropDownList>
                               
                                </td>
                            </tr>
                        <tr><td><strong>Start date :</strong> </td>
                            <td>
                                <%--<asp:TextBox ID="txtdelete_StartDate" CssClass="form-control gap" runat="server"></asp:TextBox>--%>
                                  <div style="display:inline-block">

                                                        <div class="input-group input-group-sm">
                                                            <asp:TextBox ID="txtdelete_StartDate" CssClass="form-control texthieht" Width="420px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black"  ValidationGroup="aaab"></asp:TextBox>
                                                            <ajaxToolkit:CalendarExtender ID="CalendarExtender4" PopupButtonID="ImageButton4" TargetControlID="txtdelete_StartDate" Format="dd-MMM-yyyy" runat="server" />
                                                        <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator3" ControlToValidate="txtdelete_StartDate" Display="None" ErrorMessage="<b> Missing Field</b><br />A Date is required." ValidationGroup="aaab" />
