...
public partial class frm_Period : System.Web.UI.Page
{
    ...
    protected void btn_delete_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            squer = squer + " where " + swhere + " and Record_Deleted = 0 and  [DocID] = '11' and    [GocID] = '" + gocid() + "' and [BranchId]='" + branchId() + "' and  [FiscalYearID] = '" + FiscalYear() + "' and CompId = '" + compid() + "'  ORDER BY DocDescription";
        ...
        try
        {
            if (e.CommandName.Equals("AddNew"))
            {
                foreach (GridViewRow g in GridView6.Rows)
                {
                    ...
                    string txtRemarksFooter = (GridView6.FooterRow.FindControl("txtRemarksFooter") as TextBox).Text;
                    ...
                    if (ll.Text == ItemSubHeadName && l.Text == Description)
                    {
                        ...
                        dt.Rows.Add(Accode, PONoFooter, ItemSubHeadName, Description, UOM, Qty, DCQtyFooter, Rate, Value, CostCenter, Location, Project, WarranteeFooter, txtRemarksFooter, Qty2, Rate2);
