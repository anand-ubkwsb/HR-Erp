<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frm_ItemSubHead .aspx.cs" Inherits="frm_Period" %>
                ...
                <div class="box box-solid shadowbox " style="border-radius: 15px;">
                    <div class="box-header with-border" style="height: 75px;">
                        <div style="padding-top: 0px; width: 120px; float: left;">
                            <div id="tabmenu">
                                <h3 class="box-title" style="color: #fff; padding-left: 10px;"><strong>Item Sub Head</strong></h3>
                            </div>
                        </div>
                        ...
                        <div class="box-body" style="background-color: #cddbf2;">
                            <div id="fieldbox" runat="server">
                                        ...
                                        <table id="tablecontent1" runat="server" style="width: 100%;">
                                            <tr>
                                                <td class="auto-style6"><strong>Item Sub Head Name</strong></td>
                                                <td class="auto-style11">
                                                    <asp:TextBox ID="txtItemSubName" CssClass="form-control" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black"  ValidationGroup="aaa"></asp:TextBox>
                                                    <asp:RequiredFieldValidator runat="server" ID="Req" ControlToValidate="txtItemSubName" Display="None" ErrorMessage="<b> Missing Field</b><br />A Sub Head Name is required." ValidationGroup="aaa" />
                                       <ajaxToolkit:ValidatorCalloutExtender ID="ValidatorCalloutExtender1" TargetControlID="Req" runat="server" HighlightCssClass="vali"></ajaxToolkit:ValidatorCalloutExtender>
                                                ...
                                                <td class="auto-style14">Item Head</td>
                                                <td class="auto-style12">
                                                    <div >
                                                          <asp:DropDownList ID="ddlItemHead" CssClass="form-control  select2"  Width="250px" runat="server"></asp:DropDownList>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                               <td class="auto-style3"><span class="auto-style9">Active</span></td>
                                                ...
                                                <td class="auto-style11">
                                                  ...
                                                  <td class="auto-style13"><strong>Image</strong></td>
                                                <td class="auto-style12">
                                                    <div class="linee">
                                            ...
                                            <tr>
                                                ...
                                                <td class="auto-style14">Created Date</td>
                                                <td class="auto-style12">
                                            ...
                                            <tr id="updatecol" runat="server">
                                                ...
                                                <td class="auto-style14">Updated Date</td>
                                                <td class="auto-style12">
                                        ...
                                        <div style="width: 100%; height: 400px; overflow: scroll">
                                            ...
                                            <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover tableFixHead" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="ItemSubHeadID" HeaderText="ID" SortExpression="ItemSubHeadID">
                                                    <HeaderStyle Width="20px" />
                                                    </asp:BoundField>
                ...
                <div class="modal-body">
                    ...
                    <table style="width: 100%;">
                          <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlEdit_ItemType" CssClass="select2"  Width="100%" runat="server"></asp:DropDownList>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlEdit_ItemHead" CssClass="select2"  Width="100%" runat="server"></asp:DropDownList>
                ...
                <div class="modal-body">
                    ...
                    <table style="width: 100%;">
                         <tr>
                            <td><strong>Item Type</strong> </td>
                            <td>
                                <asp:DropDownList ID="ddlFind_ItemType" CssClass="select2"  Width="100%" runat="server"></asp:DropDownList>
                        ...
                        <tr>
                            <td><strong>Item Head Name</strong> </td>
                            <td>
                                <asp:DropDownList ID="ddlFind_ItemHead" CssClass="select2"  Width="100%" runat="server"></asp:DropDownList>
                ...
                <div class="modal-body">
                    ...
                    <table style="width: 100%;">
                         <tr>
                            <td><strong>Item Type</strong> </td>
                            <td>
                                <asp:DropDownList ID="ddldel_ItemType" CssClass="select2"  Width="100%" runat="server"></asp:DropDownList>
                        ...
                        <tr>
                            <td><strong>Item Head Name</strong> </td>
                            <td>
                                <asp:DropDownList ID="ddlDel_ItemHead" CssClass="select2"  Width="100%" runat="server"></asp:DropDownList>
