...
public partial class frm_Period : System.Web.UI.Page
{
    ...
    protected void btn_delete_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            squer = squer + " where " + swhere + " and Record_Deleted = 0 and  [DocID] = '12' and    [GocID] = '" + gocid() + "' and [BranchId]='" + branchId() + "' and  [FiscalYearID] = '" + FiscalYear() + "' and CompId = '" + compid() + "'  ORDER BY DocDescription";
    ...
    protected void GridView2_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                DataTable dtup = new DataTable();
                dtup.Columns.AddRange(new DataColumn[16] { new DataColumn("Sno"), new DataColumn("DrAccountCode"), new DataColumn("ItemSubHeadName"), new DataColumn("Description"), new DataColumn("UOMName"), new DataColumn("pobal"), new DataColumn("pobal1"), new DataColumn("Rate"), new DataColumn("Value"), new DataColumn("CostCenterName"), new DataColumn("LocName"), new DataColumn("Project"), new DataColumn("Warrentee"), new DataColumn("uomName2"), new DataColumn("Qty2"), new DataColumn("Rate2") });
    ...
    public void detailinsert(string masterid)
    {
        ...
        foreach (GridViewRow g in GridView6.Rows)
        {
            ...
            Label lblRemarks = (Label)g.FindControl("lblUOM2");
            //lblUOM2
            ...
            DataSet ds5 = dml.Find("select DepartmentID,DepartmentName from SET_Department where DepartmentName = '" + lblLocation.Text + "'");
            if (ds5.Tables[0].Rows.Count > 0)
            {
                location = ds5.Tables[0].Rows[0]["DepartmentID"].ToString();
            }
            else
            {
                location = "0";
            ...
            if (trantype == "Debit")
            {
                ...
                DataSet dsinsertdetail = dml.Find("INSERT INTO Inv_InventoryOutDetail ( [Sno_Master],  [DrAccountCode],  [ItemSubHead],"
                                       ...
                                       + " '" + lblRate.Text + "', '" + lblValue.Text + "', '"+ lblRemarks.Text+ "', NULL, NULL,"
        ...
        if (dbcr == "Debit Impact")
        {
            ...
            dml.Update("UPDATE Inv_InventoryOutDetail set GLReferNo = '" + ids + "' where = Sno = '" + masterid + "'", "");
    ...
    protected void GridView6_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            if (e.CommandName.Equals("AddNew"))
            {
                    ...
                    string UOM2 = (GridView6.FooterRow.FindControl("txtRemarksFooter") as TextBox).Text;
    ...
    protected void GridView6_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        try
        {
            ...
            string UOM2 = (GridView6.Rows[e.RowIndex].FindControl("txtRemarksEdit") as TextBox).Text;
            ...
            dt.Rows[row.DataItemIndex]["Remarks"] = UOM2;
    ...
    public void detailinsertEdit(string masterid)
    {
        ...
        foreach (GridViewRow g in GridView10.Rows)
        {
            ...
            Label lblAccountcode = (Label)g.FindControl("lblAcctCode");
            Label lblPONo = (Label)g.FindControl("lblPoNEdit");
            Label lblItemSubHead = (Label)g.FindControl("lblItemSubHead");
            Label lblitemmaster = (Label)g.FindControl("lblItemMaster");
            Label lbluom = (Label)g.FindControl("lblUOM");
            TextBox lblPObalQty = (TextBox)g.FindControl("txtPObalQty");
            TextBox lblDCQty = (TextBox)g.FindControl("txtDCQty");
            TextBox lblRate = (TextBox)g.FindControl("lblRateEdit");
            TextBox lblValue = (TextBox)g.FindControl("txtValueEdit");

            Label lblCostCenter = (Label)g.FindControl("lblCostCenterEdit");
            Label lblLocation = (Label)g.FindControl("lblLocationEdit");
            Label lblProject = (Label)g.FindControl("lblProjectEdit");

            Label lblWarrantee = (Label)g.FindControl("lblWarranteeEdit");
           // Label lblUOM2 = (Label)g.FindControl("lblUOM2");
            ...
            //
            //select ItemSubHeadID, ItemSubHeadName from SET_ItemSubHead lblproject
            dml.Update("update Inv_InventoryOutDetail set Quantity='"+ lblDCQty.Text+ "',[Value]='"+ lblValue.Text+ "', Rate='"+lblRate.Text+"' where Sno_Master = '"+ masterid + "'", "");
            DataSet ds = dml.Find("select ItemSubHeadID, ItemSubHeadName from SET_ItemSubHead where ItemSubHeadName = '" + lblItemSubHead.Text + "'");
            string subhead, itemmaster, uom1, uom2, costcenter, location, itemcode, itemtypeid;
            if (ds.Tables[0].Rows.Count > 0)
            {
            ...
            if (trantype == "Debit")
            {
                ...
                //gl Detail entry
                gl.GlentryInsertofTransferIN(ddlDocName.SelectedItem.Value, doctype, ddlDocName.SelectedItem.Text, masterid, detailid, dml.dateconvertforinsertNEW(txtEntryDate), txtDocNo.Text, lblAccountcode.Text, txtShopOffName.Text, txtDeliveryChallan.Text, txtDeliveryChallanDate.Text, lblValue.Text, "0", txtRemarks.Text, gocid().ToString(), compid().ToString(), branchId().ToString(), FiscalYear().ToString(), show_username(), DateTime.Now.ToString("dd-MMM-yyy hh:mm:ss.ffff"), itemcode, lblDCQty.Text, "0", "Inv_InventoryOutDetail");
        ...
        if (dbcr == "Debit Impact")
        {
            gl.GlentryInsert(ddlDocName.SelectedItem.Value, doctype, ddlDocName.SelectedItem.Text, masterid, "0", dml.dateconvertforinsertNEW(txtEntryDate), txtDocNo.Text, RadComboAcct_Code.Text, "0", "0", txtShopOffName.Text, txtDeliveryChallan.Text, "1900-01-01", totalcrdb.ToString(), "0", txtRemarks.Text, gocid().ToString(), compid().ToString(), branchId().ToString(), FiscalYear().ToString(), show_username(), DateTime.Now.ToString("dd-MMM-yyyy hh:mm:ss.ffff"), "0", "0", "0", "Inv_InventoryOutDetail");

        }
        else
        {
            gl.GlentryInsert(ddlDocName.SelectedItem.Value, doctype, ddlDocName.SelectedItem.Text, masterid, "0", dml.dateconvertforinsertNEW(txtEntryDate), txtDocNo.Text, RadComboAcct_Code.Text, "0", "0", txtShopOffName.Text, txtDeliveryChallan.Text, "1900-01-01", "0", totalcrdb.ToString(), txtRemarks.Text, gocid().ToString(), compid().ToString(), branchId().ToString(), FiscalYear().ToString(), show_username(), DateTime.Now.ToString("dd-MMM-yyyy hh:mm:ss.ffff"), "0", "0", "0", "Inv_InventoryOutDetail");
    ...
    protected void txtRateEdit_TextChanged(object sender, EventArgs e)
    {
        ...
        //lbltxt
       // (row.FindControl("lbltxt") as Label).Text = Qty.ToString();
        (row.FindControl("txtValueEdit") as TextBox).Text = value.ToString();
    }
