<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frm_FinishedGoodsInv_Reversal.aspx.cs" Inherits="frm_Period"  EnableEventValidation="false"%>
                ...
                <div class="box box-solid shadowbox " style="border-radius: 15px;">
                    <div class="box-header with-border" style="height: 75px;">
                        <div style="padding-top: 0px; width: 120px; float: left;">
                            <div id="tabmenu">
                                <h3 class="box-title" style="color: #fff; padding-left: 10px;"><strong>FINISHED GOODS REVERSAL FORM</strong></h3>
                            </div>
                        </div>
                            ...
                            <div id="fieldbox" runat="server">
                                ...
                                <table id="tablecontent1" runat="server" style="width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td class="auto-style6"><strong>Finished Goods - IN #</strong></td>
                                        <td class="auto-style11">
                                    ...
                                    <ContentTemplate>
                                        <asp:GridView ID="GridView4" AutoGenerateColumns="False" CssClass="table table-bordered table-hover tableFixHead" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" runat="server" DataKeyNames="Sno" OnRowDataBound="GridView4_RowDataBound" OnRowCancelingEdit="GridView4_RowCancelingEdit" OnRowEditing="GridView4_RowEditing" OnRowUpdating="GridView4_RowUpdating">
                                             <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Rate" SortExpression="CostCenter" Visible="true" ItemStyle-HorizontalAlign="Right" >
                                                ...
                                                <asp:TemplateField HeaderText="Value" SortExpression="Project" Visible="true" ItemStyle-HorizontalAlign="Right" >
                                                    <EditItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Rate2" SortExpression="Project" Visible="false">
                                                    <EditItemTemplate>
                                                        ...
                                                        <asp:Label ID="lblRate2Edit" runat="server" Enabled="false" Visible="false" Text='<%# Bind("Rate2","{0:0.00}") %>'></asp:Label>
                                                    </EditItemTemplate>
                                                    <ItemTemplate>
