<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frmBasicSample.aspx.cs" Inherits="frm_Period" %>
                ...
                <div class="box box-solid shadowbox " style="border-radius: 15px;">
                    <div class="box-header with-border" style="height: 75px;">
                        <div style="padding-top: 0px; width: 120px; float: left;">
                            <div id="tabmenu">
                                <h3 class="box-title" style="color: #fff; padding-left: 10px;"><strong>Employee Barcode Card</strong></h3>
                            </div>
                        </div>
                        ...
                        <div class="box-body" style="background-color: #cddbf2;">
                            <div id="fieldbox" runat="server">
                                ...
                                <table id="tablecontent1" runat="server" style="width: 100%;">
                                      <tr>
                                                <td class="auto-style1"><strong>Employee #</strong></td>
                                               ...
                                               <td class="auto-style1"><strong>Trans Status</strong></td>
                                                <td class="auto-style1">
                                     ...
                                     <tr>
                                                <td class="auto-style6"><strong>Empolyee Name </strong></td>
                                                <td class="auto-style1">
                                               ...
                                               <td class="auto-style6"><strong>File #</strong></td>
                                                <td class="auto-style1">
                                    ...
                                    <tr>
                                               ...
                                               <td class="auto-style6"><strong>Department</strong></td>
                                                <td class="auto-style1">
                                                     <asp:DropDownList ID="ddldepart" Width="250px" CssClass=" form-control select2" runat="server" ValidationGroup="aaa"></asp:DropDownList>
                                                    
                                                   </td>  
                                     </tr>
                                  
                                     <tr>
                                                <td class="auto-style6"><strong>Appointment Date </strong></td>
                                                <td class="auto-style1">
                                               ...
                                               <td class="auto-style6"><strong>Salary Code</strong></td>
                                                <td class="auto-style1">
                                     ...
                                     <tr>
                                                <td class="auto-style6"><strong>Office / Production </strong></td>
                                                <td class="auto-style1">
                                                    <asp:DropDownList ID="ddlOffice" Width="250px" CssClass=" form-control select2" runat="server" ValidationGroup="aaa"></asp:DropDownList>
                                                     
                                                     
                                                </td>
                                               <td class="auto-style6"><strong>Shift Code</strong></td>
                                                <td class="auto-style1">
                                                     <asp:DropDownList ID="ddlShiftCode" Width="250px" CssClass=" form-control select2" runat="server" ValidationGroup="aaa"></asp:DropDownList>
                                                    
                                                   </td>  
                                     </tr>

                                     <tr>
                                                <td class="auto-style6"><strong>Employee Type</strong></td>
                                                <td class="auto-style1">
                                                    <asp:DropDownList ID="ddlemptype" Width="250px" CssClass=" form-control select2" runat="server" ValidationGroup="aaa"></asp:DropDownList>
                                                     
                                                     
                                                </td>
                                               <td class="auto-style6"><strong>C.N.I.C #</strong></td>
                                                <td class="auto-style1">
                                                     <asp:TextBox ID="txtCNIC" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                                    
                                                   </td>  
                                     </tr>
                                        
                                     <tr>
                                                <td class="auto-style6"><strong>Phone NO</strong></td>
                                                <td class="auto-style1">
                                                    <asp:TextBox ID="txtphoneNo" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                                     
                                                     
                                                </td>
                                               <td class="auto-style6"><strong>Left Date</strong></td>
                                                <td class="auto-style1">
                                                     <asp:TextBox ID="txtLeftDate" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                                    
                                                   </td>  
                                          <td class="auto-style6"><strong>Sex</strong></td>
                                                <td class="auto-style1">
                                                    <asp:TextBox ID="txtSex" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
