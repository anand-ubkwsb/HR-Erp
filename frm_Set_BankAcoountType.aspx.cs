...
public partial class frm_Period : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Page.IsPostBack == false)
        {
            ...
            dml.dropdownsql(ddlEdit_MenuTitle, "SET_BankAccountType", "BankAcctTypeName", "BankAcctTypeID");
            dml.dropdownsql(ddlFind_MenuName, "SET_BankAccountType", "BankAcctTypeName", "BankAcctTypeID");
            dml.dropdownsql(ddlDel_MenuName, "SET_BankAccountType", "BankAcctTypeName", "BankAcctTypeID");
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        DataSet uniqueg_B_C = dml.Find("select * from SET_BankAccountType where BankAcctTypeName = '" + txtBankAccountType.Text + "' and Record_Deleted = '0'");
        if (uniqueg_B_C.Tables[0].Rows.Count > 0)
        {
            ...
            dml.Insert("INSERT INTO SET_BankAccountType ([BankAcctTypeName], [CreatedBy], [CreateDate],[Record_Deleted], [IsActive],[MLD]) VALUES ('"+txtBankAccountType.Text+"', '"+show_username()+"', '"+DateTime.Now.ToString("dd-MMM-yyyy hh:mm:ss.ffff")+"', '0', '"+chk+"','"+dml.Encrypt("h")+"');", "");
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds_up = dml.Find("select * from SET_BankAccountType WHERE ([BankAcctTypeID]='" + ViewState["SNO"].ToString()+ "') AND ([BankAcctTypeName]='" + txtBankAccountType.Text+"') AND ([IsActive]='"+chk+"')");
        ...
        dml.Update("UPDATE SET_BankAccountType SET [BankAcctTypeName]='" + txtBankAccountType.Text + "', [UpdatedBy]='" + show_username() +"', [UpdateDate]='"+DateTime.Now.ToString("dd-MMM-yyyy hh:mm:ss.ffff")+"', [IsActive]='"+chk+"' WHERE ([BankAcctTypeID]='"+ViewState["SNO"].ToString()+"')", "");
    ...
    protected void btn_delete_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            GridView2.DataBind();
            string swhere = "";
            string squer = "select * from SET_BankAccountType";


            if (ddlDel_MenuName.SelectedIndex != 0)
            {
                swhere = "BankAcctTypeName = '" + ddlDel_MenuName.SelectedItem.Text + "'";
            }
            else
            {
                swhere = "BankAcctTypeName is not null";
            }
            ...
            squer = squer + " where " + swhere + " and Record_Deleted = 0  ORDER BY BankAcctTypeName";
    ...
    protected void btn_Search_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                swhere = "BankAcctTypeName = '" + ddlFind_MenuName.SelectedItem.Text + "'";
            }
            else
            {
                swhere = "BankAcctTypeName is not null";
    ...
    protected void btnSearchEdit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                swhere = "BankAcctTypeName = '" + ddlEdit_MenuTitle.SelectedItem.Text + "'";
            }
            else
            {
                swhere = "BankAcctTypeName is not null";
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        try
        {
            dml.Delete("update SET_BankAccountType set Record_Deleted = 1 where BankAcctTypeID = " + ViewState["SNO"].ToString() + "", "");
            textClear();
    ...
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            DataSet ds = dml.Find("select * from SET_BankAccountType WHERE ([BankAcctTypeID]='" + serial_id+"') and Record_Deleted = 0");
            if (ds.Tables[0].Rows.Count > 0)
            {

               

                txtBankAccountType.Text = ds.Tables[0].Rows[0]["BankAcctTypeName"].ToString();
    ...
    protected void GridView2_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (flag == true)
        {
            ...
            DataSet ds = dml.Find("select BankAcctTypeID,MLD from SET_BankAccountType where BankAcctTypeID = '" + id + "'");
            if (ds.Tables[0].Rows.Count > 0)
            {
