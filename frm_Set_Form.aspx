<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frm_Set_Form.aspx.cs" Inherits="frm_Period" %>
                ...
                <div class="box box-solid shadowbox " style="border-radius: 15px;">
                    <div class="box-header with-border" style="height: 75px;">
                        <div style="padding-top: 0px; width: 120px; float: left;">
                            <div id="tabmenu">
                                <h3 class="box-title" style="color: #fff; padding-left: 10px;"><strong>FORM</strong></h3>
                            </div>
                        </div>
                                ...
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <table id="tablecontent1" runat="server" style="width: 100%;">
                                            <tr>
                                                <td class="auto-style6"><strong>Form Name</strong></td>
                                                <td class="auto-style11">
                                                    ...
                                                    <asp:RequiredFieldValidator runat="server" ID="Req" ControlToValidate="txtMenuNAme" Display="None" ErrorMessage="<b> Missing Field</b><br />A Form Name is required." ValidationGroup="aaa" />
                                                ...
                                                <td class="auto-style11">
                                                    <asp:DropDownList ID="ddlMenu" Width="250px" CssClass=" form-control select2" runat="server" ValidationGroup="aaa"  ></asp:DropDownList>
                                            ...
                                            <tr>
                                                ...
                                                <td class="auto-style11">
                                                   ...
                                                   <asp:Panel ID="Panel6" runat="server">
                                                        <asp:RadioButton ID="rdbHAVDOC_Y" Text="YES" runat="server" GroupName="Group_HD"/>
                                                        <asp:RadioButton ID="rdbHAVDOC_N" Text="NO" runat="server" GroupName="Group_HD"/>
                                                    </asp:Panel>
                                                </td>

                                            </tr>
                                            <tr>
                                                 <td class="auto-style6"><strong>Periodic Entry Parameters Exempt?</strong></td>
                                                <td class="auto-style11">

                                                   <asp:Panel ID="Panel3" runat="server">
                                                        <asp:RadioButton ID="rdb_PEP_Y" Text="YES" runat="server" GroupName="Group_PEP"/>
                                                        <asp:RadioButton ID="rdb_PEP_N" Text="NO" runat="server" GroupName="Group_PEP"/>
                                                    </asp:Panel>
                                                </td>
                                            </tr>
                                             ...
                                             <tr>
                                                ...
                                                <td class="auto-style6"><strong>Form Path</strong></td>
                                                <td class="auto-style11">
                                                 <asp:TextBox ID="txtFormPath" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table style="width: 100%;">
                        <tr>
                            <td class="rowpadd"><strong>Form Name</strong> </td>
                            <td class="rowpadd" >
                        ...
                        <tr>
                            <td class="rowpadd"><strong>Menu</strong> </td>
                            <td class="rowpadd">
                   ...
                   <table style="width: 100%;">
                         <tr>
                            ...
                            <td class="rowpadd" style="width:25%">
                                <asp:RadioButton ID="rdbEditMain" Text="Have Document"  GroupName="ms" runat="server" />

                            </td>
                            <td class="rowpadd" style="width:25%">
                                <asp:RadioButton ID="rdbEditSub" Text="No Document"  GroupName="ms" runat="server" />
                            </td>
                ...
                <div class="modal-body">
                   ...
                   <table style="width: 100%;">
                         <tr>
                            ...
                            <td class="rowpadd" style="width:25%">
                                <asp:RadioButton ID="rdbFind_M" Text="Have Document"  GroupName="ms" runat="server" />

                            </td>
                            <td class="rowpadd" style="width:25%">
                                <asp:RadioButton ID="rdbFind_S" Text="No Documnet"  GroupName="ms" runat="server" />
                            </td>
                  ...
                  <table style="width: 100%;">
                   ...
                   <table style="width: 100%;">
                         <tr>
                            ...
                            <td class="rowpadd" style="width:25%">
                                <asp:RadioButton ID="rdbDel_M" Text="Have Document"  GroupName="ms" runat="server" />

                            </td>
                            <td class="rowpadd" style="width:25%">
                                <asp:RadioButton ID="rdbDel_S" Text="No Document"  GroupName="ms" runat="server" />
                            </td>
