<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frm_StockAdjustmentOut.aspx.cs" Inherits="frm_Period"  EnableEventValidation="false"%>
                ...
                <div class="box box-solid shadowbox " style="border-radius: 15px;">
                    <div class="box-header with-border" style="height: 75px;">
                        <div style="padding-top: 0px; width: 120px; float: left;">
                            <div id="tabmenu">
                                <h3 class="box-title" style="color: #fff; padding-left: 10px;"><strong>Stock Adjustment - Reduction</strong></h3>
                            </div>
                        </div>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Rate" SortExpression="CostCenter" ItemStyle-HorizontalAlign="Right">
                                            <EditItemTemplate>
                                                ...
                                                <asp:TextBox ID="lblRateEdit"  runat="server" Text='<%# Bind("Rate","{0:0.00}") %>' OnTextChanged="txtRateEdit_TextChanged" AutoPostBack="true" ></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Value" SortExpression="Project" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right">
                                            <HeaderTemplate>
                                                ...
                                                <asp:CheckBox ID="chkamount"  runat="server" AutoPostBack="True" OnCheckedChanged="chkamount_CheckedChanged" />
                                            </HeaderTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtValueEdit" runat="server" Text='<%# Bind("Value","{0:0.00}") %>' Enabled="false"></asp:TextBox>
                                        ...
                                        <asp:TemplateField HeaderText="Remarks" SortExpression="Remarks" Visible="true">
                                            <EditItemTemplate>
                                                ...
                                                <asp:TextBox ID="txtRemarksEdit" runat="server"  Text='<%# Bind("Remarks") %>'></asp:TextBox>

                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="lblUOM2" runat="server" Text='<%# Bind("Remarks") %>'></asp:Label>
                                            </ItemTemplate>
                                            <FooterTemplate>
                                        ...
                                        <asp:GridView ID="GridView4" AutoGenerateColumns="False" CssClass="table table-bordered table-hover tableFixHead" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" runat="server" DataKeyNames="Sno" OnRowDataBound="GridView4_RowDataBound" OnRowCancelingEdit="GridView4_RowCancelingEdit" OnRowEditing="GridView4_RowEditing" OnRowUpdating="GridView4_RowUpdating">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="PO No." Visible="false" SortExpression="ItemSubHeadName">
                                                    <EditItemTemplate>
                                                        <asp:Label ID="lblPoNEdit" runat="server" Enabled="false" Text=""></asp:Label>
                                                    </EditItemTemplate>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Remarks" SortExpression="Project" >
                                                    <EditItemTemplate>
                                                        <asp:TextBox ID="txtUOM2Edit" runat="server" Text='<%# Bind("Remarks") %>'></asp:TextBox>
                                                        <asp:Label ID="lblUOM2Edit" runat="server" Enabled="false" Text='<%# Bind("Remarks") %>'></asp:Label>
                                                    </EditItemTemplate>
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblUOM2" runat="server" Text='<%# Bind("Remarks") %>'></asp:Label>
                                                    </ItemTemplate>
                            ...
                            <div style="width: 100%; height: 200px; overflow: scroll">
                                ...
                                <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
                                    ...
                                    <ContentTemplate>
                                     ...
                                     <%--   table table-bordered table-hover tableFixHead--%>
                                        <asp:GridView ID="GridView10" AutoGenerateColumns="False" CssClass=" table table-bordered table-hover tableFixHead" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" runat="server" DataKeyNames="Sno" OnRowCancelingEdit="GridView10_RowCancelingEdit" OnRowEditing="GridView10_RowEditing" OnRowUpdating="GridView10_RowUpdating" OnRowDeleting="GridView10_RowDeleting" OnRowDataBound="GridView10_RowDataBound">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Item Sub Head" SortExpression="Description" HeaderStyle-Width="250px">
                                                ...
                                                <asp:TemplateField HeaderText="Item Master" SortExpression="UOM" HeaderStyle-Width="250px">
                                                    <EditItemTemplate>
                                                        <%--<asp:DropDownList ID="ddlItemMasterEdit" Width="150px" CssClass=" form-control select2" runat="server" ValidationGroup="aaa"></asp:DropDownList>--%>
                                                ...
                                                <asp:TemplateField HeaderText="Qty" SortExpression="RequiredQuantity" Visible="true" ItemStyle-HorizontalAlign="Right">
                                                    <EditItemTemplate>
                                                        <asp:Label ID="lbltxt" runat="server" Width="50px" Visible="false"></asp:Label>
                                                ...
                                                <asp:TemplateField HeaderText="Value" SortExpression="Project" ItemStyle-HorizontalAlign="Right">
                                                    <EditItemTemplate>
                                                        ...
                                                        <asp:Label ID="lblValueEdit" runat="server" Visible="false" Width="150px" Enabled="false" Text='<%# Bind("Value") %>'></asp:Label>
                                                    </EditItemTemplate>
                                                    <ItemTemplate>
