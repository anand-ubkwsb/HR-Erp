<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frm_ItemReport.aspx.cs" Inherits="frm_Period" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script>
        ...
        function alertFileGenerated() {
            swal("File generated Successfuly!", "success")
                .then(function () {
                ...
                <div class="box box-solid shadowbox " style="border-radius: 15px;">
                    <div class="box-header with-border" style="height: 75px;">
                        <div style="padding-top: 0px; width: 120px; float: left;">
                            <div id="tabmenu">
                                <h3 class="box-title" style="color: #fff; padding-left: 10px;"><strong>Item Report</strong></h3>
                            </div>
                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="auto-style11">
                                                    <asp:Panel ID="Panel1" runat="server">
                                                        <asp:RadioButton ID="rdbLocal" Text="Local" runat="server" GroupName="Group_L_I"  />
                                                        <asp:RadioButton ID="rdbImport" Text="Import" runat="server" GroupName="Group_L_I"  />
                                                    </asp:Panel>
