<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frm_SET_UnitOFMeasure.aspx.cs" Inherits="frm_SET_COA_Master" EnableEventValidation="false" %>
                ...
                <div class="box box-solid shadowbox " style="border-radius: 15px;">
                    <div class="box-header with-border" style="height:75px;">
                        ...
                        <div style=" padding-top:0px; width:120px;float:left;">
                            <div id="tabmenu">
                                <h3 class="box-title" style="color: #fff; padding-left: 10px;"><strong>Unit Of Measure</strong></h3>
                            </div>
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="box-body" style="background-color: #cddbf2;">
                             <div id="fieldbox" runat="server">
                                ...
                                <tr>
                                    <td class="auto-style6"><strong>Unit of Measure Name</strong></td>
                                    <td class="auto-style7">
                                        <div>
                                         <asp:TextBox ID="txtunitofmeasure" CssClass="form-control texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black"></asp:TextBox>
                                        </div>
                                    </td>
                                    <td class="auto-style4"><strong>Created By</strong></td>
                                    <td class="auto-style1 ">
                                        <div class="backcolorlbl texthieht">
                                            <asp:Label ID="lblCreatedBy" runat="server" Font-Italic="False" ForeColor="Black"></asp:Label>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="padspace">
                                        <div class="backcolorlbl texthieht">
                                            <asp:Label ID="lblCreatedDate" runat="server" Font-Italic="False" ForeColor="Black"></asp:Label>
                                        </div>
                                    </td>
                                        ...
                                        <%--  ENd Modals --%>
                                          ...
                                          <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="UOMID" HeaderText="ID" SortExpression="UOMID" ReadOnly="True" InsertVisible="False" >
                                                <HeaderStyle Width="20px" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="UOMName" HeaderText="Unit Of Measure" SortExpression="UOMName">
