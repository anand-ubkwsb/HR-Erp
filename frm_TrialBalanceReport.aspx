<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frm_TrialBalanceReport.aspx.cs" Inherits="frm_TrialBalanceReport" %>
                ...
                <div class="box box-solid shadowbox " style="border-radius: 15px;">
                    <div class="box-header with-border" style="height: 75px;">
                        ...
                        <div style="height: 60px; width: 650px;">
                            <asp:LinkButton ID="btnGenerate" Height="40" CssClass="btn btn-app " runat="server" Style="left: 180px; background-color: #1f4f8a; color: white;" ValidationGroup="changest" OnClick="btnGenerateReport_Click">
                     <i class="fas fa-save"></i>&nbsp Generate Trial Balance Report
                            </asp:LinkButton>
