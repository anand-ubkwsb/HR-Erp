<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frmBlankInOutAttendanceReport.aspx.cs" Inherits="frm_Period" %>
                ...
                <div class="box box-solid shadowbox " style="border-radius: 15px;">
                    <div class="box-header with-border" style="height: 75px;">
                        <div style="padding-top: 0px; width: 120px; float: left;">
                            <div id="tabmenu">
                                <h3 class="box-title" style="color: #fff; padding-left: 10px;"><strong>Blank IN / OUT Attendance Report</strong></h3>
                            </div>
                        </div>
                                ...
                                <table id="tablecontent1" runat="server" style="width: 100%;">
                                      <tr>
                                                ...
                                                <td class="auto-style1">
                                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                                    <asp:RadioButton ID="RadioButton3" runat="server" Text="All" />
