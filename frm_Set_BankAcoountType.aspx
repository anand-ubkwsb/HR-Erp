<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frm_Set_BankAcoountType.aspx.cs" Inherits="frm_Period" %>
                ...
                <div class="box box-solid shadowbox " style="border-radius: 15px;">
                    <div class="box-header with-border" style="height: 75px;">
                        <div style="padding-top: 0px; width: 120px; float: left;">
                            <div id="tabmenu">
                                <h3 class="box-title" style="color: #fff; padding-left: 10px;"><strong>BANK ACCOUNT TYPE</strong></h3>
                            </div>
                        </div>
                                        ...
                                        <table id="tablecontent1" runat="server" style="width: 100%;">
                                            <tr>
                                                ...
                                                <td class="auto-style11">
                                                    <asp:TextBox ID="txtBankAccountType" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                                     <asp:RequiredFieldValidator runat="server" ID="Req" ControlToValidate="txtBankAccountType" Display="None" ErrorMessage="<b> Missing Field</b><br />A Bank Account type is required." ValidationGroup="aaa" />
                                            ...
                                            <tr>
                                                <td class="auto-style12"><strong>Created By</strong></td>
                                                ...
                                                <td class="auto-style12"><strong>Created Date</strong></td>
                                                <td class="auto-style12">
