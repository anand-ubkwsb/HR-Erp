<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frm_DocReport.aspx.cs" Inherits="frm_Period" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script>
        ...
        function alertFileGenerated() {
            swal("File has been generated", "success")
                .then(function () {
                });
                ...
                <div class="box box-solid shadowbox " style="border-radius: 15px;">
                    <div class="box-header with-border" style="height: 75px;">
                        <div style="padding-top: 0px; width: 120px; float: left;">
                            <div id="tabmenu">
                                <h3 class="box-title" style="color: #fff; padding-left: 10px;"><strong>Document Report</strong></h3>
                            </div>
                        </div>
                                         ...
                                         <table id="tablecontent1" runat="server" style="width: 100%;">
                                            <tr>
                                                ...
                                                <td class="auto-style11">
                                                    ...
                                                    <asp:DropDownList ID="ddlItemTypes" Width="250px" CssClass=" form-control select2" runat="server" ValidationGroup="aaa" AutoPostBack="True" OnSelectedIndexChanged="ddlItemTypes_SelectedIndexChanged"></asp:DropDownList>
                                            ...
                                            <tr>
                                                ...
                                                <td class="auto-style11">
                                                 ...
                                                 <td class="auto-style6"><strong>Monthy/Yearly based<asp:Label ID="lblSteriek" runat="server" Text="" ForeColor="Red"></asp:Label></strong></td>
                                                <td class="auto-style11">
                                                    <asp:Panel ID="Panel1" runat="server">
                                                        <asp:RadioButton ID="rdbMonthly" Text="Monthly" runat="server"  GroupName="Group_L_I"  />
                                                        <asp:RadioButton ID="rdbYearly" Text="Yearly" runat="server"  GroupName="Group_L_I"  />
                                                    </asp:Panel>
