<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frmDesignationSetup.aspx.cs" Inherits="frm_Period" %>
                ...
                <div class="box box-solid shadowbox " style="border-radius: 15px;">
                    <div class="box-header with-border" style="height: 75px;">
                        <div style="padding-top: 0px; width: 120px; float: left;">
                            <div id="tabmenu">
                                <h3 class="box-title" style="color: #fff; padding-left: 10px;"><strong>Designation Setup</strong></h3>
                            </div>
                        </div>
                        ...
                        <div class="box-body" style="background-color: #cddbf2;">
                            <div id="fieldbox" runat="server">
                                ...
                                <table id="tablecontent1" runat="server" style="width: 100%;">
                                      <tr>
                                                <td class="auto-style2"><strong>Designation ID</strong></td>
                                            ...
                                            <td class="auto-style3"><strong>Designation Category</strong></td>
                                                <td class="auto-style1">
                                     ...
                                     <tr>
                                                <td class="auto-style3"><strong>Designation Name</strong></td>
                                                <td class="auto-style1">
                                     ...
                                     <td class="auto-style3"><strong>Officer / Worker</strong></td>
                                                <td class="auto-style1">
                                     ...
                                     <tr>
                                                <td class="auto-style3"><strong>Attd. Allowance</strong></td>
                                                <td class="auto-style1">
