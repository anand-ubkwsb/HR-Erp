<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frmDailyIrRegularReport.aspx.cs" Inherits="frm_Period" %>
                ...
                <div class="box box-solid shadowbox " style="border-radius: 15px;">
                    <div class="box-header with-border" style="height: 75px;">
                        <div style="padding-top: 0px; width: 120px; float: left;">
                            <div id="tabmenu">
                                <h3 class="box-title" style="color: #fff; padding-left: 10px;"><strong>Daily Ir-Regular Report</strong></h3>
                            </div>
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="box-body" style="background-color: #cddbf2;">
                            <div id="fieldbox" runat="server">
                                ...
                                <table id="tablecontent1" runat="server" class="nav-justified">
                                      <tr>
                                                <td class="auto-style2"><strong>Date</strong></td>
                                                <td class="auto-style1">
                                                    <asp:DropDownList ID="DropDownList4" Width="250px" CssClass=" form-control select2" runat="server" ValidationGroup="aaa"></asp:DropDownList>
                                       ...
                                       <tr>
                                                ...
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    <asp:RadioButton ID="RadioButton3" runat="server" Text="Select" />
                                            ...
                                            <td class="auto-style3"><strong>Employee</strong></td>
                                                ...
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    <asp:RadioButton ID="RadioButton4" runat="server" Text="Select" />
                                     ...
                                     <tr>
                                                <td class="auto-style3"><strong>Dept. From</strong></td>
                                                <td class="auto-style1">
                                         ...
                                         <td class="auto-style3"><strong>Emp. ID</strong></td>
                                                <td class="auto-style1">
                                                    <asp:DropDownList ID="DropDownList3" Width="250px" CssClass=" form-control select2" runat="server" ValidationGroup="aaa"></asp:DropDownList>
                                     ...
                                     <tr>
                                                <td class="auto-style3"><strong>Employee Type</strong></td>
                                                <td class="auto-style1">
                                                    &nbsp;&nbsp;&nbsp;
                                                    <asp:RadioButton ID="RadioButton5" runat="server" Text="All" />
                                                     
                                                     
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    <asp:RadioButton ID="RadioButton6" runat="server" Text="Select" />
                                                     
                                                     
                                                </td>
                                            <td class="auto-style3"><strong>Shift</strong></td>
                                                <td class="auto-style1">
                                                    &nbsp;&nbsp;&nbsp;
                                                    <asp:RadioButton ID="RadioButton7" runat="server" Text="All" />
                                                     
                                                     
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    <asp:RadioButton ID="RadioButton8" runat="server" Text="Select" />
                                     ...
                                     <tr>
                                                <td class="auto-style3"><strong>Type From</strong></td>
                                                <td class="auto-style1">
                                         ...
                                         <td class="auto-style3"><strong>Shift From</strong></td>
                                                <td class="auto-style1">
