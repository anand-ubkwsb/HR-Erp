...
public partial class frm_Period : System.Web.UI.Page
{
    ...
    protected void btn_delete_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                swhere = swhere + " and DeliveryChallan = '" + ddlFind_Department.SelectedItem.Value + "'";
            }
            else
            {
                swhere = swhere + " and DeliveryChallan is not null";
            }
            ...
            {
                swhere = swhere + " and DeliveryChallanDate = '" + txtDel_DelviDate.Text + "'";
            }
            else
            {
                swhere = swhere + " and DeliveryChallanDate is not null";
            }
    ...
    protected void btn_Search_Click(object sender, EventArgs e)
    {
        ...
        //ContentPlaceHolder1_GridView4.Visible = false;
        btnCancel.Visible = true;
        btnFind.Visible = true;
        btnDelete.Visible = false;
        btnEdit.Visible = false;
        ...
        try
        {
            ...
            {
                swhere = swhere + " and DeliveryChallanDate = '" + txtFind_DeliveryDate.Text + "'";
            }
            else
            {
                swhere = swhere + " and DeliveryChallanDate is not null";
            ...
            squer = squer + " where " + swhere + " and Record_Deleted = 0 and   [GocID] = " + gocid() + " and  [FiscalYearID] = " + FiscalYear() + " ORDER BY DocDescription";
    ...
    protected void btnSearchEdit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                swhere = swhere + " and DeliveryChallan = '" + ddlEdit_Depart.SelectedItem.Value + "'";
            }
            else
            {
                swhere = swhere + " and DeliveryChallan is not null";
            ...
            {
                swhere = swhere + " and DeliveryChallanDate = '" + txtEdit_deliveryDate.Text + "'";
            }
            else
            {
                swhere = swhere + " and DeliveryChallanDate is not null";
    ...
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                if (ds.Tables[0].Rows[0]["DocId"].ToString() != null)
                {
                ...
                if (ds.Tables[0].Rows[0]["DocumentAuthority"].ToString() != null)
                {
                ...
                string v = inv.totalval(GridView4).ToString();
                lblTotalValues.Text = "Total : " + inv.FinancialroundOff_Value(branchId().ToString(), v);
                valuegetcombobox(ds, "DrAccountCode", RadComboAcct_Code);
    ...
    protected void GridView3_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                string v = inv.totalval(GridView10).ToString();
                lblTotalValues.Text = "Total : " + inv.FinancialroundOff_Value(branchId().ToString(), v);
                valuegetcombobox(ds, "DrAccountCode", RadComboAcct_Code);
         ...
         string dbcr_detail = "",dbcr_plusminus= "";
            ...
            if (trantype == "Debit")
            {
                ...
                DataSet dsinsertdetail  = dml.Find("INSERT INTO Inv_InventoryInDetail ( [Sno_Master], [PONo], [DrAccountCode],  [ItemSubHead],"
                                       ...
                                       + "VALUES ('" + masterid + "', '" + lblPONo.Text + "', '" + lblAccountcode.Text + "', '" + subhead + "', '" + itemmaster + "', '" + uom1 + "', '" + lblDCQty.Text + "',"
                                       + " '" + lblRate.Text + "', '" + lblValue.Text + "', NULL, '" + lblQty2.Text + "', '" + uom2 + "', '" + lblRate2.Text + "', '" + balqty + "', '" + balqty2 + "', NULL, NULL,"
    ...
    protected void lblQty2Footer_TextChanged(object sender, EventArgs e)
    {
       ...
       (row.FindControl("lblRate2Footer") as TextBox).Text = value.ToString("0.00");
    }
    ...
    public void docrule(string docid)
    {
        if (ddlDocName.SelectedIndex != 0)
        {
            ...
            DataSet ds = dml.Find("SELECT AccountCode FROM SET_Documents WHERE DocID = '" + docid + "'; SELECT ForceAccountCode,AccountType FROM SET_AcRules4Doc WHERE DocId = '" + docid + "' and MasterDetail = 'M'");
...
(row.FindControl("txtValueEdit") as TextBox).Text = value.ToString("0.00");
       ...
       // string v = inv.totalvalEdit(GridView6).ToString();
      //  lblTotalValues.Text = "Total : " + inv.FinancialroundOff_Value(branchId().ToString(), v);
    }
    ...
    protected void ddlSupplier_SelectedIndexChanged(object sender, EventArgs e)
    {
        if(ddlSupplier.SelectedIndex != 0)
        {
            txtShopOffName.Text = ddlSupplier.SelectedItem.Text;
    ...
    public void detailinsertEdit(string masterid)
    {
        ...
        foreach (GridViewRow g in GridView10.Rows)
        {
            ...
            Label lbsno = (Label)g.FindControl("lblSno");
            Label lblAccountcode = (Label)g.FindControl("lblAccountCode");
            Label lblPONo = (Label)g.FindControl("lblPONo");
            Label lblItemSubHead = (Label)g.FindControl("lblItemSubHead");
            Label lblitemmaster = (Label)g.FindControl("lblItemMaster");
    ...
    protected void GridView10_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            string f = "0";
            if (e.Row.FindControl("lblValue") as Label != null)
            {
                f = (e.Row.FindControl("lblValue") as Label).Text;
            }
            float fa = float.Parse(f);
            string displ = inv.displaydigit(branchId().ToString());
            if (displ == "0")
