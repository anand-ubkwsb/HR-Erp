...
public partial class frm_Period : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Page.IsPostBack == false)
        {
            ...
            //select DepartmentName,DepartmentID from SET_Department where IsWarehouse='1' Record_Deleted = '0'
            dml.dropdownsql(ddlDepartment, "SET_Department", "DepartmentName", "DepartmentID", "IsWarehouse", "1");
    ...
    protected void btnInsert_Click(object sender, EventArgs e)
    {
        ...
        txtRecordStocklevel.Enabled = true;
        RadComboItem_Code.Enabled = true;
        ddlDepartment.Enabled = true;
        txtPartNoDetail.Enabled = true;
        txtLoctaion1.Enabled = true;
        txtLoctaion2.Enabled = true;
        txtLoctaion3.Enabled = true;
        txtLoctaion4.Enabled = true;
        txtMiniStockLevel.Enabled = true;
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try {
            ...
            DataSet uniqueg_B_C = dml.Find("select * from SET_ItemMasterOthers where GocID = '" + gocid() + "'  and ItemCode = '" + RadComboItem_Code.Text + "'  and Record_Deleted = 0");
            if (uniqueg_B_C.Tables[0].Rows.Count > 0)
            {
                ...
                dml.Insert("INSERT INTO [SET_ItemMasterOthers] ([GocID], [ItemID], [ItemCode], [CompId], [BranchId], [DepartmentId], [PartNo_Detail], [Location1], [Location2], [Location3], [Location4], [MinimumStockLevel], [MaximumStockLevel], [ReorderStockLevel], [RecorderQuantity], [IsActive], [CreatedBy], [CreateDate],[Record_Deleted]) VALUES (" + gocid() + ", '" + val + "', '" + RadComboItem_Code.Text + "'," + compid() + "," + branchId() + ", '" + ddlDepartment.SelectedItem.Value + "', '" + txtPartNoDetail.Text + "', '" + txtLoctaion1.Text + "', '" + txtLoctaion2.Text + "', '" + txtLoctaion3.Text + "', '" + txtLoctaion4.Text + "', '" + txtMiniStockLevel.Text + "', '" + txtMaxStockLevel.Text + "', '" + txtRecordStocklevel.Text + "', '" + txtRecQuantity.Text + "', '" + chk + "', '" + show_username() + "', '" + DateTime.Now.ToString("dd-MMM-yyyy hh:mm:ss") + "', '0');", "alertme()");

                dml.Update("update SET_ItemMaster set MLD = '" + dml.Encrypt("q") + "' where ItemID = '" + RadComboItem_Code.SelectedItem.Value + "'", "");
                ClientScript.RegisterStartupScript(this.GetType(), "randomtext", "alertme()", true);
                Label1.Text = "";
                RadComboItem_Code.SelectedIndex = 0;
                ddlDepartment.SelectedIndex = 0;
                txtPartNoDetail.Text = "";
                txtLoctaion1.Text = "";
                txtLoctaion2.Text = "";
                txtLoctaion3.Text = "";
                txtLoctaion4.Text = "";
                txtMiniStockLevel.Text = "";
                txtMaxStockLevel.Text = "";
                txtRecQuantity.Text = "";
                txtRecordStocklevel.Text = "";
                chkActive.Checked = true;
                txtCreatedby.Text = "";
                txtCreatedDate.Text = "";
                txtUpdateBy.Text = "";
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        {
            txtRecQuantity.Text = "0.0";    
        }
        DataSet ds_up = dml.Find("select * from SET_ItemMasterOthers WHERE ([ItemMasterOthersID]='"+ViewState["SNO"].ToString()+"') AND ([GocID]='"+gocid()+"') AND ([ItemCode]='"+RadComboItem_Code.Text+"') AND ([CompId]='"+compid()+"') AND ([BranchId]='"+branchId()+"') AND ([DepartmentId]='"+ddlDepartment.SelectedItem.Value+"') AND ([PartNo_Detail] ='"+txtPartNoDetail.Text+"') AND ([Location1] ='"+txtLoctaion1.Text+"') AND ([Location2] = '"+txtLoctaion2.Text+"' ) AND ([Location3] = '"+txtLoctaion3.Text+"') AND ([Location4]  = '"+txtLoctaion4.Text+"' ) AND ([MinimumStockLevel]  = '"+txtMiniStockLevel.Text+"') AND ([MaximumStockLevel] = '"+txtMaxStockLevel.Text+"') AND ([ReorderStockLevel] ='"+txtRecordStocklevel.Text+"') AND ([RecorderQuantity] ='"+txtRecQuantity.Text+"') AND ([IsActive]='"+chk+"')");
        if (ds_up.Tables[0].Rows.Count > 0)
        {
            ...
            dml.Update("UPDATE [SET_ItemMasterOthers] SET [GocID]='" + gocid() + "',[ItemID]= '" + val + "', [ItemCode]='" + RadComboItem_Code.Text + "', [CompId]='" + compid() + "', [BranchId]='" + branchId() + "', [DepartmentId]='" + ddlDepartment.SelectedItem.Value + "', [PartNo_Detail]='" + txtPartNoDetail.Text + "', [Location1]='" + txtLoctaion1.Text + "', [Location2]='" + txtLoctaion2.Text + "', [Location3]='" + txtLoctaion3.Text + "', [Location4]='" + txtLoctaion4.Text + "', [MinimumStockLevel]='" + txtMiniStockLevel.Text + "', [MaximumStockLevel]='" + txtMaxStockLevel.Text + "', [ReorderStockLevel]='" + txtRecordStocklevel.Text + "', [RecorderQuantity]='" + txtRecQuantity.Text + "', [IsActive]='" + chk + "',[UpdatedBy]='" + show_username() + "', [UpdateDate]='" + DateTime.Now.ToString("dd-MMM-yyyy hh:mm:ss.ffff") + "' WHERE ([ItemMasterOthersID]='" + ViewState["SNO"].ToString() + "');", "");
    ...
    protected void btn_delete_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            GridView2.DataBind();
            string swhere;
            string squer = "select * from SET_ItemMasterOthers";
            //select ItemCode,PartNo_Detail,IsActive from SET_ItemMasterOthers where ItemMasterOthersID = '343'

            if (radDel_ItemCode.Text != "")
            {
                swhere = "ItemCode = '" + radDel_ItemCode.Text + "'";
            }
            else
            {
                swhere = "ItemCode is not null";
            }
            if (txtFind_PartNoDetail.Text != "")
            {
                swhere = swhere + " and PartNo_Detail like '" + txtFind_PartNoDetail.Text + "%'";
            }
            else
            {
                swhere = swhere + " and PartNo_Detail is not null";
            }
            ...
            squer = squer + " where " + swhere + " and Record_Deleted = 0 and CompId = '" + compid() + "' and BranchId = '" + branchId() + "' ORDER BY ItemCode";
    ...
    protected void btn_Search_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (radFindItem_Code.Text != "")
            {
                swhere = "ItemCode = '" + radFindItem_Code.Text + "'";
            }
            else
            {
                swhere = "ItemCode is not null";
    ...
    protected void btnSearchEdit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (radedit_itemCode.Text!= "")
            {
                swhere = "ItemCode = '" + radedit_itemCode.Text + "'";
            }
            else
            {
                swhere = "ItemCode is not null";
    ...
    public void textClear()
    {
        ...
        txtPartNoDetail.Enabled = false;
        txtLoctaion1.Enabled = false;
        txtLoctaion2.Enabled = false;
        txtLoctaion3.Enabled = false;
        txtLoctaion4.Enabled = false;
        txtMiniStockLevel.Enabled = false;
        ...
        txtUpdateBy.Enabled = false;
        txtUpdateDate.Enabled = false;
        txtRecordStocklevel.Enabled = false;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        try
        {
            dml.Delete("update SET_ItemMasterOthers set Record_Deleted = 1 where ItemMasterOthersID = " + ViewState["SNO"].ToString() + "", "");
            textClear();
    ...
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            DataSet ds = dml.Find("select * from SET_ItemMasterOthers where ItemMasterOthersID = '" + serial_id + "' and Record_Deleted = 0");
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                txtPartNoDetail.Text = ds.Tables[0].Rows[0]["PartNo_Detail"].ToString();
                txtLoctaion1.Text = ds.Tables[0].Rows[0]["Location1"].ToString();
                txtLoctaion2.Text = ds.Tables[0].Rows[0]["Location2"].ToString();
                txtLoctaion3.Text = ds.Tables[0].Rows[0]["Location3"].ToString();
                txtLoctaion4.Text = ds.Tables[0].Rows[0]["Location4"].ToString();
                txtMiniStockLevel.Text = ds.Tables[0].Rows[0]["MinimumStockLevel"].ToString();
                txtMaxStockLevel.Text = ds.Tables[0].Rows[0]["MaximumStockLevel"].ToString();
                txtRecordStocklevel.Text = ds.Tables[0].Rows[0]["ReorderStockLevel"].ToString();
                txtRecQuantity.Text = ds.Tables[0].Rows[0]["RecorderQuantity"].ToString();
    ...
    protected void radFindItem_Code_ItemsRequested(object sender, RadComboBoxItemsRequestedEventArgs e)
    {
        string where = "GocID = '" + gocid() + "' and Record_Deleted = '0'";

        cmb.serachcombo3(radFindItem_Code, e.Text, "ItemCode", "ItemID", "Description", "Local_Import", "SET_ItemMaster", where, "ItemCode");

    }
    protected void radedit_itemCode_ItemsRequested(object sender, RadComboBoxItemsRequestedEventArgs e)
    {
        string where = "GocID = '" + gocid() + "' and Record_Deleted = '0'";

        cmb.serachcombo3(radedit_itemCode, e.Text, "ItemCode", "ItemID", "Description", "Local_Import", "SET_ItemMaster", where, "ItemCode");

    }
    protected void radDel_ItemCode_ItemsRequested(object sender, RadComboBoxItemsRequestedEventArgs e)
    {
        string where = "GocID = '" + gocid() + "' and Record_Deleted = '0'";

        cmb.serachcombo3(radDel_ItemCode, e.Text, "ItemCode", "ItemID", "Description", "Local_Import", "SET_ItemMaster", where, "ItemCode");
