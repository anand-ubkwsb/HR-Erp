<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frm_SET_UserGrpDOCAutority.aspx.cs" Inherits="frm_SET_COA_Master" %>
    ...
    <script>
        function alertme() {
            swal("Insert Successfuly!", "record has been saved!!!", "success")
                .then(function () {
                    window.location = "frm_SET_UserGrpDOCAutority.aspx?UserID=" + userid + "&UsergrpID=" + UserGrpID + "&fiscaly=" + fiscal + "&FormID=" + FormID + "";
            });
                ...
                <div class="box box-solid shadowbox " style="border-radius: 15px;">
                    <div class="box-header with-border" style="height:75px;">
                        ...
                        <div style=" padding-top:0px; width:120px;float:left;">
                            <div id="tabmenu">
                                <h3 class="box-title" style="color: #fff; padding-left: 10px;"><strong>User Group Document Authority</strong></h3>
                            </div>
                        </div>
                        ...
                        <div class="box-body" style="background-color: #cddbf2;">
                             <div id="fieldbox" runat="server">
                                  ...
                                  <table id="tablecontent1" runat="server" style="width: 100%;">
                                      <tr>
                                    <td class="auto-style6"><strong>Authority </strong></td>
                                    <td class="auto-style11">
                                        
                                            <asp:DropDownList ID="lblAuth" CssClass="select2 form-control ddlHeight" Width="250px" runat="server" ></asp:DropDownList>
                                         <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1" ControlToValidate="lblAuth" InitialValue="Please select..." Display="None" ErrorMessage="<b> Missing Field</b><br />Please Select Authority." ValidationGroup="aaa" />
                                    ...
                                    <td class="auto-style11">
                                           ...
                                           <asp:DropDownList ID="lblDoc" CssClass="select2 form-control ddlHeight" Width="250px" runat="server" ></asp:DropDownList>
                                        <%--<asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator2" ControlToValidate="lblDoc" InitialValue="Please select..." Display="None" ErrorMessage="<b> Missing Field</b><br />Please Select Document." ValidationGroup="aaa" />
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style11">
                                       ...
                                       <asp:DropDownList ID="lblUserGrpName" CssClass="select2 form-control ddlHeight" Width="250px" runat="server" ></asp:DropDownList>
                                        <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator3" ControlToValidate="lblUserGrpName" InitialValue="Please select..." Display="None" ErrorMessage="<b> Missing Field</b><br />Please Select User Group Name." ValidationGroup="aaa" />
                                    ...
                                    <td class="auto-style11">
                                           ...
                                           <asp:TextBox ID="txtRemarks" CssClass="form-control ddlHeight" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black"></asp:TextBox>
                                            <%--<asp:Label ID="lblmenu" runat="server"  Font-Italic="False" ForeColor="Black"></asp:Label>--%>
                                ...
                                <tr>
                                    <td class="auto-style6"><strong>Date From</strong></td>
                                    <td class="padspace  auto-style11">
                                       <%--<asp:TextBox ID="txtDateFrom" CssClass="form-control" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black"></asp:TextBox>--%>

                                        <div style="display: inline-block">

                                            <div class="input-group input-group-sm">
                                                <asp:TextBox ID="txtDateFrom" CssClass="form-control texthieht" Width="220px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" ValidationGroup="aaa" AutoPostBack="True" OnTextChanged="txtDateFrom_TextChanged"></asp:TextBox>
                                                <ajaxToolkit:CalendarExtender ID="CalendarExtender1" PopupButtonID="imgPopup" TargetControlID="txtDateFrom" Format="dd-MMM-yyyy" runat="server" />
                                                <asp:RequiredFieldValidator runat="server" ID="Req2" ControlToValidate="txtDateFrom" Display="None" ErrorMessage="<b> Missing Field</b><br />A Date is required." ValidationGroup="aaa" />
                                                <ajaxToolkit:ValidatorCalloutExtender ID="ValidatorCalloutExtender3" TargetControlID="Req2" runat="server" HighlightCssClass="vali"></ajaxToolkit:ValidatorCalloutExtender>
                                    ...
                                    <td class="auto-style6"><strong>Date To</strong></td>
                                    <td class="padspace auto-style11">
                                     <%--   <asp:TextBox ID="txtDateTo" CssClass="form-control" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black"></asp:TextBox>--%>
                                    
                                     <div style="display: inline-block">

                                            <div class="input-group input-group-sm">
                                                <asp:TextBox ID="txtDateTo" CssClass="form-control texthieht" Width="220px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" ValidationGroup="aaa"></asp:TextBox>
                                                <ajaxToolkit:CalendarExtender ID="CalendarExtender2" PopupButtonID="ImageButton1" TargetControlID="txtDateTo" Format="dd-MMM-yyyy" runat="server" />
                                                <%--<asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator4" ControlToValidate="txtDateTo" Display="None" ErrorMessage="<b> Missing Field</b><br />A Date is required." ValidationGroup="aaa" />
                                ...
                                <tr>
                                     <td class="auto-style6"><strong>Entry Date</strong></td>
                                       ...
                                       <%--<asp:TextBox ID="txtEntryDate" CssClass="form-control ddlHeight" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black"></asp:TextBox>--%>
                                            ...
                                            <div class="input-group input-group-sm">
                                                ...
                                                <ajaxToolkit:CalendarExtender ID="CalendarExtender3" PopupButtonID="ImageButton2" TargetControlID="txtEntryDate" Format="dd-MMM-yyyy" runat="server" />
                                                <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator5" ControlToValidate="txtEntryDate" Display="None" ErrorMessage="<b> Missing Field</b><br />A Date is required." ValidationGroup="aaa" />
                                   ...
                                   <td class="auto-style11">
                                      ...
                                      <tr>
                                                <td class="auto-style10"><strong>Created By</strong></td>
                                                <td class="padspace auto-style11">
                                                    <asp:TextBox ID="txtCreatedBy" CssClass="form-control ddlHeight" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" TabIndex="4"></asp:TextBox>

                                                </td>
                                                <td class="auto-style10"><strong>Created Date</strong></td>
                                                <td class="padspace auto-style11">
                                                    <asp:TextBox ID="txtcreatedDate" CssClass="form-control ddlHeight" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" TabIndex="5"></asp:TextBox>
                                                    
                                                </td>
                                            </tr>

                                            <tr id="updatecol" runat="server">
                                                <td class="auto-style10"><strong>Updated By</strong></td>
                                                <td class="padspace auto-style11">
                                                    <asp:TextBox ID="txtUpdatedBy" CssClass="form-control ddlHeight" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" TabIndex="6"></asp:TextBox>

                                                </td>
                                                <td class="auto-style10"><strong>Updated Date</strong></td>
                                                <td class="padspace auto-style11">
                                                    <asp:TextBox ID="txtUpdatedDate" CssClass="form-control ddlHeight" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Style="margin-bottom: 1" TabIndex="7"></asp:TextBox>
                                                </td>
                                            </tr>
                                          ...
                                          <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover tableFixHead" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" DataKeyNames="UserGrpDocAuthId" >
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="EntryDate" HeaderText="Entry Date" SortExpression="EntryDate" DataFormatString = "{0:dd-MMM-yyyy}" >
                                                 ...
                                                 <%-- //DateFrom,DateTo--%>
                                                <asp:BoundField DataField="DateFrom" HeaderText="Date From" SortExpression="DateFrom" DataFormatString = "{0:dd-MMM-yyyy}" >
                                                    <HeaderStyle Width="200px" />
                                                    </asp:BoundField>
                                                <asp:BoundField DataField="DateTo" HeaderText="Date To" SortExpression="DateTo" DataFormatString = "{0:dd-MMM-yyyy}" >
                                                    <HeaderStyle Width="200px" />
                                                    </asp:BoundField>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
              ...
              <table style="width: 100%;">
                    <tr>
                            <td  style="width:200px"><strong>User Group Name</strong> </td>
                            <td>
                                <asp:DropDownList ID="ddlEdit_USergrpName" CssClass="form-control select2"  width="100%" runat="server"></asp:DropDownList>
                                <%--  ENd Modals --%>
                            </td>

                        </tr>
                        <tr>
                            <td  style="width:200px"><strong>Authority</strong> </td>
                            <td>
                                <asp:DropDownList ID="ddlEdit_GOCName" CssClass="form-control select2"  width="100%" runat="server"></asp:DropDownList>
                                <%--  ENd Modals --%>
                            </td>
                ...
                <table style="width: 100%;">
                    <tr>
                        ...
                        <tr>
                            <td  style="width:200px"><strong>Authority</strong> </td>
                            <td>
                                <asp:DropDownList ID="ddlFInd_AUTH" CssClass="form-control select2"  width="100%" runat="server"></asp:DropDownList>
                                <%--  ENd Modals --%>
                            </td>
                ...
                <div class="modal-body">
                     ...
                     <table style="width: 100%;">
                           <tr>
                            <td  style="width:200px"><strong>User Group Name</strong> </td>
                            <td>
                                <asp:DropDownList ID="ddlDel_UserGrpName" CssClass="form-control select2"  width="100%" runat="server"></asp:DropDownList>
                                <%--  ENd Modals --%>
                            </td>

                        </tr>
                       <tr>
                            <td style="width:200px; padding-bottom:30px"><strong>Authority</strong> </td>
                            <td style="padding-bottom:30px">
                                <asp:DropDownList ID="ddlDel_AUTH" CssClass="form-control  select2"  width="100%" runat="server"></asp:DropDownList>
                                <%--  ENd Modals --%>
                            </td>

                        </tr>
                         <tr >
                            <td style="padding-bottom:30px" ><strong>Document</strong> </td>
                            <td>
