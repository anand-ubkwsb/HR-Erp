<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frmGazetted Holiday Setup.aspx.cs" Inherits="frm_Period" %>
                ...
                <div class="box box-solid shadowbox " style="border-radius: 15px;">
                    <div class="box-header with-border" style="height: 75px;">
                        <div style="padding-top: 0px; width: 120px; float: left;">
                            <div id="tabmenu">
                                <h3 class="box-title" style="color: #fff; padding-left: 10px;"><strong>Gazetted Holiday Setup</strong></h3>
                            </div>
                        </div>
                            ...
                            <div id="fieldbox" runat="server">
                                ...
                                <table id="tablecontent1" runat="server" style="width: 100%;">
                                      <tr>
                                               ...
                                               <td class="auto-style1"><strong>Month</strong></td>
                                                <td class="auto-style1">
                                     ...
                                     <tr>
                                                <td class="auto-style6"><strong>Abbrivation</strong></td>
                                                <td class="auto-style1">
                                    ...
                                    <tr>
                                                <td class="auto-style6"><strong>Consider as Normal Day</strong></td>
                                                <td class="auto-style1">
                                               ...
                                               <td class="auto-style6"><strong>Company Declare Hour's</strong></td>
                                                <td class="auto-style1">
                                     ...
                                     <tr>
                                                <td class="auto-style6"><strong>Current User</strong></td>
                                                <td class="auto-style1">
                                               ...
                                               <td class="auto-style6"><strong>User</strong></td>
                                                <td class="auto-style1">
                                     ...
                                     <tr>
                                                <td class="auto-style6"><strong>Date and Time</strong></td>
                                                <td class="auto-style1">
