<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frm_SET_Report.aspx.cs" Inherits="frm_SET_COA_Master" %>
                ...
                <div class="box box-solid shadowbox " style="border-radius: 15px;">
                    <div class="box-header with-border" style="height: 75px;">
                        ...
                        <div style="padding-top: 0px; width: 120px; float: left;">
                            <div id="tabmenu">
                                <h3 class="box-title" style="color: #fff; padding-left: 10px;"><strong>Report Setup Form</strong></h3>
                            </div>
                        </div>
                                ...
                                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                    ...
                                    <ContentTemplate>
                                        ...
                                        <table id="tablecontent1" runat="server" style="width: 100%;">
                                            <tr>
                                                <td class="auto-style6"><strong>Report Title </strong></td>
                                                <td class="auto-style11">

                                                    <asp:TextBox ID="txtReportTitle" CssClass="form-control texthieht" Width="250px" runat="server" Font-Bold="False" ForeColor="Black"></asp:TextBox>
                                            ...
                                            <tr>
                                                <td class="auto-style6"><strong>Report Name</strong></td>
                                                <td class="auto-style11">

                                                    <asp:TextBox ID="txtReportName" CssClass="form-control texthieht" Width="250px" runat="server" Font-Bold="False" ForeColor="Black"></asp:TextBox>


                                                </td>

                                                <td class="auto-style6"><strong>Report Path</strong></td>
                                                <td class="auto-style11">
                                                    <asp:TextBox ID="txtReportPath" CssClass="form-control texthieht" Width="250px" runat="server" Font-Bold="False" ForeColor="Black"></asp:TextBox></td>
                                            </tr>
                                            <tr>
                                       ...
                                       <asp:RadioButton ID="rdb_Hide_N" runat="server" GroupName="Hide" Text="NO" />
                                            ...
                                            <tr>
                                                ...
                                                <td class="auto-style11">
                                                    ...
                                                    <asp:TextBox ID="txtSortOrder" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" ForeColor="Black"></asp:TextBox>
                ...
                <div class="modal-body">
                   ...
                   <table style="width: 100%;">
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlEdit_RptTitle" CssClass="form-control" runat="server"></asp:DropDownList>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlEdit_Menu" CssClass="form-control" runat="server"></asp:DropDownList>
                            </td>
                ...
                <div class="modal-body">
                    ...
                    <table style="width: 100%;">
                        <tr>
                            <td><strong>Report Title</strong> </td>
                            <td>
                                <asp:DropDownList ID="ddlFind_RptTitle" CssClass="form-control" runat="server"></asp:DropDownList>
                        ...
                        <tr>
                            <td><strong>Menu</strong> </td>
                            <td>
                                <asp:DropDownList ID="ddlFind_MenuTitle" CssClass="form-control" runat="server"></asp:DropDownList>
                            </td>
        ...
        <div class="modal-dialog">
            ...
            <table style="width: 100%;">
                        <tr>
                            <td><strong>Report Title</strong> </td>
                            <td>
                                <asp:DropDownList ID="ddlDel_RptTitle" CssClass="form-control" runat="server"></asp:DropDownList>
                        ...
                        <tr>
                            <td><strong>Menu</strong> </td>
                            <td>
                                <asp:DropDownList ID="ddlDel_Menu" CssClass="form-control" runat="server"></asp:DropDownList>
                            </td>
