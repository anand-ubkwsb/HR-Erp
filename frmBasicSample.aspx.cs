...
public partial class frm_Period : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Page.IsPostBack == false)
        {
            ...
            //select DepartmentID,DepartmentName from SET_Department
            dml.dropdownsql(ddlDesignation, "tblDesignation", "Designation", "Dscode");
            dml.dropdownsql(ddldepart, "SET_Department", "DepartmentName", "DepartmentID");
    ...
    protected void btnInsert_Click(object sender, EventArgs e)
    {
        ...
        txtEmpl.Enabled = true;
        txtTranStatus.Enabled = true;
        txtEmpName.Enabled = true;
        txtfileNo.Enabled = true;
        ddlDesignation.Enabled = true;
        ddldepart.Enabled = true;
        ddlappointmentDate.Enabled = true;
        ddlsalaryCode.Enabled = true;
    ...
    public void textClear()
    {
        ...
        txtEmpl.Enabled = false;
        txtTranStatus.Enabled = false;
        txtEmpName.Enabled = false;
        txtfileNo.Enabled = false;
        ddlDesignation.Enabled = false;
        ddldepart.Enabled = false;
        ddlappointmentDate.Enabled = false;
        ddlsalaryCode.Enabled = false;
        ...
        ddlappointmentDate.SelectedIndex = 0;
        ddlsalaryCode.SelectedIndex = 0;
