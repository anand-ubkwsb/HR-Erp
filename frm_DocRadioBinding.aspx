<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frm_DocRadioBinding.aspx.cs" Inherits="frm_Period" %>
                ...
                <div class="box box-solid shadowbox " style="border-radius: 15px;">
                    <div class="box-header with-border" style="height: 75px;">
                        <div style="padding-top: 0px; width: 120px; float: left;">
                            <div id="tabmenu">
                                <h3 class="box-title" style="color: #fff; padding-left: 10px;"><strong>DOCUMENT RADIOBUTTON BINDING</strong></h3>
                            </div>
                        </div>
                                        ...
                                        <table id="tablecontent1" runat="server" style="width: 100%;">
                                            <tr>
                                                ...
                                                <td class="auto-style11">
                                                    ...
                                                    <asp:DropDownList ID="ddldoc" CssClass="select2" Width="250px" ValidationGroup="aaa" runat="server"></asp:DropDownList>
                                                    
                                                     <asp:RequiredFieldValidator runat="server" ID="Req" ControlToValidate="ddldoc" InitialValue="Please select..." Display="None" ErrorMessage="<b> Missing Field</b><br />Please select ." ValidationGroup="aaa" />
                                                ...
                                                <td class="auto-style6"><strong>Radio Button Name</strong></td>
                                                <td class="auto-style11">
                                                 <asp:TextBox ID="txtRadioBtnName" CssClass="form-control texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                                </td>
                                                </tr>
                                        ...
                                        <div style="width: 100%; height: 400px; overflow: scroll">
                                            ...
                                            <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover tableFixHead" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" >
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="DocDescription" HeaderText="Doc Description" SortExpression="DocDescription" >
                                                    <HeaderStyle Width="500px" />
                                                    </asp:BoundField>
                                                     <asp:BoundField DataField="RadioButton" HeaderText="RadioButton" SortExpression="RadioButton" >
                                                    <HeaderStyle Width="500px" />
                                                    </asp:BoundField>
