<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frm_Set_Menu.aspx.cs" Inherits="frm_Period" %>
            ...
            <div class="col-lg-12">
                ...
                <div class="box box-solid shadowbox " style="border-radius: 15px;">
                        ...
                        <div style="padding-top: 0px; width: 120px; float: left;">
                            <div id="tabmenu">
                                <h3 class="box-title" style="color: #fff; padding-left: 10px;"><strong>MENU</strong></h3>
                            </div>
                        </div>
                        ...
                        <div class="box-body" style="background-color: #cddbf2;">
                            <div id="fieldbox" runat="server">
                                        ...
                                        <table id="tablecontent1" runat="server" style="width: 100%;">
                                            <tr>
                                                <td class="auto-style6"><strong>Menu Name</strong></td>
                                                <td class="auto-style11">
                                                    <asp:TextBox ID="txtMenuNAme" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                                     <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1" ControlToValidate="txtMenuNAme" Display="None" ErrorMessage="<b> Missing Field</b><br />A Menu Name is required." ValidationGroup="aaa" />
                                                ...
                                                <td class="auto-style11">
                                                    <asp:TextBox ID="txtRemarks" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                            ...
                                            <tr>
                                                ...
                                                <td class="auto-style11">
                                                   ...
                                                   <asp:Panel ID="Panel2" runat="server">
                                                        <asp:RadioButton ID="rdbHide_Y" Text="YES" runat="server" GroupName="Group_L_I"/>
                                                        <asp:RadioButton ID="rdbHide_N" Text="NO" runat="server" GroupName="Group_L_I"/>
                                                    </asp:Panel>
                                                </td>
                                                <td class="auto-style6"><strong>Main Menu or Sub Menu?</strong></td>
                                                <td class="auto-style11">

                                                   <asp:Panel ID="Panel6" runat="server">
                                                        <asp:RadioButton ID="rdbMainMenu"  Text="Main Menu" runat="server" GroupName="Group_L" AutoPostBack="True" OnCheckedChanged="rdbMainMenu_CheckedChanged"/>
                                                        <asp:RadioButton ID="rdbSubMenu" Text="Sub Menu" runat="server" GroupName="Group_L" AutoPostBack="True" OnCheckedChanged="rdbSubMenu_CheckedChanged"/>
                                                    </asp:Panel>
                                                </td>

                                            </tr>
                                              <tr>
                                                  <td class="auto-style6"><strong>Main Menu</strong></td>
                                                <td class="auto-style11">

                                                    <asp:DropDownList ID="ddlMain_Menu" Width="250px" CssClass=" form-control select2" runat="server" ValidationGroup="aaa"  ></asp:DropDownList>
                                                </td>
                                                <td class="auto-style6"><strong>Module</strong></td>
                                                <td class="auto-style11">
                                                     <asp:DropDownList ID="ddlModule" Width="250px" CssClass=" form-control select2" runat="server" ValidationGroup="aaa"  ></asp:DropDownList>
                                                    <asp:RequiredFieldValidator runat="server" ID="Req" ControlToValidate="ddlModule" InitialValue="Please select..." Display="None" ErrorMessage="<b> Missing Field</b><br />Please Select Department." ValidationGroup="aaa" />
                                             ...
                                             <tr>
                                                  <td class="auto-style6"><strong>Sort Order</strong></td>
                                                <td class="auto-style11">
                                                ...
                                                <td class="auto-style6"><strong>Menu Path</strong></td>
                                                <td class="auto-style11">
                                                 <asp:TextBox ID="txtMenuPath" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table style="width: 100%;">
                        <tr>
                            <td class="rowpadd"><strong>Menu Name</strong> </td>
                            <td class="rowpadd" >
                        ...
                        <tr>
                            <td class="rowpadd"><strong>Module</strong> </td>
                            <td class="rowpadd">
                              <asp:DropDownList ID="ddlEdit_Module" CssClass="form-control select2" Width="100%" runat="server"></asp:DropDownList>
                   ...
                   <table style="width: 100%;">
                         <tr>
                             <td class="rowpadd" style="width:25%">
                                

                            </td>
                            <td class="rowpadd" style="width:25%">
                                <asp:RadioButton ID="rdbEditMain" Text="Main Menu"  GroupName="ms" runat="server" />

                            </td>
                            <td class="rowpadd" style="width:25%">
                                <asp:RadioButton ID="rdbEditSub" Text="Sub Menu"  GroupName="ms" runat="server" />
                            </td>
                             <td class="rowpadd" style="width:25%">
                                <asp:RadioButton ID="rdbEditAll" Text="Both" Checked="true"  GroupName="ms" runat="server" />
                            </td>
                        </tr>
                ...
                <div class="modal-body">
                     ...
                     <table style="width: 100%;">
                        ...
                        <tr>
                            <td class="rowpadd"><strong>Module</strong> </td>
                            <td class="rowpadd">
                              <asp:DropDownList ID="ddlFind_Module" CssClass="form-control select2" Width="100%" runat="server"></asp:DropDownList>
                   ...
                   <table style="width: 100%;">
                         <tr>
                            ...
                            <td class="rowpadd" style="width:25%">
                                <asp:RadioButton ID="rdbFind_M" Text="Main Menu"  GroupName="ms1" runat="server" />

                            </td>
                            <td class="rowpadd" style="width:25%">
                                <asp:RadioButton ID="rdbFind_S" Text="Sub Menu"  GroupName="ms1" runat="server" />
                            </td>
                             <td class="rowpadd" style="width:25%">
                                <asp:RadioButton ID="rdbFind_B" Text="Both" Checked="true"  GroupName="ms1" runat="server" />
                            </td>
                        </tr>
                ...
                <div class="modal-body">
                  ...
                  <table style="width: 100%;">
                        ...
                        <tr>
                            <td class="rowpadd"><strong>Module</strong> </td>
                            <td class="rowpadd">
                              <asp:DropDownList ID="ddlDel_Module" CssClass="form-control select2" Width="100%" runat="server"></asp:DropDownList>
                   ...
                   <table style="width: 100%;">
                         <tr>
                            ...
                            <td class="rowpadd" style="width:25%">
                                <asp:RadioButton ID="rdbDel_M" Text="Main Menu"  GroupName="ms2" runat="server" />

                            </td>
                            <td class="rowpadd" style="width:25%">
                                <asp:RadioButton ID="rdbDel_S" Text="Sub Menu"  GroupName="ms2" runat="server" />
                            </td>
                             <td class="rowpadd" style="width:25%">
                                <asp:RadioButton ID="rdbDel_B" Text="Both" Checked="true"  GroupName="ms2" runat="server" />
                            </td>
                        </tr>
