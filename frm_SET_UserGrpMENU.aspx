<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frm_SET_UserGrpMENU.aspx.cs" Inherits="frm_SET_COA_Master"  EnableEventValidation="false"  %>
    ...
    <script>
        function alertme() {
            swal("Insert Successfuly!", "record has been saved!!!", "success")
                .then(function () {
                    window.location = "frm_SET_UserGrpMENU.aspx?UserID=" + userid + "&UsergrpID=" + UserGrpID + "&fiscaly=" + fiscal + "&FormID=" + FormID + "";
            });
                ...
                <div class="box box-solid shadowbox " style="border-radius: 15px;">
                    <div class="box-header with-border" style="height:75px;">
                        ...
                        <div style=" padding-top:0px; width:120px;float:left;">
                            <div id="tabmenu">
                                <h3 class="box-title" style="color: #fff; padding-left: 10px;"><strong>User Group Menu</strong></h3>
                            </div>
                        </div>
                             ...
                             <div id="fieldbox" runat="server">
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style8">
                                        <div>
                                            <asp:DropDownList ID="lblModule" CssClass="ddlHeight" Width="250px" runat="server" ></asp:DropDownList>
                                   


                                             <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator3" ControlToValidate="lblModule" InitialValue="Please select..." Display="None" ErrorMessage="<b> Missing Field</b><br />Please Select Module." ValidationGroup="aaa" />
                                        ...
                                        <%--  ENd Modals --%>
                                         ...
                                         <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover tableFixHead" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Serial" HeaderText="ID" SortExpression="Serial" />
                                                ...
                                                <asp:BoundField DataField="ModuleDescription" HeaderText="Module Description" SortExpression="ModuleDescription" />
                                                <asp:CheckBoxField DataField="IsActive" HeaderText="Active" SortExpression="IsActive" />
                                                <asp:BoundField DataField="Hide" HeaderText="Hide" SortExpression="Hide" />
                                                <asp:BoundField DataField="SysDate" HeaderText="Date" SortExpression="SysDate" />
                                            </Columns>
                                ...
                                <div class="box">
                                    ...
                                    <div class="box-body" style="width: 100%; overflow: auto; height: 50%;">
                                        ...
                                        <div style="width: 100%; height: 400px; overflow: scroll">
                                            ...
                                            <asp:GridView ID="GridView4" runat="server" CssClass="table table-bordered table-hover tableFixHead" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView4_SelectedIndexChanged" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" DataKeyNames="Sno"  OnRowDataBound="GridView4_RowDataBound"  >
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="ID" SortExpression="Sno">
                                                     ...
                                                     <asp:TemplateField HeaderText="Menu Title" SortExpression="Menu_title">
                                                         <EditItemTemplate>
                                                             <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("Menu_title") %>'></asp:TextBox>
                                                         </EditItemTemplate>
                                                         <ItemTemplate>
                                                             <asp:Label ID="lbldoc" runat="server" Text='<%# Bind("Menu_title") %>'></asp:Label>
                                                         </ItemTemplate>
                                                         <HeaderStyle Width="300px" />
                                                          <ItemStyle Height="10px" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Module " SortExpression="ModuleDescription">
                                                        <EditItemTemplate>
                                                            <asp:TextBox ID="TextBox3" runat="server" Text='<%# Bind("ModuleDescription") %>'></asp:TextBox>
                                                        </EditItemTemplate>
                                                        <ItemTemplate>
                                                            <asp:Label ID="lbldocname" runat="server" Text='<%# Bind("ModuleDescription") %>'></asp:Label>
                                                        </ItemTemplate>
                                            ...
                                            <%--<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:db_HRERPSys %>" SelectCommand="SELECT [Sno], [Menu_title], [ModuleDescription], [IsActive], [Hide] , [SysDate] FROM [View_Set_Menu] order by Menu_title asc"></asp:SqlDataSource>--%>
              ...
              <table style="width: 100%;">
                        <tr>
                         ...
                         <tr>
                            ...
                            <td>
                                <%--<asp:TextBox ID="txtEdit_Moduole" CssClass="form-control gap" runat="server"></asp:TextBox>--%>
                                <asp:DropDownList ID="txtEdit_Moduole" CssClass="form-control select2" width="100%"  runat="server"></asp:DropDownList>
                            </td>
                ...
                <table style="width: 100%;">
                       <tr>
                         ...
                         <tr>
                            <td><strong>Module Description</strong> </td>
                            <td>
                                <%--<asp:TextBox ID="txtFind_ModuleDesc" CssClass="form-control gap" runat="server"></asp:TextBox>--%>
                                <asp:DropDownList ID="txtFind_ModuleDesc" CssClass="form-control select2" width="100%"  runat="server"></asp:DropDownList>
                     ...
                     <table style="width: 100%;">
                       <tr>
                         ...
                         <tr>
                            <td><strong>Module Description</strong> </td>
                            <td>
                                <%--<asp:TextBox ID="txtDel_ModuleDesc" CssClass="form-control gap" runat="server"></asp:TextBox>--%>
                                <asp:DropDownList ID="txtDel_ModuleDesc" CssClass="form-control select2" width="100%"  runat="server"></asp:DropDownList>
                            </td>
