<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frmEmployee'sTransaction.aspx.cs" Inherits="frm_Period" %>
                ...
                <div class="box box-solid shadowbox " style="border-radius: 15px;">
                    <div class="box-header with-border" style="height: 75px;">
                        <div style="padding-top: 0px; width: 120px; float: left;">
                            <div id="tabmenu">
                                <h3 class="box-title" style="color: #fff; padding-left: 10px;"><strong>Employee's Transaction</strong></h3>
                            </div>
                        </div>
                        ...
                        <div class="box-body" style="background-color: #cddbf2;">
                            <div id="fieldbox" runat="server">
                                ...
                                <table id="tablecontent1" runat="server" style="width: 100%;">
                                      <tr>
                                                <td class="auto-style1"><strong>Entry Date</strong></td>
                                               ...
                                               <td class="auto-style1"><strong>Shift Code</strong></td>
                                                <td class="auto-style1">
                                     ...
                                     <tr>
                                                <td class="auto-style6"><strong>Empolyee ID</strong></td>
                                                <td class="auto-style1">
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                                <td class="auto-style6"><strong>Direct / Indirect/ Office</strong></td>
                                                <td class="auto-style1">
                                     ...
                                     <tr>
                                                <td class="auto-style6"><strong>Salary Remarks</strong></td>
                                                <td class="auto-style1">
                                               ...
                                               <td class="auto-style6"><strong>Left / Transfer Date</strong></td>
                                                <td class="auto-style1">
                                     ...
                                     <tr>
                                               ...
                                               <td class="auto-style6">&nbsp;</td>
                                                <td class="auto-style1">
                                                     <asp:CheckBox ID="CheckBox1" runat="server" Text="Overtime" />
                                                     <asp:CheckBox ID="CheckBox2" runat="server" Text="Bonus" />
                                                     <asp:CheckBox ID="CheckBox3" runat="server" Text="Conveyance Provided" />
                                                     <asp:CheckBox ID="CheckBox4" runat="server" Text="Vehicle Provide" />
                                                     <asp:CheckBox ID="CheckBox6" runat="server" Text="Attendance Allowance" />
                                                   </td>  
