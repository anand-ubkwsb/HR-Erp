<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frm_Set_StockReqDetail.aspx.cs" Inherits="frm_Period" %>
                ...
                <div class="box box-solid shadowbox " style="border-radius: 15px;">
                    <div class="box-header with-border" style="height: 75px;">
                        <div style="padding-top: 0px; width: 120px; float: left;">
                            <div id="tabmenu">
                                <h3 class="box-title" style="color: #fff; padding-left: 10px;"><strong>Stock Requisition Detail</strong></h3>
                            </div>
                        </div>
                          ...
                          <table id="tablecontent1" runat="server" style="width: 100%;">
                                            ...
                                            <tr>
                                                ...
                                                <td class="auto-style11">
                                                    <asp:DropDownList ID="ddlItemSubHead" Width="250px" CssClass=" form-control select2" runat="server" ValidationGroup="aaa" OnSelectedIndexChanged="ddlItemSubHead_SelectedIndexChanged"  AutoPostBack="true" ></asp:DropDownList>
                                                    <asp:RequiredFieldValidator runat="server" ID="req1" ControlToValidate="ddlItemSubHead" InitialValue="Please select..." Display="None" ErrorMessage="<b> Missing Field</b><br />Please Select Document." ValidationGroup="aaa" />
                                                ...
                                                <td class="auto-style6"><strong>Item Master</strong></td>
                                                <td class="auto-style11">
                                                   
                                                      <asp:DropDownList ID="ddlItemMaster" Width="250px" CssClass=" form-control select2" runat="server" ValidationGroup="aaa" ></asp:DropDownList>
                                                    <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1" ControlToValidate="ddlItemMaster" InitialValue="Please select..." Display="None" ErrorMessage="<b> Missing Field</b><br />Please Select Document." ValidationGroup="aaa" />
                                            ...
                                            <tr>
                                                ...
                                                <td class="auto-style11">
                                                    <asp:DropDownList ID="ddlCostCenter" Width="250px" CssClass=" form-control select2" runat="server" ValidationGroup="aaa"   ></asp:DropDownList>
                                                    <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator3" ControlToValidate="ddlCostCenter" InitialValue="Please select..." Display="None" ErrorMessage="<b> Missing Field</b><br />Please Select Document." ValidationGroup="aaa" />
                                                ...
                                                <td class="auto-style6"><strong>Unit of Measure</strong></td>
                                                <td class="auto-style11">
                                                   
                                                      <asp:DropDownList ID="ddlUOM" Width="250px" CssClass=" form-control select2" runat="server" ValidationGroup="aaa"  ></asp:DropDownList>
                                                    <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator2" ControlToValidate="ddlUOM" InitialValue="Please select..." Display="None" ErrorMessage="<b> Missing Field</b><br />Please Select Document." ValidationGroup="aaa" />
                                             ...
                                             <tr>
                                                  <td class="auto-style6"><strong>Requistion No.</strong></td>
                                                <td class="auto-style11">
                                                   
                                                      <asp:DropDownList ID="ddlReqNO" Width="250px" CssClass=" form-control select2" runat="server" ValidationGroup="aaa"  ></asp:DropDownList>
                                                    <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator4" ControlToValidate="ddlReqNO" InitialValue="Please select..." Display="None" ErrorMessage="<b> Missing Field</b><br />Please Select Document." ValidationGroup="aaa" />
                                                ...
                                                <td class="auto-style6"><strong>Project</strong></td>
                                                <td class="auto-style11">
                                                ...
                                                <tr>
                                                    <td class="auto-style6"><strong>Current Stock</strong></td>
                                                <td class="auto-style11">
                                                   <asp:TextBox ID="txtCurrentStock" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px" ValidationGroup="aaa"></asp:TextBox>
                                                    <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator5" ControlToValidate="txtCurrentStock" Display="None" ErrorMessage="<b> Missing Field</b><br />Please input document name." ValidationGroup="aaa" />
                                                ...
                                                <td class="auto-style6"><strong>Required Quantity</strong></td>
                                                <td class="auto-style11">
                                                    <asp:TextBox ID="txtReqQuantity" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px" ValidationGroup="aaa"></asp:TextBox>
                                                    <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator6" ControlToValidate="txtReqQuantity" Display="None" ErrorMessage="<b> Missing Field</b><br />Please input document name." ValidationGroup="aaa" />
                                            ...
                                            <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover tableFixHead" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" DataKeyNames="Sno">
                                                <Columns>
                                                    ...
                                                    <HeaderStyle Width="200px" />
                                                     ...
                                                     <asp:BoundField DataField="CostCenterName" HeaderText="Cost Center Name" SortExpression="CostCenterName" >
                                                    <HeaderStyle Width="200px" />
                                                    </asp:BoundField>
                                                      <asp:BoundField DataField="UOMName" HeaderText="UOM" SortExpression="UOMName" >
                                                    <HeaderStyle Width="200px" />
                                                    </asp:BoundField>
                ...
                <div class="modal-body">
                    ...
                    <table style="width: 100%;">
                        <tr>
                          ...
                          <tr>
                            <td class="rowpadd"><strong>Item Master</strong> </td>
                            <td class="rowpadd" >
                                
                                <asp:DropDownList ID="ddlEdit_ItemMaster" CssClass="form-control select2" Width="100%" runat="server"></asp:DropDownList>
                            </td>
                        </tr>
                          <tr>
                            <td class="rowpadd"><strong>Cost Center</strong> </td>
                            <td class="rowpadd" >
                                
                                <asp:DropDownList ID="ddlEdit_CostCenter" CssClass="form-control select2" Width="100%" runat="server"></asp:DropDownList>
                            </td>
                        </tr>
                        ...
                        <tr>
                          ...
                          <tr>
                            ...
                            <td class="rowpadd" >
                                ...
                                <asp:DropDownList ID="ddlFind_ItemMaster" CssClass="form-control select2" Width="100%" runat="server"></asp:DropDownList>
                            </td>
                        </tr>
                          <tr>
                            <td class="rowpadd"><strong>Cost Center</strong> </td>
                            <td class="rowpadd" >
                                ...
                                <asp:DropDownList ID="ddlFind_CostCenter" CssClass="form-control select2" Width="100%" runat="server"></asp:DropDownList>
                            </td>
                        </tr>
                         ...
                         <tr>
                          ...
                          <tr>
                            ...
                            <td class="rowpadd" >
                                ...
                                <asp:DropDownList ID="ddlDel_ItemMaster" CssClass="form-control select2" Width="100%" runat="server"></asp:DropDownList>
                            </td>
                        </tr>
                          <tr>
                            <td class="rowpadd"><strong>Cost Center</strong> </td>
                            <td class="rowpadd" >
                                ...
                                <asp:DropDownList ID="ddlDel_CostCenetr" CssClass="form-control select2" Width="100%" runat="server"></asp:DropDownList>
                            </td>
                        </tr>
