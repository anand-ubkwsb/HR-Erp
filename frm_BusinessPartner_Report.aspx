<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frm_BusinessPartner_Report.aspx.cs" Inherits="frm_Period" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script>
        ...
        function alertFileGenerated() {
            swal("File Generated Successfuly!", "record has been saved!!!", "success")
                .then(function () {
                ...
                <div class="box box-solid shadowbox " style="border-radius: 15px;">
                    <div class="box-header with-border" style="height: 75px;">
                        <div style="padding-top: 0px; width: 120px; float: left;">
                            <div id="tabmenu">
                                <h3 class="box-title" style="color: #fff; padding-left: 10px;"><strong>Business Partner Report</strong></h3>
                            </div>
                        </div>
                        ...
                        <div class="box-body" style="background-color: #cddbf2;">
                            <div id="fieldbox" runat="server">
                                         ...
                                         <table id="tablecontent1" runat="server" style="width: 100%;">
                                            <tr>
                                                <td class="auto-style6"><strong>Business Partner Name</strong></td>
                                                <td class="auto-style11">

                                                    <asp:DropDownList ID="ddlBusiness" Width="250px" CssClass=" form-control select2" runat="server" ValidationGroup="aaa"></asp:DropDownList>
                                                    <asp:RequiredFieldValidator runat="server" ID="Req" ControlToValidate="ddlBusiness" InitialValue="Please select..." Display="None" ErrorMessage="<b> Missing Field</b><br />Please Select Item Type." ValidationGroup="aaa" />
                                                ...
                                                <td class="auto-style6"><strong>CNIC</strong></td>
                                                <td class="auto-style11">
                                                    <asp:TextBox ID="txtCnic" CssClass="form-control texthieht" Width="250px" runat="server"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                
                                                <td class="auto-style6"><strong>NTN No</strong></td>
                                                <td class="auto-style11">
                                                    <asp:TextBox ID="txtNTN" CssClass="form-control texthieht" Width="250px" runat="server"></asp:TextBox>
