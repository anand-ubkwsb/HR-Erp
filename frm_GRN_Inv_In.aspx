<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frm_GRN_Inv_In.aspx.cs" Inherits="frm_Period"  EnableEventValidation="false"%>
                ...
                <div class="box box-solid shadowbox " style="border-radius: 15px;">
                    <div class="box-header with-border" style="height: 75px;">
                        <div style="padding-top: 0px; width: 120px; float: left;">
                            <div id="tabmenu">
                                <h3 class="box-title" style="color: #fff; padding-left: 10px;"><strong>GOOD RECEIVED NOTE</strong></h3>
                            </div>
                        </div>
                            ...
                            <div id="fieldbox" runat="server">
                                ...
                                <table id="tablecontent1" runat="server" style="width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td class="auto-style6"><strong>Location To</strong></td>
                                        <td class="auto-style11">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2" rowspan="2">
                                            ...
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <asp:Label ID="lblTotalValues" runat="server" Text="Total : 0 " Font-Bold="True" Font-Size="20px"></asp:Label>
                                                </div>
                                       </td>
                                    </tr>
                                        ...
                                        <div style="width: 100%; height: 400px; overflow: scroll">
                                            ...
                                            <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover tableFixHead" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" DataKeyNames="Sno">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="DeliveryChallan" HeaderText="Delivery Challan" SortExpression="DeliveryChallan"></asp:BoundField>
                                                    <asp:BoundField DataField="DeliveryChallanDate" HeaderText="Delivery Challan Date" SortExpression="DeliveryChallanDate" DataFormatString="{0:dd-MMM-yyyy}" />
                                                    <asp:BoundField DataField="Direct_Normal" HeaderText="Direct/Normal" SortExpression="Direct_Normal" />
                            ...
                            <div style="width: 100%; height: 200px; overflow: scroll">
                                ...
                                <asp:GridView ID="GridView6" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-hover tableFixHead" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" ShowFooter="true" ShowHeaderWhenEmpty="true" OnRowDataBound="GridView6_RowDataBound" OnRowDeleting="GridView6_RowDeleting" OnRowCommand="GridView6_RowCommand" OnRowEditing="GridView6_RowEditing" OnRowUpdating="GridView6_RowUpdating" OnRowCancelingEdit="GridView6_RowCancelingEdit">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="DC Qty" SortExpression="RequiredQuantity" ItemStyle-HorizontalAlign="Right">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtDCQtyEdit" runat="server" Width="70px" Text='<%# Bind("DCQty") %>' AutoPostBack="True" OnTextChanged="txtDCQtyEdit_TextChanged" ></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Rate" SortExpression="CostCenter"  ItemStyle-HorizontalAlign="Right">
                                            <EditItemTemplate>
                                                ...
                                                <asp:TextBox ID="lblRateEdit" runat="server"  Text='<%# Bind("Rate","{0:0.00}") %>'   OnTextChanged="lblRateEdit_TextChanged" AutoPostBack="true"></asp:TextBox >
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="lblRate" runat="server" Width="150px" Text='<%# Bind("Rate","{0:0.00}") %>'></asp:Label>
                                            </ItemTemplate>
                                            <FooterTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Value" SortExpression="Project" ItemStyle-HorizontalAlign="Right">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtValueEdit" runat="server" Enabled="false" Text='<%# Bind("Value","{0:0.00}") %>' ></asp:TextBox>
                                                <%--<asp:Label ID="lblValueEdit" runat="server" Enabled="false" Text='<%# Bind("Value") %>'></asp:Label>--%>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="lblValue" runat="server" Text='<%# Bind("Value","{0:0.00}") %>'></asp:Label>
                                        ...
                                        <asp:TemplateField HeaderText="Warrantee/Expiry Date" SortExpression="Project">
                                            ...
                                            <FooterTemplate>
                                                ...
                                                <div style="display: inline-block">
                                                    ...
                                                    <div class="input-group input-group-sm">
                                                        <asp:TextBox ID="lblWarranteeFooter" CssClass="form-control texthieht" Width="120px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" ValidationGroup="aaa"></asp:TextBox>
                                        ...
                                        <asp:TemplateField HeaderText="Rate2" SortExpression="Project" ItemStyle-HorizontalAlign="Right">
                                            <EditItemTemplate>
                                        ...
                                        <asp:GridView ID="GridView4" AutoGenerateColumns="False" CssClass="table table-bordered table-hover tableFixHead" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" runat="server" DataKeyNames="Sno" OnRowDataBound="GridView4_RowDataBound" OnRowCancelingEdit="GridView4_RowCancelingEdit" OnRowEditing="GridView4_RowEditing" OnRowUpdating="GridView4_RowUpdating">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="PO bal Qty" SortExpression="RequiredQuantity" Visible="false">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblPObalQty" runat="server" Width="50px" Text='<%# Bind("Quantity") %>'></asp:Label>
                                                    </ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Value" SortExpression="Project" ItemStyle-HorizontalAlign="Right">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblValue" runat="server" Width="150px" Text='<%# Bind("Value","{0:0.00}") %>'></asp:Label>
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Item Sub Head" SortExpression="Description">
                                                    ...
                                                    <EditItemTemplate>
                                                        ...
                                                        <asp:DropDownList ID="ddlItemSubHeadEdit" Width="150px" CssClass=" form-control select2" runat="server" ValidationGroup="aaa"></asp:DropDownList>
                                                        <asp:Label ID="lblItemSubHead" runat="server" Enabled="false" Text='<%# Bind("ItemSubHeadName") %>'></asp:Label>
                                                    </EditItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Rate" SortExpression="CostCenter" ItemStyle-HorizontalAlign="Right">
                                                    ...
                                                    <EditItemTemplate>
                                                        ...
                                                        <asp:TextBox ID="lblRateEdit" runat="server" Width="150px" Text='<%# Bind("Rate","{0:0.00}") %>' OnTextChanged="lblRateEdit_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                    </EditItemTemplate>
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblRate" runat="server" Width="150px" Text='<%# Bind("Rate","{0:0.00}") %>'></asp:Label>
                                                    </ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Value" SortExpression="Project" ItemStyle-HorizontalAlign="Right">
                                                    <EditItemTemplate>
                                                        <asp:TextBox ID="txtValueEdit" runat="server" Enabled="false" Text='<%# Bind("Value","{0:0.00}") %>' Width="150px"></asp:TextBox>
                                                        <asp:Label ID="lblValueEdit" runat="server" Visible="false" Enabled="false" Text='<%# Bind("Value","{0:0.00}")  %>'></asp:Label>
                                                    </EditItemTemplate>
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblValue" runat="server" Width="150px" Text='<%# Bind("Value","{0:0.00}") %>'></asp:Label>
                                                ...
                                                <asp:TemplateField HeaderText="Cost Center" SortExpression="Project">
                                                    <EditItemTemplate>
                                                        <asp:DropDownList ID="ddlCostCenterEdit" Width="150px" CssClass=" form-control select2" runat="server" ValidationGroup="aaa"></asp:DropDownList>
                                                        <asp:Label ID="lblCostCenterEdit" runat="server" Visible="false" Enabled="false" Text='<%# Bind("CostCenterName") %>'></asp:Label>
                                                    </EditItemTemplate>
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblCostCenter" runat="server" Text='<%# Bind("CostCenterName") %>'></asp:Label>
                                                    </ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Location" SortExpression="Project">
                                                    <EditItemTemplate>
                                                        ...
                                                        <asp:Label ID="lblLocationEdit" runat="server" Visible="false" Enabled="false" Text='<%# Bind("LocName") %>'></asp:Label>
                                                    </EditItemTemplate>
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblLocation" runat="server" Text='<%# Bind("LocName") %>'></asp:Label>
                                                    </ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Project/Job/Batch No." SortExpression="Project">
                                                    <EditItemTemplate>
                                                        ...
                                                        <asp:Label ID="lblProjectEdit" runat="server" Enabled="false" Visible="false" Text='<%# Bind("Project") %>'></asp:Label>
                                                    </EditItemTemplate>
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblProject" runat="server" Text='<%# Bind("Project") %>'></asp:Label>
                                                    </ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Warrantee/Expiry Date" SortExpression="Project">
                                                    <EditItemTemplate>
                                                        ...
                                                        <asp:Label ID="lblWarranteeEdit" runat="server" Enabled="false" Visible="false" Text='<%# Bind("Warrentee","{0:dd-MMM-yyyy}") %>'></asp:Label>
                                                    </EditItemTemplate>
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblWarrantee" runat="server" Text='<%# Bind("Warrentee","{0:dd-MMM-yyyy}") %>'></asp:Label>
                                                    </ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Qty2" SortExpression="Project" ItemStyle-HorizontalAlign="Right">
                                                    <EditItemTemplate>
