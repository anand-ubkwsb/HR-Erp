<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frmAnnualLeave.aspx.cs" Inherits="frm_Period" %>
                ...
                <div class="box box-solid shadowbox " style="border-radius: 15px;">
                    <div class="box-header with-border" style="height: 75px;">
                        <div style="padding-top: 0px; width: 120px; float: left;">
                            <div id="tabmenu">
                                <h3 class="box-title" style="color: #fff; padding-left: 10px;"><strong>Annual Leave</strong></h3>
                            </div>
                        </div>
                                ...
                                <table id="tablecontent1" runat="server" style="width: 100%;">
                                     ...
                                     <tr>
                                               ...
                                               <td class="auto-style6"><strong>Designation</strong></td>
                                                <td class="auto-style1">
                                                    <asp:TextBox ID="TextBox6" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <tr>
                                               <td class="auto-style6"><strong>Date From</strong></td>
                                                <td class="auto-style1">
                                                     <asp:DropDownList ID="DropDownList2" Width="250px" CssClass=" form-control select2" runat="server" ValidationGroup="aaa"></asp:DropDownList>
                                                    
                                                </td>
                                                 
                                        <td class="auto-style6"><strong>Date To</strong></td>
                                                <td class="auto-style1">
                                                    <asp:DropDownList ID="DropDownList1" Width="250px" CssClass=" form-control select2" runat="server" ValidationGroup="aaa"></asp:DropDownList>
                                        ...
                                        <tr>
                                               <td class="auto-style6"><strong>No. of Leaves</strong></td>
                                                <td class="auto-style1">
                                                     <asp:TextBox ID="TextBox7" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                                    
                                                </td>

                                               <td class="auto-style6"><strong>No. of Hours</strong></td>
                                                <td class="auto-style1">
                                                     <asp:TextBox ID="TextBox5" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                                    
                                                </td>
                                     
                                     </tr> 
                                     <tr>
                                               <td class="auto-style6"><strong>Leave Type</strong></td>
                                                <td class="auto-style1">
                                                     <asp:DropDownList ID="DropDownList5" Width="250px" CssClass=" form-control select2" runat="server" ValidationGroup="aaa"></asp:DropDownList>
                                                    
                                                </td>

                                               <td class="auto-style6"><strong>Remarks  </strong></td>
                                                <td class="auto-style1">
                                                     <asp:TextBox ID="TextBox4" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
