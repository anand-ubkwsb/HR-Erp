<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frm_Set_Document.aspx.cs" Inherits="frm_Period" %>
                ...
                <div class="box box-solid shadowbox " style="border-radius: 15px;">
                    <div class="box-header with-border" style="height: 75px;">
                        <div style="padding-top: 0px; width: 120px; float: left;">
                            <div id="tabmenu">
                                <h3 class="box-title" style="color: #fff; padding-left: 10px;"><strong>ASSIGN DOCUMENT</strong></h3>
                            </div>
                        </div>
                                        ...
                                        <table id="tablecontent1" runat="server" style="width: 100%;">
                                            <tr>
                                                ...
                                                <td class="auto-style11">
                                                    <asp:DropDownList ID="ddlDocType" Width="250px" CssClass="select2" runat="server" ValidationGroup="aaa"  ></asp:DropDownList>
                                                    <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1" ControlToValidate="ddlDocType" InitialValue="Please select..." Display="None" ErrorMessage="<b> Missing Field</b><br />Please Select Menu." ValidationGroup="aaa" />
                                                    <ajaxToolkit:ValidatorCalloutExtender ID="ValidatorCalloutExtender5" TargetControlID="RequiredFieldValidator1" runat="server" HighlightCssClass="vali" PopupPosition="Right"></ajaxToolkit:ValidatorCalloutExtender>
                                                </td>
                                                ...
                                                <td class="padspace">
                                                     <div style="display:inline-block">
                                                         ...
                                                         <div class="input-group input-group-sm">
                                                             <asp:TextBox ID="txtApplyDate" CssClass="form-control texthieht" Width="220px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" ValidationGroup="aaa"></asp:TextBox>
                                                             ...
                                                             <asp:RequiredFieldValidator runat="server" ID="Req2" ControlToValidate="txtApplyDate" Display="None" ErrorMessage="<b> Missing Field</b><br />A Date is required." ValidationGroup="aaa" />
                                                             <ajaxToolkit:ValidatorCalloutExtender ID="ValidatorCalloutExtender2" TargetControlID="Req2" runat="server" HighlightCssClass="vali" PopupPosition="BottomLeft"></ajaxToolkit:ValidatorCalloutExtender>
                                            ...
                                            <tr id="row2" runat="server" visible="true">
                                                <td class="auto-style6"><strong>Main Document</strong></td>
                                                <td class="auto-style11">
                                                    <asp:TextBox ID="txtDocDES" CssClass="texthieht"   style="text-transform:uppercase;" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px" ValidationGroup="aaa"></asp:TextBox>
                                                    <asp:RequiredFieldValidator runat="server" ID="Req" ControlToValidate="txtDocDES" Display="None" ErrorMessage="<b> Missing Field</b><br />Please input document name." ValidationGroup="aaa" />
                                          ...
                                          <tr>
                                                ...
                                                <td class="auto-style10">Inventory Impact</td>
                                                <td class="padspace">
                                                    <div class="texthieht">
                                            ...
                                            <tr>
                                                <td class="auto-style6"><strong>Menu</strong></td>
                                                <td class="auto-style11">
                                                    <asp:DropDownList ID="ddlMenu" Width="250px" CssClass="select2" runat="server" ValidationGroup="aaa" AutoPostBack="True" OnSelectedIndexChanged="ddlMenu_SelectedIndexChanged"  ></asp:DropDownList>
                                                    <asp:RequiredFieldValidator runat="server" ID="req1" ControlToValidate="ddlMenu" InitialValue="Please select..." Display="None" ErrorMessage="<b> Missing Field</b><br />Please Select Menu." ValidationGroup="aaa" />
                                                    <ajaxToolkit:ValidatorCalloutExtender ID="ValidatorCalloutExtender3" TargetControlID="req1" runat="server" HighlightCssClass="vali" PopupPosition="Left"></ajaxToolkit:ValidatorCalloutExtender>
                                                </td>
                                                <td class="auto-style10">Form</td>
                                                <td class="padspace">
                                                    <div class="texthieht">
                                                    <asp:DropDownList ID="ddlForm" Width="250px" CssClass="select2" runat="server" ValidationGroup="aaa" ></asp:DropDownList>
                                                    <%--<asp:RequiredFieldValidator runat="server" ID="req3" ControlToValidate="ddlForm" InitialValue="Please select..." Display="None" ErrorMessage="<b> Missing Field</b><br />Please Select Form." ValidationGroup="aaa" />
                                                    <ajaxToolkit:ValidatorCalloutExtender ID="ValidatorCalloutExtender4" TargetControlID="req3" runat="server" HighlightCssClass="vali" PopupPosition="Left"></ajaxToolkit:ValidatorCalloutExtender>--%>
                                                    </div>
                                                </td>
                                              ...
                                              <tr>
                                                ...
                                                <td class="auto-style10">Account Code</td>
                                                <td class="padspace">
                                                    <telerik:RadComboBox RenderMode="Lightweight" ID="RadComboAcct_Code" runat="server" Height="200" Width="250"
                                                        DropDownWidth="500" EmptyMessage="select Account code" HighlightTemplatedItems="true"
                                            ...
                                            <tr>
                                                ...
                                                <td class="auto-style11">
                                                    ...
                                                    <ajaxToolkit:ValidatorCalloutExtender ID="ValidatorCalloutExtender4" TargetControlID="RequiredFieldValidator2" runat="server" HighlightCssClass="vali" PopupPosition="Right"></ajaxToolkit:ValidatorCalloutExtender>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="auto-style6"><strong>Have Document No</strong></td>
                                                <td class="auto-style11">
                                                     <asp:RadioButton ID="rdb_hDOCY" runat="server" GroupName="Hidedoc" Text="YES" AutoPostBack="True" OnCheckedChanged="rdb_hDOCY_CheckedChanged" />
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    <asp:RadioButton ID="rdb_hDOCN" runat="server" GroupName="Hidedoc" Text="NO" AutoPostBack="True" OnCheckedChanged="rdb_hDOCN_CheckedChanged" />
                                                </td>
                                                <td class="auto-style10">Monthly Base / Yearly Base</td>
                                                <td class="padspace">
                                                      <asp:RadioButton ID="rdb_Monthly" runat="server" GroupName="Hidemy" Text="Monthly" />
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    <asp:RadioButton ID="rdb_yearly" runat="server" GroupName="Hidemy" Text="Yearly" />
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="auto-style11">
                                                      <asp:RadioButton ID="rdb_SiteY" runat="server" GroupName="Hidesite" Text="Main" />
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    <asp:RadioButton ID="rdb_SiteN" runat="server" GroupName="Hidesite" Text="Site" />
                                                </td>   

                                            </tr>
                                            <tr>
                                                <td class="auto-style6"><strong>More Actount Code</strong></td>
                                                <td class="auto-style11">
                                                     <asp:RadioButton ID="rdb_MAC_Y" runat="server" GroupName="HideMAC" Text="YES" />
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    <asp:RadioButton ID="rdb_MAC_N" runat="server" GroupName="HideMAC" Text="NO" />
                                                </td>
                                                <td class="auto-style10">More Business Partners</td>
                                                <td class="padspace">
                                                     <asp:RadioButton ID="rdb_MBP_Y" runat="server" GroupName="HideMBP" Text="YES" />
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    <asp:RadioButton ID="rdb_MBP_N" runat="server" GroupName="HideMBP" Text="NO" />
                                                </td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table style="width: 100%;">
                        ...
                        DropDownWidth="500" EmptyMessage="Please Select" HighlightTemplatedItems="true"
                        ...
                        <ItemTemplate>
                            <table style="width: 500px" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td style="width: 60px;">
                                        <%# DataBinder.Eval(Container, "Attributes['Menu_title']")%>
                                    </td>
                        ...
                        <tr>
                            ...
                            <td><asp:DropDownList ID="ddlEdit_DOCType" CssClass="form-control select2" Width="100%" runat="server"></asp:DropDownList></td>
                        </tr>
                           ...
                           <tr>
                            ...
                            <td><asp:DropDownList ID="ddlEdit_Menu" CssClass="form-control select2" Width="100%" runat="server"></asp:DropDownList></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><asp:DropDownList ID="ddlEdit_form" CssClass="form-control select2" Width="100%" runat="server"></asp:DropDownList></td>
                        </tr>
                       ...
                       <HeaderTemplate>
                        ...
                        <ItemTemplate>
                         ...
                         <tr>
                            ...
                            <td><asp:DropDownList ID="ddlFind_DocType" CssClass="form-control select2" Width="100%" runat="server"></asp:DropDownList></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><asp:DropDownList ID="ddlFind_Menu" CssClass="form-control select2" Width="100%" runat="server"></asp:DropDownList></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><asp:DropDownList ID="ddFind_Form" CssClass="form-control select2" Width="100%" runat="server"></asp:DropDownList></td>
                        </tr>
                       ...
                       <HeaderTemplate>
                        ...
                        <ItemTemplate>
                         ...
                         <tr>
                            ...
                            <td><asp:DropDownList ID="ddlDel_DocTypes" CssClass="form-control select2" Width="100%" runat="server"></asp:DropDownList></td>
                        </tr>
                         ...
                         <tr>
                            ...
                            <td><asp:DropDownList ID="ddlDel_Menu" CssClass="form-control select2" Width="100%" runat="server"></asp:DropDownList></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><asp:DropDownList ID="ddlDel_Form" CssClass="form-control select2" Width="100%" runat="server"></asp:DropDownList></td>
                        </tr>
