<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="SET_GenBackDoc.aspx.cs" Inherits="frm_Period" %>
                ...
                <div class="box box-solid shadowbox " style="border-radius: 15px;">
                    <div class="box-header with-border" style="height: 75px;">
                        <div style="padding-top: 0px; width: 120px; float: left;">
                            <div id="tabmenu">
                                <h3 class="box-title" style="color: #fff; padding-left: 10px;"><strong>GENERATE BACKGROUND DOCUMENT</strong></h3>
                            </div>
                        </div>
                                        ...
                                        <table id="tablecontent1" runat="server" style="width: 100%;">
                                            <tr>
                                                ...
                                                <td class="auto-style11">
                                                    ...
                                                    <asp:DropDownList ID="ddldoctype" CssClass="select2" Width="250px" ValidationGroup="aaa" runat="server"></asp:DropDownList>
                                                    
                                                     <asp:RequiredFieldValidator runat="server" ID="Req" ControlToValidate="ddldoctype" InitialValue="Please select..." Display="None" ErrorMessage="<b> Missing Field</b><br />Please select DocType." ValidationGroup="aaa" />
                                                ...
                                                <td class="auto-style6"><strong>Auto Generate Doc</strong></td>
                                                <td class="auto-style11">
                                                    <asp:DropDownList ID="ddlAutoGenDoc" runat="server" CssClass="select2" ValidationGroup="aaa" Width="250px">
                                                    </asp:DropDownList>
                                                      <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1" ControlToValidate="ddlAutoGenDoc" InitialValue="Please select..." Display="None" ErrorMessage="<b> Missing Field</b><br />Please select Auto Generate Document." ValidationGroup="aaa" />
                                             ...
                                             <tr>
                                                <td class="auto-style6"><strong>Direct CheckBox</strong></td>
                                                <td class="auto-style11">
                                                    <asp:Panel ID="Panel2" runat="server">
                                                        <asp:CheckBox ID="chkDirect" runat="server" Text="Yes" TabIndex="3" />
                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    </asp:Panel>
                                            ...
                                            <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover tableFixHead" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" >
                                                <Columns>
                                                    ...
                                                    <HeaderStyle Width="500px" />
                                                     ...
                                                     <asp:BoundField DataField="autogen" HeaderText="autogen" SortExpression="autogen" >
                                                    <HeaderStyle Width="500px" />
                                                    </asp:BoundField>
