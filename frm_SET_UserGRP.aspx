<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frm_SET_UserGRP.aspx.cs" Inherits="frm_SET_COA_Master" EnableEventValidation="false" %>
     ...
     <script>
        function alertme() {
            swal("Insert Successfuly!", "record has been saved!!!", "success")
                .then(function () {
                    window.location = "frm_SET_UserGRP.aspx?UserID=" + userid + "&UsergrpID=" + UserGrpID + "&fiscaly=" + fiscal + "&FormID=" + FormID + "";
            });
                ...
                <div class="box box-solid shadowbox " style="border-radius: 15px;">
                    <div class="box-header with-border" style="height:75px;">
                        ...
                        <div style=" padding-top:0px; width:120px;float:left;">
                            <div id="tabmenu">
                                <h3 class="box-title" style="color: #fff; padding-left: 10px;"><strong>User Group</strong></h3>
                            </div>
                        </div>
                             ...
                             <div id="fieldbox" runat="server">
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style7">
                                        <div>
                                         <asp:TextBox ID="txtUserGrpName" CssClass="form-control texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black"></asp:TextBox>
                                            <%--<asp:Label ID="lblUserGrpName" runat="server" Font-Italic="False" ForeColor="Black"></asp:Label>--%>

                                             <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1" ControlToValidate="txtUserGrpName"  Display="None" ErrorMessage="<b> Missing Field</b><br />Please Enter User Group Name." ValidationGroup="aaa" />
                                    ...
                                    <td class="auto-style1 ">
                                       <div>
                                            <asp:TextBox ID="txtdescription" CssClass="form-control texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black"></asp:TextBox>
                                             <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator2" ControlToValidate="txtdescription"  Display="None" ErrorMessage="<b> Missing Field</b><br />Please Enter Description." ValidationGroup="aaa" />
                                        ...
                                        <%--  ENd Modals --%>
                                          ...
                                          <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover tableFixHead" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Sno" HeaderText="ID" SortExpression="Sno" ReadOnly="True" InsertVisible="False" >
                                                <HeaderStyle Width="20px" />
                                                </asp:BoundField>
