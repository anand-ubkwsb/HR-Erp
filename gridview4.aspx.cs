...
public partial class frm_Period : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Page.IsPostBack == false)
        {
            ...
            inv.gridv(GridView11);
            string v = inv.totalval(GridView11).ToString();
            lblval.Text =  inv.FinancialroundOff_Value(branchId().ToString(), v);
            GridView12.Visible = true;
            inv.DataView(GridView12);
    ...
    protected void btnInsert_Click(object sender, EventArgs e)
    {
        ...
        DataTable dta =   inv.DataView_Ret(GridView12);
        ViewState["dta"] = dta;
    ...
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                txtCreateddate.Text = dml.dateConvert(ds.Tables[0].Rows[0]["CreatedDate"].ToString()) + " " + ds.Tables[0].Rows[0]["CreatedBy"].ToString();
    ...
    protected void ddlitemsub_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        DropDownList ddlsubitem = GridView12.FooterRow.FindControl("ddlItemSubHeadFooter") as DropDownList;
        DropDownList ddlmaster = GridView12.FooterRow.FindControl("ddlItemMasterFooter") as DropDownList;
    ...
    protected void ddlitemMaster_SelectedIndexChanged(object sender, EventArgs e)
    {
        DropDownList ddlmaster = GridView12.FooterRow.FindControl("ddlItemMasterFooter") as DropDownList;
        DropDownList ddlsubitem = GridView12.FooterRow.FindControl("ddlItemSubHeadFooter") as DropDownList;
        RadComboBox ddlaccout = GridView12.FooterRow.FindControl("RadComboAcct_CodeFooter") as RadComboBox;
        if (ddlmaster.SelectedIndex != 0)
        {
            ...
            string valitem1 = "";
            string valitemcode= "";
            DropDownList ddluomm = GridView12.FooterRow.FindControl("ddlUOMFooter") as DropDownList;
            ...
            DropDownList ddluomm2 = GridView12.FooterRow.FindControl("ddlUOM2Footer") as DropDownList;
            ...
            string dbcr_detail = "";
            DataSet dsdebcr_detail = dml.Find("SELECT	GLImpact, InventoryImpact,AccountType FROM SET_AcRules4Doc WHERE DocId = '15' AND MasterDetail = 'D' AND CompID = '" + compid() + "' AND Record_Deleted = 0 AND IsActive = 1 AND IsHide = 0 ;");
            if (dsdebcr_detail.Tables[0].Rows.Count > 0)
            {
    ...
    protected void GridView6_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        inv.GV_Addcommand(GridView12, (DataTable)ViewState["dta"], ViewState["flag"].ToString());
        ViewState["flag"] = "false";
    }
    protected void GridView6_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
       
        inv.GV_RowDeleting(GridView12, e, (DataTable)ViewState["dta"]);
    ...
    {
        inv.GV_EditCommand(GridView12, e, (DataTable)ViewState["dta"],true);
    }
    ...
    {
        inv.GV_RowUpdating(GridView12, e, (DataTable)ViewState["dta"]);
    }
    protected void GridView6_RowCancelingEdit(object sender, GridViewCancelEditEventArgs e)
    {
        inv.GV_RowCancelingEdit(GridView12, e, (DataTable)ViewState["dta"]);
    }
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        //TreeNode leafNode = new TreeNode("Leaf Node");
    ...
    {
        string EncryptionKey = "SADASDAS12545ASDASD";
    ...
    {
        dml.Update("update SET_GOC set MLD = '"+Encrypt("q")+"' where GocId = 1", "");
        
    }
    protected void LinkButton2_Click(object sender, EventArgs e)
    {
        Label1.Text = Decrypt(Label1.Text);
    }

    protected void Button2_Click(object sender, EventArgs e)
    {
      Label1.Text =   inv.FinancialroundOff_Value("1","4563.51");
    }
}
