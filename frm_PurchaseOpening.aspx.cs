...
public partial class frm_Period : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        if (IsPostBack)
        {
            ...
            try
            {
                ...
                DataSet ds = dml.Find("INSERT INTO [Fin_PurOpeningMaster] ([DocId], [DocType], [BPartnerID], [Status], [Remarks], [IsActive], [GocID], [CompId], [BranchId], [FiscalYearID], [CreatedBy], [CreatedDate], [Record_Deleted], [ReferNo], [FWD_Id]) VALUES"
                                     + " ('" + ddlDocName.SelectedItem.Value + "', NULL, '" + ddlSupplier.SelectedItem.Value + "', '" + ddlStatus.SelectedItem.Value + "', '" + txtDesc.Text + "', '" + chk + "', " + gocid() + ", " + compid() + ", " + branchId() + ", " + FiscalYear() + ", '" + show_username() + "', '" + DateTime.Now.ToString("dd-MMM-yyyy hh:mm:ss.ffff") + "', 0, NULL, NULL);SELECT * FROM Fin_PurOpeningMaster WHERE Sno = SCOPE_IDENTITY()");
    ...
    protected void btn_Search_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            GridView1.DataBind();
            string swhere;
            string squer = "select * from View_Fin_PurchaseOpeningFED";

            if (cmbFind_Accountcode.SelectedIndex != 0)
            {
                swhere = "DocId like '" + cmbFind_Accountcode.Text + "%'";
            }
            else
            {
            ...
            {
                swhere = swhere + " and BPartnerID = '" + txtFind_GlDate.Text + "'";
            }
            else
            {
                swhere = swhere + " and BPartnerID is not null";
            }

            if (txtFind_openValue.Text != "")
            {
                swhere = swhere + " and Status like '" + txtFind_openValue.Text + "%'";
            }
            else
            {
            ...
            squer = squer + " where " + swhere + " and  GocID = '" + gocid() + "' and CompId = '" + compid() + "' and BranchId = '" + branchId() + "' and Record_Deleted = '0' ORDER BY DocDescription";
    ...
    protected void btn_delete_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                swhere = "DocId like '" + cmbDel_AcctCode.Text + "%'";
            }
            else
            {
                swhere = "DocId is not null";
            ...
            {
                swhere = swhere + " and BPartnerID = '" + txtDel_GlDate.Text + "'";
            }
            else
            {
                swhere = swhere + " and BPartnerID is not null";
            ...
            {
                swhere = swhere + " and Status like '" + txtDel_OpenValue.Text + "%'";
            }
            else
            {
                swhere = swhere + " and Status is not null";
    ...
    protected void btnSearchEdit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                swhere = "DocId like '" + RadComboBoxProduct.Text + "%'";
            }
            else
            {
                swhere = "DocId is not null";
            ...
            {
                swhere = swhere + " and BPartnerID = '" + txtEdit_GlDate.Text + "'";
            }
            else
            {
                swhere = swhere + " and BPartnerID is not null";
            ...
            {
                swhere = swhere + " and Status like '" + txtEdit_OpenValue.Text + "%'";
            }
            else
            {
                swhere = swhere + " and Status is not null";
        ...
        if (FiscalStatusId == 1)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                if (i != 0)
                {
                    ...
                    if (dml.returnDmlResultInString(UserGroupFormDataSet, "DmlAllowed") == "Y")
                    {
    ...
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            DataSet ds = dml.Find("select * from Fin_PurOpeningMaster where Sno  = '" + serial_id + "' and Record_Deleted = 0");
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                if (ddlSupplier.Items.FindByValue(ds.Tables[0].Rows[0]["BPartnerID"].ToString()) != null)
                {
                ...
                txtUpdateDate.Enabled = false;
                DataSet ds_detail_Payment = dml.Find("Select [Sno], [Sno_Master], [DrAccountCode] as AccountCode, CONVERT(varchar,[EntryDate],6) as EntryDate, [VoucherNo], [BillNo], CONVERT(varchar,[BillDate],6) as BillDate, [StaxInvNo] as GstBillNo, [DcNo], [GrnNo], [PoNo] as PoGRn, [Value] as BillAmount, [TaxAmount] as GstAmount, [TotalAmount], [BalanceAmount] as BillBalance, [BalanceTax] as GstBalance, [Status], [ReferNo], [GocId], [CompId], [BranchId], [FiscalYearID], [CreatedBy], [CreatedDate], [UpdatedBy], [UpdatedDate], [Record_Deleted], [TempLockUser], [RowNo] from Fin_PurOpeningDetail where Sno_Master = '" + serial_id + "'");
                if (ds_detail_Payment.Tables[0].Rows.Count > 0)
                {
                    Div2.Visible = true;
                    GridView6.DataSource = ds_detail_Payment.Tables[0];
                    GridView6.ShowFooter = false;
                    GridView6.DataBind();
                }
    ...
    public int compid()
    {
        string CompId = Request.Cookies["BranchId"].Value;
...
new DataColumn("CreateDate",typeof(string))
    ...
    protected void btnYes_Click(object sender, EventArgs e)
    {
        ...
        {
            Detailfileupload(sender, e);

        }
        if (rdbMaster.Checked == true)
        {
            masterfileupload(sender, e);
        }
        if (rdbDetail.Checked == false && rdbMaster.Checked == false)
        {
            Label1.Text = "Please select Master or Detail";
        }
    }
    ...
    protected void GridView6_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            if (e.CommandName.Equals("AddNew"))
            {
                ...
                string RadComboAcct_CodeFooter = (GridView6.FooterRow.FindControl("RadComboAcct_CodeFooter") as RadComboBox).Text;
                string txtEntrydateFooter = (GridView6.FooterRow.FindControl("txtEntrydateFooter") as TextBox).Text;
                string lbltxtVoucherNoFooter = (GridView6.FooterRow.FindControl("txtVoucherNoFooter") as TextBox).Text;
                string txtBillNoFooter = (GridView6.FooterRow.FindControl("txtBillNoFooter") as TextBox).Text;
                string txtBillDateFooter = (GridView6.FooterRow.FindControl("txtBillDateFooter") as TextBox).Text;
                string txtBillAmountFooter = (GridView6.FooterRow.FindControl("txtBillAmountFooter") as TextBox).Text;
                string txtGstBillNoFooter = (GridView6.FooterRow.FindControl("txtGstBillNoFooter") as TextBox).Text;
                string txtGstAmountFooter = (GridView6.FooterRow.FindControl("txtGstAmountFooter") as TextBox).Text;
                string txtTotalAmountFooter = (GridView6.FooterRow.FindControl("txtTotalAmountFooter") as TextBox).Text;
                string txtBillBalanceFooter = (GridView6.FooterRow.FindControl("txtBillBalanceFooter") as TextBox).Text;
                string txtGSTBalanceFooter = (GridView6.FooterRow.FindControl("txtGSTBalanceFooter") as TextBox).Text;
                string txtPoGRNFooter = (GridView6.FooterRow.FindControl("txtPoGRNFooter") as TextBox).Text;
                string txtStatusFooter = (GridView6.FooterRow.FindControl("txtStatusFooter") as TextBox).Text;
                ...
                dt.Rows.Add(RadComboAcct_CodeFooter, txtEntrydateFooter, lbltxtVoucherNoFooter, txtBillNoFooter, txtBillDateFooter, txtBillAmountFooter, txtGstBillNoFooter, txtGstAmountFooter, txtTotalAmountFooter, txtBillBalanceFooter, txtGSTBalanceFooter, txtPoGRNFooter, txtStatusFooter);
    ...
    public string startdate(string fy)
    {
        ...
        DataSet ds = dml.Find("select StartDate,EndDate from SET_Fiscal_Year where  FiscalYearId=" + FiscalYear());
        if (ds.Tables[0].Rows.Count > 0)
        {
    ...
    public void detailinsert(string masterid)
    {
        foreach (GridViewRow g in GridView6.Rows)
        {
            ...
            Label lblEntryDate = (Label)g.FindControl("lblEntryDate");
            Label lblVoucherNo = (Label)g.FindControl("lblVoucherNo");
            Label lblBillDate = (Label)g.FindControl("lblBillDate");
            Label lblBillNo = (Label)g.FindControl("lblBillNo");
            Label lblBillAmount = (Label)g.FindControl("lblBillAmount");
            Label lblGstBillNo = (Label)g.FindControl("lblGstBillNo");
            Label lblGstAmount = (Label)g.FindControl("lblGstAmount");
            Label lblTotalAmount = (Label)g.FindControl("lblTotalAmount");
            Label lblBillBalance = (Label)g.FindControl("lblBillBalance");
            Label lblGSTBalance = (Label)g.FindControl("lblGSTBalance");
            Label lblPoGRN = (Label)g.FindControl("lblPoGRN");
            Label lblStatus = (Label)g.FindControl("lblStatus");

            DataSet Branch = dml.Find("Select * From Set_Branch Where BranchId=" + Request.Cookies["BranchId"].Value);
            int FinancialRoundOff=0, DisplayDigit=0;
            ...
            lblBillAmount.Text = utl.RoundOff(DisplayDigit, FinancialRoundOff, lblBillAmount.Text);
            lblBillBalance.Text = utl.RoundOff(DisplayDigit, FinancialRoundOff, lblBillBalance.Text);
            lblTotalAmount.Text = utl.RoundOff(DisplayDigit, FinancialRoundOff, lblTotalAmount.Text);
            dml.Insert("INSERT INTO [Fin_PurOpeningDetail] ([Sno_Master], [DrAccountCode], [EntryDate], [VoucherNo], [BillNo], [BillDate], [StaxInvNo], [DcNo], [GrnNo], [PoNo], [Value], [TaxAmount], [TotalAmount], [BalanceAmount], [BalanceTax], [Status], [ReferNo], [GocId], [CompId], [BranchId], [FiscalYearID], [CreatedBy], [CreatedDate],  [Record_Deleted], [TempLockUser], [RowNo]) VALUES"
                                                             + " ('" + masterid + "', '" + lblAccountCode.Text + "', '" + lblEntryDate.Text + "', '" + lblVoucherNo.Text + "', '" + lblBillNo.Text + "', '" + lblBillDate.Text + "', '" + lblGstBillNo.Text + "', '" + ddlDocName.SelectedItem.Value + "', NULL, NULL, '" + lblTotalAmount.Text + "', '" + lblGstAmount.Text + "', '" + lblTotalAmount.Text + "','" + lblTotalAmount.Text + "', '" + lblGSTBalance.Text + "', '" + lblStatus.Text + "', NULL," + gocid() + "," + compid() + "," + branchId() + "," + FiscalYear() + ", '" + show_username() + "', '" + DateTime.Now.ToString("dd-MMM-yyyy hh:mm:ss.ffff") + "', 0, NULL, NULL)", "");
    ...
    public void masterfileupload(object sender, EventArgs e)
    {
            ...
            try
            {
                ...
                if (flag == true)
                {
                    using (OleDbConnection excel_con = new OleDbConnection(conString))
                    {
                        ...
                        //Change Here
                        dtExcelData.Columns.AddRange(new DataColumn[13] { new DataColumn("DocId", typeof(string)),
...
//Acct_Type_ID
                        ...
                        using (OleDbDataAdapter oda = new OleDbDataAdapter("SELECT * , '" + gocid() + "' as GocID, '" + compid() + "' as CompId, '" + branchId() + "' as BranchId , '" + FiscalYear() + "' as FiscalYearID , '" + DateTime.Now.ToString("dd-MMM-yyyy hh:mm:ss.ffff") + "' as CreateDate ,'" + show_username() + "' as CreatedBy, 'false' as Record_Deleted,'1' as Status, 'true' as UploadButtonDis_Ena , 'true'as IsActive  FROM [" + sheet1 + "]", excel_con))
                        {
                            oda.Fill(dtExcelData);
                        ...
                        using (SqlConnection con = new SqlConnection(consString))
                        {
                            using (SqlBulkCopy sqlBulkCopy = new SqlBulkCopy(con))
                            {
                                ...
                                sqlBulkCopy.DestinationTableName = "dbo.Fin_PurOpeningMaster";

                                sqlBulkCopy.ColumnMappings.Add("DocId", "DocId");
                                sqlBulkCopy.ColumnMappings.Add("DocType", "DocType");
                                ...
                                sqlBulkCopy.ColumnMappings.Add("CreatedBy", "CreatedBy");
                                sqlBulkCopy.ColumnMappings.Add("Record_Deleted", "Record_Deleted");
                                sqlBulkCopy.ColumnMappings.Add("CreateDate", "CreatedDate");
                                //IsActive
                                con.Open();
                                sqlBulkCopy.WriteToServer(dtExcelData);
                                Panel3.Visible = true;
    ...
    public void Detailfileupload(object sender, EventArgs e)
    {
            ...
            try
            {
                ...
                if (flag == true)
                {
                    using (OleDbConnection excel_con = new OleDbConnection(conString))
                    {
                        ...
                        //Change Here
                        dtExcelData.Columns.AddRange(new DataColumn[24] { new DataColumn("Sno_Master", typeof(string)),
                new DataColumn("DrAccountCode", typeof(string)),
                new DataColumn("EntryDate",typeof(string)) ,
                new DataColumn("VoucherNo",typeof(string)),
                new DataColumn("BillNo",typeof(string)),
                new DataColumn("BillDate",typeof(string)),
                new DataColumn("StaxInvNo",typeof(string)),
                new DataColumn("DcNo",typeof(string)),
                new DataColumn("GrnNo",typeof(string)),
                new DataColumn("PoNo",typeof(string)),
                new DataColumn("Value",typeof(string)),
                new DataColumn("TaxAmount",typeof(string)),
                new DataColumn("TotalAmount",typeof(string)),
                new DataColumn("BalanceAmount",typeof(string)),
                new DataColumn("BalanceTax",typeof(string)),
                            //End Change Here
                new DataColumn("Status",typeof(string)),
                new DataColumn("IsActive",typeof(string)),
                new DataColumn("GocID",typeof(string)),
                ...
                new DataColumn("CreateDate",typeof(string))
                        ...
                        using (SqlConnection con = new SqlConnection(consString))
                        {
                            using (SqlBulkCopy sqlBulkCopy = new SqlBulkCopy(con))
                            {
                                ...
                                sqlBulkCopy.DestinationTableName = "dbo.Fin_PurOpeningDetail";

                                sqlBulkCopy.ColumnMappings.Add("Sno_Master", "Sno_Master");
                                sqlBulkCopy.ColumnMappings.Add("DrAccountCode", "DrAccountCode");
                                ...
                                sqlBulkCopy.ColumnMappings.Add("StaxInvNo", "StaxInvNo");
                                sqlBulkCopy.ColumnMappings.Add("DcNo", "DcNo");
                                sqlBulkCopy.ColumnMappings.Add("GrnNo", "GrnNo");
                                sqlBulkCopy.ColumnMappings.Add("PoNo", "PoNo");
                                ...
                                sqlBulkCopy.ColumnMappings.Add("BalanceAmount", "BalanceAmount");
                                sqlBulkCopy.ColumnMappings.Add("BalanceTax", "BalanceTax");
                                sqlBulkCopy.ColumnMappings.Add("Status", "Status");
                                sqlBulkCopy.ColumnMappings.Add("GocID", "GocId");
                                sqlBulkCopy.ColumnMappings.Add("CompId", "CompId");
                                sqlBulkCopy.ColumnMappings.Add("BranchId", "BranchId");
