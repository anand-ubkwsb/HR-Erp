<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frm_SetIremMasterOpening.aspx.cs" Inherits="frm_Period" %>
                ...
                <div class="box box-solid shadowbox " style="border-radius: 15px;">
                    <div class="box-header with-border" style="height: 75px;">
                        <div style="padding-top: 0px; width: 120px; float: left;">
                            <div id="tabmenu">
                                <h3 class="box-title" style="color: #fff; padding-left: 10px;"><strong>ITEM MASTER OPENING</strong></h3>
                            </div>
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="box-body" style="background-color: #cddbf2;">
                            <div id="fieldbox" runat="server">
                                        ...
                                        <table id="tablecontent1" runat="server" style="width: 100%;">
                                            <tr>
                                                ...
                                                <td class="auto-style11">
                                                      ...
                                                      <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator3" ControlToValidate="RadComboItem_Code"  Display="None" ErrorMessage="<b> Missing Field</b><br />Please Select Item Code." ValidationGroup="aaa" />
                                                    <ajaxToolkit:ValidatorCalloutExtender ID="ValidatorCalloutExtender5" TargetControlID="RequiredFieldValidator3" runat="server" HighlightCssClass="vali" PopupPosition="Left"></ajaxToolkit:ValidatorCalloutExtender>

                                                   <%--<asp:DropDownList ID="ddlItemCodes" Width="250px" CssClass=" form-control select2" runat="server" ValidationGroup="aaa"  ></asp:DropDownList>
                                                    <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1" ControlToValidate="ddlItemCodes" InitialValue="Please select..." Display="None" ErrorMessage="<b> Missing Field</b><br />Please Select Item Code." ValidationGroup="aaa" />
                                                    <ajaxToolkit:ValidatorCalloutExtender ID="ValidatorCalloutExtender3" TargetControlID="RequiredFieldValidator1" runat="server" HighlightCssClass="vali" PopupPosition="Left"></ajaxToolkit:ValidatorCalloutExtender>--%>
                                                </td>
                                                <td class="auto-style6"><strong>Purchase_Sales</strong></td>
                                                <td class="auto-style11">

                                                   <asp:Panel ID="Panel2" runat="server">
                                                        <asp:RadioButton ID="rdbPur" Text="Purchase" runat="server" GroupName="Group_L_I"/>
                                                        <asp:RadioButton ID="rdbSale" Text="Sale" runat="server" GroupName="Group_L_I"/>
                                                    </asp:Panel>
                                              ...
                                              <tr>
                                                ...
                                                <td class="auto-style11">
                                                    ...
                                                    <asp:RequiredFieldValidator runat="server" ID="Req" ControlToValidate="ddlDepartment" InitialValue="Please select..." Display="None" ErrorMessage="<b> Missing Field</b><br />Please Select Department." ValidationGroup="aaa" />
                                                    <ajaxToolkit:ValidatorCalloutExtender ID="ValidatorCalloutExtender1" TargetControlID="Req" runat="server" HighlightCssClass="vali" PopupPosition="Left"></ajaxToolkit:ValidatorCalloutExtender>
                                                </td>
                                                <td class="auto-style6"><strong>Busniss Partner</strong></td>
                                                <td class="auto-style11">

                                                    <asp:DropDownList ID="ddlBPartner" Width="250px" CssClass=" form-control select2" runat="server" ValidationGroup="aaa"  ></asp:DropDownList>
                                            ...
                                            <tr>
                                                ...
                                                <td class="auto-style6"><strong>Expiry Date<asp:Label ID="lblSteriek" runat="server" Text="" ForeColor="Red"></asp:Label></strong></td>
                                                <td class="auto-style11">
                                                    <div style="display:inline-block">
                                                        <div class="input-group input-group-sm">
                                                            <asp:TextBox ID="txtExpiryDate" CssClass="form-control texthieht" Width="220px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black"  ValidationGroup="aaa"></asp:TextBox>
                                                             <ajaxToolkit:CalendarExtender ID="CalendarExtender3" PopupButtonID="imgPopup12" TargetControlID="txtExpiryDate" Format="dd-MMM-yyyy" runat="server" />
                                                        
                                                            <span class="input-group-btn">
                                                                <%--<button type="button" class="btn btn-info btn-flat">Go!</button>--%>
                                                                <asp:ImageButton ID="imgPopup12" CssClass="btn btn-flat" ImageUrl="img/calendar.png" ImageAlign="Bottom" runat="server" />
                                                            </span>
                                                       </div>
                                             ...
                                             <tr>
                                                ...
                                                <td class="auto-style11">
                                                  <asp:TextBox ID="txtBillNo" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                                </td>
                                                ...
                                                <td class="auto-style11">
                                                   <div style="display:inline-block">
                                                       ...
                                                       <div class="input-group input-group-sm">
                                                           ...
                                                           <ajaxToolkit:CalendarExtender ID="CalendarExtender2" PopupButtonID="imgPopup1" TargetControlID="txtBillDate" Format="dd-MMM-yyyy" runat="server" />
                                             ...
                                             <tr>
                                                  <td class="auto-style6"><strong>Opening Quantity</strong></td>
                                                <td class="auto-style11">                                                 
                                                    <asp:TextBox ID="txtOpeningQuantity" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px" AutoPostBack="True" OnTextChanged="txtOpeningQuantity_TextChanged" ValidationGroup="aaa"></asp:TextBox>
                                                    <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" FilterType="Custom, Numbers" ValidChars="."  TargetControlID="txtOpeningQuantity" runat="server" />
                                                     <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1" ControlToValidate="txtOpeningQuantity"  Display="None" ErrorMessage="<b> Missing Field</b><br />Please Input Opening Quantity." ValidationGroup="aaa" />
                                                ...
                                                <td class="auto-style11">
                                                  <asp:TextBox ID="txtOpeningValue" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px" AutoPostBack="True" OnTextChanged="txtOpeningValue_TextChanged"></asp:TextBox>
                                                    <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender3" FilterType="Custom, Numbers" ValidChars="."  TargetControlID="txtOpeningValue" runat="server" />
                                            ...
                                            <tr>
                                                 <td class="auto-style6"><strong>Item Rate</strong></td>
                                                <td class="auto-style11">
                                                  <asp:TextBox ID="txtItemRate" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                                    <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" FilterType="Custom, Numbers" ValidChars="."  TargetControlID="txtItemRate" runat="server" />
                                                </td>
                                                 <td class="auto-style6"><strong>Balance Quantity</strong></td>
                                                <td class="auto-style11">
                                                    <asp:TextBox ID="txtBalance_Quantity" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                                    <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender4" FilterType="Custom, Numbers" ValidChars="."  TargetControlID="txtBalance_Quantity" runat="server" />
                                            ...
                                            <tr>
                                                <td class="auto-style6"><strong>Balance Value</strong></td>
                                                <td class="auto-style11">
                                                    <asp:TextBox ID="txtBalance_Value" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                                    <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender5" FilterType="Custom, Numbers" ValidChars="."  TargetControlID="txtBalance_Value" runat="server" />
                                                </td>

                                                <td class="auto-style6"><strong>Batch No</strong></td>
                                                <td class="auto-style11">
                                                    <asp:TextBox ID="txtBatchNo" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                                </td>
                                ...
                                <table id ="uploadtable"  runat="server" style="width: 50%;">
                                            <tr>
                                                <td class="auto-style14" width="230px">
                            ...
                            <ajaxToolkit:ModalPopupExtender ID="ModalPopupExtender2" runat="server"
                                CancelControlID="btnNo_2"
                                TargetControlID="btn_ok" PopupControlID="Panel5"
                                PopupDragHandleControlID="PopupHeader1" Drag="true"
                                BackgroundCssClass="ModalPopupBG">
                            </ajaxToolkit:ModalPopupExtender>

                             <asp:Panel ID="Panel5" Style="display:none" runat="server">
                                                        <div class="HellowWorldPopup">
                                        ...
                                        <div style="width: 100%; height: 400px; overflow: scroll">
                                            ...
                                            <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover tableFixHead" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="ItemMasterOpeningID" HeaderText="ID" SortExpression="ItemMasterOpeningID" InsertVisible="False" ReadOnly="True">
                                                    <HeaderStyle Width="20px" />
                                                    </asp:BoundField>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td class="rowpadd">
                                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                    <ContentTemplate>
                                        <telerik:RadComboBox RenderMode="Lightweight" ID="RadcmbItem_Code" runat="server" Height="200" Width="100%"
                                                        DropDownWidth="500" EmptyMessage="Choose a Item Code" HighlightTemplatedItems="true"
                                                        EnableLoadOnDemand="true" Filter="StartsWith"
                                                        AutoPostBack="true" 
                                                        OnItemsRequested="RadcmbItem_Code_ItemsRequested"
                                                        Label="">
                                                        <HeaderTemplate>
                                                            <table style="width: 100%" cellspacing="0" cellpadding="0">
                                                                <tr>
                        ...
                        <tr>
                            ...
                            <td class="rowpadd">
                                <div style="display:inline-block">
                                                        ...
                                                        <div class="input-group input-group-sm" >
                                                            <asp:TextBox ID="txtEdit_GlDate" CssClass="form-control texthieht" Width="350px"  runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black"  ValidationGroup="aaa"></asp:TextBox>
                                                             <ajaxToolkit:CalendarExtender ID="CalendarExtender4" PopupButtonID="ImageButton1" TargetControlID="txtEdit_GlDate" Format="dd-MMM-yyyy" runat="server" />
                        ...
                        <tr>
                            <td class="rowpadd"><strong>Opening Value :</strong> </td>
                            <td class="rowpadd">
                                <asp:TextBox ID="txtEdit_OpenVal" CssClass="texthieht" Width="100%" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px" AutoPostBack="True" OnTextChanged="txtOpeningValue_TextChanged"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td class="rowpadd">
                                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                    <ContentTemplate>
                                        <telerik:RadComboBox RenderMode="Lightweight" ID="radcmbFind_ItemCode" runat="server" Height="200" Width="100%"
                                                        DropDownWidth="500" EmptyMessage="Choose a Item Code" HighlightTemplatedItems="true"
                                                        EnableLoadOnDemand="true" Filter="StartsWith"
                                                        AutoPostBack="true" 
                                                        OnItemsRequested="radcmbFind_ItemCode_ItemsRequested"
                                                        Label="">
                                                        <HeaderTemplate>
                                                            <table style="width: 100%" cellspacing="0" cellpadding="0">
                                                                <tr>
                        ...
                        <tr>
                            ...
                            <td class="rowpadd">
                                <div style="display:inline-block">
                                                        ...
                                                        <div class="input-group input-group-sm" >
                                                            <asp:TextBox ID="txtFind_GlDate" CssClass="form-control texthieht" Width="350px"  runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black"  ValidationGroup="aaa"></asp:TextBox>
                                                             <ajaxToolkit:CalendarExtender ID="CalendarExtender5" PopupButtonID="ImageButton2" TargetControlID="txtFind_GlDate" Format="dd-MMM-yyyy" runat="server" />
                                                        <span class="input-group-btn">
                                                                <%--<button type="button" class="btn btn-info btn-flat">Go!</button>--%>
                         ...
                         <tr>
                            <td class="rowpadd"><strong>Department :</strong> </td>
                            <td class="rowpadd">
                                <asp:DropDownList ID="ddlFind_Department" CssClass="form-control select2" Width="100%" runat="server"></asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td class="rowpadd"><strong>Opening Value :</strong> </td>
                            <td class="rowpadd">
                                <asp:TextBox ID="txtFind_OpenVal" CssClass="texthieht" Width="100%" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px" AutoPostBack="True" OnTextChanged="txtOpeningValue_TextChanged"></asp:TextBox>
           ...
           <tr>
                            ...
                            <td class="rowpadd">
                                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                    <ContentTemplate>
                                        <telerik:RadComboBox RenderMode="Lightweight" ID="radcmbDel_Item_Code" runat="server" Height="200" Width="100%"
                                                        DropDownWidth="500" EmptyMessage="Choose a Item Code" HighlightTemplatedItems="true"
                                                        EnableLoadOnDemand="true" Filter="StartsWith"
                                                        AutoPostBack="true" 
                                                        OnItemsRequested="radcmbDel_Item_Code_ItemsRequested"
                                                        Label="">
                                                        <HeaderTemplate>
                                                            <table style="width: 100%" cellspacing="0" cellpadding="0">
                                                                <tr>
                        ...
                        <tr>
                            ...
                            <td class="rowpadd">
                                <div style="display:inline-block">
                                                        ...
                                                        <div class="input-group input-group-sm" >
                                                            <asp:TextBox ID="txtdel_Gldate" CssClass="form-control texthieht" Width="350px"  runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black"  ValidationGroup="aaa"></asp:TextBox>
                                                             <ajaxToolkit:CalendarExtender ID="CalendarExtender6" PopupButtonID="ImageButton3" TargetControlID="txtdel_Gldate" Format="dd-MMM-yyyy" runat="server" />
                                                        <span class="input-group-btn">
                                                                <%--<button type="button" class="btn btn-info btn-flat">Go!</button>--%>
                         ...
                         <tr>
                            <td class="rowpadd"><strong>Department :</strong> </td>
                            <td class="rowpadd">
                                <asp:DropDownList ID="ddlDel_Department" CssClass="form-control select2" Width="100%" runat="server"></asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td class="rowpadd"><strong>Opening Value :</strong> </td>
                            <td class="rowpadd">
                                <asp:TextBox ID="txtdel_OpenVal" CssClass="texthieht" Width="100%" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px" AutoPostBack="True" OnTextChanged="txtOpeningValue_TextChanged"></asp:TextBox>
