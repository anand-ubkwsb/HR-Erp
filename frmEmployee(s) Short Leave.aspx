<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frmEmployee(s) Short Leave.aspx.cs" Inherits="frm_Period" %>
                ...
                <div class="box box-solid shadowbox " style="border-radius: 15px;">
                    <div class="box-header with-border" style="height: 75px;">
                        <div style="padding-top: 0px; width: 120px; float: left;">
                            <div id="tabmenu">
                                <h3 class="box-title" style="color: #fff; padding-left: 10px;"><strong>Employee(s) Short Leave</strong></h3>
                            </div>
                        </div>
                        ...
                        <div class="box-body" style="background-color: #cddbf2;">
                            <div id="fieldbox" runat="server">
                                ...
                                <table id="tablecontent1" runat="server" style="width: 100%;">
                                      <tr>
                                                <td class="auto-style1"><strong>Emp. Id</strong></td>
                                    ...
                                    <tr>
                                                <td class="auto-style6"><strong>Terminal #</strong></td>
                                                <td class="auto-style1">
                                                    <asp:TextBox ID="TextBox3" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                                     
                                                     
                                                </td>
                                               <td class="auto-style6"><strong>Out Going ID</strong></td>
                                                <td class="auto-style1">
                                     ...
                                     <tr>
                                                <td class="auto-style6"><strong>Date Out</strong></td>
                                                <td class="auto-style1">
                                               ...
                                               <td class="auto-style6"><strong>Date In</strong></td>
                                                <td class="auto-style1">
                                     ...
                                     <tr>
                                                <td class="auto-style6"><strong>Deduct Time</strong></td>
                                                <td class="auto-style1">
                                               ...
                                               <td class="auto-style6"><strong>Remarks</strong></td>
                                                <td class="auto-style1">
                                                     <asp:TextBox ID="TextBox1" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
