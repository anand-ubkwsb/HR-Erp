<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frm_SupplQuotAppr.aspx.cs" Inherits="frm_Period"  EnableEventValidation="false" %>
                ...
                <div class="box box-solid shadowbox " style="border-radius: 15px;">
                    <div class="box-header with-border" style="height: 75px;">
                        <div style="padding-top: 0px; width: 120px; float: left;">
                            <div id="tabmenu">
                                <h3 class="box-title" style="color: #fff; padding-left: 10px;"><strong>Supplier Quotation & Approval</strong></h3>
                            </div>
                        </div>
                                ...
                                <table id="tablecontent1" runat="server" style="width: 100%;">
                                    <tr>
                                        ...
                                        <td class="auto-style11">
                                            ...
                                            <asp:DropDownList ID="ddlDocName" Width="250px" CssClass=" form-control select2" runat="server" ValidationGroup="aaa" AutoPostBack="True" OnSelectedIndexChanged="ddlDocName_SelectedIndexChanged"  ></asp:DropDownList>
                                        ...
                                        <td class="auto-style11" visible="false">
                                            ...
                                            <asp:DropDownList ID="ddlDocTypes" Width="250px" CssClass=" form-control select2" runat="server" ValidationGroup="aaa" ></asp:DropDownList>
                                            
                                            <asp:Panel ID="Panel2" runat="server" Visible="false"> 
                                                <asp:RadioButton ID="rdbDepartment" Text="Department" runat="server" Checked="true" GroupName="Group_L_I" CssClass="rdbgap"  />
                                                <asp:RadioButton ID="rdbPurchase" Text="Purchase" runat="server" GroupName="Group_L_I" />
                                            </asp:Panel>
                                    ...
                                    <tr>
                                        ...
                                        <td class="auto-style11">
                                            ...
                                            <asp:Label ID="lbldocno" runat="server" Visible="False"></asp:Label>
                                          
                                            <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator3" ControlToValidate="txtDocNo"  Display="None" ErrorMessage="<b> Missing Field</b><br />Please Select Document." ValidationGroup="aaa" />
                                    ...
                                    <tr>
                                          <td class="auto-style6"><strong>Direct Quuotation</strong></td>
                                        <td class="auto-style11">
                                            
                                            <asp:CheckBox ID="chkDirect" Text="Direct" runat="server" AutoPostBack="True" OnCheckedChanged="chkDirect_CheckedChanged" />
                                           
                                            
                                             

                                        </td>
                                        <td class="auto-style6"><strong>AFQ No. / Requisition No.</strong></td>
                                        <td class="auto-style11">
                                            <asp:DropDownList ID="ddlAFQ_ReqNo" Width="250px" CssClass=" form-control select2" runat="server" ValidationGroup="aaa" AutoPostBack="True" OnSelectedIndexChanged="ddlAFQ_ReqNo_SelectedIndexChanged">
                                               </asp:DropDownList>
                                            <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator2" ControlToValidate="ddlAFQ_ReqNo" InitialValue="Please select..." Display="None" ErrorMessage="<b> Missing Field</b><br />Please Select Document." ValidationGroup="aaa" />
                                    ...
                                    <tr>
                                        ...
                                        <td class="auto-style6"><strong>Delivery Date </strong></td>
                                        <td>
                                        <div style="display: inline-block">

                                                <div class="input-group input-group-sm">
                                                    <asp:TextBox ID="txtDeliveryDate" CssClass="form-control texthieht" Width="220px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" ValidationGroup="aaa"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td class="auto-style11">
                                            ...
                                            <asp:DropDownList ID="ddlModeOFPayment" Width="250px" CssClass=" form-control select2" runat="server" ValidationGroup="aaa">
                                            </asp:DropDownList>
                                            <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator5"  ControlToValidate="ddlModeOFPayment" InitialValue="Please select..."  Display="None" ErrorMessage="<b> Missing Field</b><br />Please select Payment mode." ValidationGroup="aaa" />
                                        ...
                                        <td class="auto-style6"><strong>Delivery Duration</strong></td>
                                        <td class="auto-style11">
                                            <asp:TextBox ID="txtDeliverDuration" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px" ValidationGroup="aaa"></asp:TextBox>
                                            <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator9" ControlToValidate="txtDeliverDuration" Display="None" ErrorMessage="<b> Missing Field</b><br />Please input document name." ValidationGroup="aaa" />
                                    ...
                                    <tr>
                                        ...
                                        <td class="auto-style6" visible="false"><strong>Remarks</strong></td>
                                        <td class="auto-style11" visible="false">
                                    ...
                                    <tr>
                                         <td class="auto-style6"><strong>Depatment</strong></td>
                                        <td class="auto-style11">
                                            <asp:DropDownList ID="ddlDepartment" Width="250px" CssClass=" form-control select2" runat="server" ValidationGroup="aaa">
                                            </asp:DropDownList>

                                            <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator11" ControlToValidate="ddlDepartment" InitialValue="Please select..." Display="None" ErrorMessage="<b> Missing Field</b><br />Please Select Department." ValidationGroup="aaa" />
                                        ...
                                        <td class="auto-style11">
                                            ...
                                            <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator10" ControlToValidate="ddlStatus" InitialValue="Please select..." Display="None" ErrorMessage="<b> Missing Field</b><br />Please Select Status." ValidationGroup="aaa" />
                                    ...
                                    <tr id="updatecol" runat="server">
                                        <td class="auto-style6" visible="false"><strong>Updated By</strong></td>
                                        <td class="auto-style11" visible="false">
                                        ...
                                        <div style="width: 100%; height: 400px; overflow: scroll">
                                            ...
                                            <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover tableFixHead" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" DataKeyNames="Sno">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="AFQ_RequisitionNo" HeaderText="AFQ_RequisitionNo" SortExpression="AFQ_RequisitionNo">
                                                    </asp:BoundField>
                                       ...
                                       <%-- CssClass="table table-bordered table-hover"--%>
                                        ...
                                        <div style="width: 100%; height: 200px; overflow: scroll">
                                            ...
                                            <asp:GridView ID="GridView5" AutoGenerateColumns="False" CssClass="table table-bordered table-hover tableFixHead" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" runat="server" DataKeyNames="Sno" OnRowDataBound="GridView5_RowDataBound" >
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Qty" SortExpression="Qty">
                                                     ...
                                                     <asp:TemplateField HeaderText="Approved Qty" SortExpression="ApprovedQty">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtApprovedQty" runat="server" Width="50px" Text='<%# Bind("BalanceQty") %>' AutoPostBack="True" OnTextChanged="txtApprovedQty_TextChanged"></asp:TextBox>
                                                    ...
                                                    <asp:TemplateField HeaderText="Rate" SortExpression="Quantity">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtRate" runat="server" Width="50px" AutoPostBack="true"  OnTextChanged="txtRate_TextChanged"></asp:TextBox>
                                                     ...
                                                     <asp:TemplateField HeaderText="GST %" SortExpression="RequiredQuantity">
                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:TextBox ID="txtGST" runat="server" Width="50px" AutoPostBack="True" OnTextChanged="txtGST_TextChanged"></asp:TextBox>
                                                     ...
                                                     <asp:TemplateField HeaderText="project" SortExpression="RequiredQuantity">
                                                        <EditItemTemplate>
                                                            <asp:TextBox ID="txtproject" runat="server" Text='<%# Bind("RequiredQuantity") %>'></asp:TextBox>
                                                        </EditItemTemplate>
                                                        <ItemTemplate>
                                                ...
                                                <FooterStyle BackColor="#CCCC99" ForeColor="Black" />
                                                <HeaderStyle BackColor="#000080" Font-Bold="True" ForeColor="White" BorderStyle="Solid" Height="2px" BorderWidth="1px" Wrap="True" />
                                                <PagerStyle BackColor="White" ForeColor="Black" HorizontalAlign="Right" />
                                            </asp:GridView>
                                        ...
                                        <div style="width: 100%; height: 400px; overflow: scroll">
                                            ...
                                            <asp:GridView ID="GridView4" AutoGenerateColumns="False" CssClass="table table-bordered table-hover tableFixHead"  BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Both" runat="server" DataKeyNames="Sno" OnRowDataBound="GridView4_RowDataBound" OnRowCancelingEdit="GridView4_RowCancelingEdit" OnRowEditing="GridView4_RowEditing" OnRowUpdating="GridView4_RowUpdating" >
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Requisition No" SortExpression="AFQ_RequisitionNo">
                                                        <EditItemTemplate>
                                                            <asp:Label ID="lblreq" runat="server" Text='<%# Bind("AFQ_RequisitionNo") %>'></asp:Label>
                                                        </EditItemTemplate>
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblreq" runat="server" Text='<%# Bind("AFQ_RequisitionNo") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="UOM" SortExpression="UOMName">
                                                        <EditItemTemplate>
                                                            ...
                                                            <asp:DropDownList ID="ddlUOMs" Width="80px" CssClass=" form-control select2" runat="server" ValidationGroup="aaa"></asp:DropDownList>
                                                            <asp:Label ID="lbluom" runat="server" Text='<%# Bind("UOMName") %>'></asp:Label>
                                                        </EditItemTemplate>
                                                        <ItemTemplate>
                                                            <asp:Label ID="lbluom" runat="server" Text='<%# Bind("UOMName") %>'></asp:Label>
                                                    ...
                                                    <asp:TemplateField HeaderText="Qty" SortExpression="Quantity">
                                                        <EditItemTemplate>
                                                            <asp:Label ID="txtQty" runat="server" Width="50px" Text='<%# Bind("Quantity") %>'></asp:Label>
                                                        </EditItemTemplate>
                                                        <ItemTemplate>
                                                     ...
                                                     <asp:TemplateField HeaderText="Approved Qty" SortExpression="ApprovedQuantity">
                                                        <EditItemTemplate>
                                                            <asp:TextBox ID="txtApprovedQty" Width="50px" runat="server" Text='<%# Bind("ApprovedQuantity") %>' AutoPostBack="True" OnTextChanged="txtApprovedQtygd4_TextChanged"></asp:TextBox>
                                                        </EditItemTemplate>
                                                        <ItemTemplate>
                                                            <%--<asp:TextBox ID="txtApprovedQty" runat="server" Width="50px" Text='<%# Bind("BalanceQty") %>'></asp:TextBox>--%>
                                                            <asp:Label ID="lblApprovedQty" runat="server" Text='<%# Bind("ApprovedQuantity") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Rate" SortExpression="Quantity">
                                                        <EditItemTemplate>
                                                            <asp:TextBox ID="txtRate" Width="50px"  Text='<%# Bind("Rate") %>' runat="server" AutoPostBack="True" OnTextChanged="txtRateQtygd4_TextChanged"></asp:TextBox>
                                                        </EditItemTemplate>
                                                        <ItemTemplate>
                                                            <%--<asp:TextBox ID="txtRate" runat="server" Width="50px"  OnTextChanged="txtRate_TextChanged"></asp:TextBox>--%>
                                                     ...
                                                     <asp:TemplateField HeaderText="GST Rate" SortExpression="GSTRate">
                                                        <EditItemTemplate>
                                                            <asp:Label ID="txtGSTRate" Width="50px" Text='<%# Bind("GSTRate") %>'  runat="server" ></asp:Label>
                                                        </EditItemTemplate>
                                                        <ItemTemplate>
                                                            <%--<asp:Label ID="lblGSTRate" runat="server"></asp:Label>--%>
                                                     ...
                                                     <asp:TemplateField HeaderText="Gross Value" SortExpression="GrossValue">
                                                        <EditItemTemplate>
                                                            <asp:Label ID="txtGrossValue" Width="50px" runat="server" Text='<%# Bind("GrossValue") %>'></asp:Label>
                                                        </EditItemTemplate>
                                                        <ItemTemplate>
                                                            <%--<asp:Label ID="lblQtyVal" runat="server" Visible="false"></asp:Label>--%>
                                                            <%--<asp:Label ID="lblGstValue" runat="server" Visible="false"></asp:Label>--%>
                                                     ...
                                                     <%--<asp:TemplateField HeaderText="Cost Center" SortExpression="LocName">
                                                        <EditItemTemplate>
                                                            <asp:TextBox ID="txtCostCenter" Width="50px" Text='<%# Bind("LocName") %>' runat="server"></asp:TextBox>
                                                        </EditItemTemplate>
                                                        <ItemTemplate> 
                                                            <%--<asp:DropDownList ID="ddlCostCenter" CssClass="form-control select2" Width="150px" runat="server"></asp:DropDownList>--%>
                                                           <%-- <asp:Label ID="lblCostCenter" runat="server" Text='<%# Bind("LocName") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>--%>

                                                     <asp:TemplateField HeaderText="Location" SortExpression="LocName">
                                                        <EditItemTemplate>
                                                            <asp:DropDownList ID="ddlLocation" Width="70px" CssClass=" form-control select2" runat="server" ValidationGroup="aaa"></asp:DropDownList>
                                                            <asp:Label ID="lblloc" runat="server" Text='<%# Bind("LocName") %>'></asp:Label>
                                                             <%--<asp:TextBox ID="txtLocation" runat="server" Text='<%# Bind("LocName") %>'></asp:TextBox>--%>
                                                        </EditItemTemplate>
                                                        <ItemTemplate>
                                                             <%--<asp:DropDownList ID="ddlLocation" CssClass="form-control select2" Width="150px" runat="server"></asp:DropDownList>--%>
                                                     ...
                                                     <asp:TemplateField HeaderText="project" SortExpression="Project">
                                                        <EditItemTemplate>
                                                            <asp:TextBox ID="txtproject" runat="server" Width="50px" Text='<%# Bind("Project") %>'></asp:TextBox>
                                                        </EditItemTemplate>
                                                        <ItemTemplate>
                                                            <%--<asp:TextBox ID="txtproject" Width="100px" runat="server"></asp:TextBox>--%>
                                                ...
                                                <FooterStyle BackColor="#CCCC99" ForeColor="Black" />
                                                <HeaderStyle BackColor="#000080" Font-Bold="True" ForeColor="White" BorderStyle="Solid" BorderWidth="1px" Wrap="True" />
                                                <PagerStyle BackColor="White" ForeColor="Black" HorizontalAlign="Right" />
                                            </asp:GridView>
                ...
                <div class="modal-body">
                    ...
                    <table style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td class="rowpadd">
                                <asp:DropDownList ID="ddlEdit_AFQRequisitionNo" Width="100%" CssClass=" form-control select2" runat="server" ValidationGroup="aaa">
