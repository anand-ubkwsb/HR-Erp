<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frm_Set_DocumentType.aspx.cs" Inherits="frm_Period" %>
                ...
                <div class="box box-solid shadowbox " style="border-radius: 15px;">
                    <div class="box-header with-border" style="height: 75px;">
                        <div style="padding-top: 0px; width: 120px; float: left;">
                            <div id="tabmenu">
                                <h3 class="box-title" style="color: #fff; padding-left: 10px;"><strong>DOCUMENT TYPE</strong></h3>
                            </div>
                        </div>
                                ...
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        ...
                                        <table id="tablecontent1" runat="server" style="width: 100%;">
                                            <tr>
                                                <td class="auto-style6"><strong>Document Type Name</strong></td>
                                                <td class="auto-style11">
                                                    <asp:TextBox ID="txtDocument_Name" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px" ValidationGroup="aaa"></asp:TextBox>
                                                    <asp:RequiredFieldValidator runat="server" ID="Req" ControlToValidate="txtDocument_Name" Display="None" ErrorMessage="<b> Missing Field</b><br />Please input document name." ValidationGroup="aaa" />
                                                ...
                                                <td class="auto-style10">Document Abbr</td>
                                                <td class="padspace">
                                                    <div class="texthieht">
                                                    <asp:TextBox ID="txtDocumnet_Abbr" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                                    </div>
                                                </td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table style="width: 100%;">
                        <tr>
                            <td><strong>Document Type Name</strong> </td>
                            <td>
