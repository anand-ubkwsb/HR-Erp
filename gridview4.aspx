<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="gridview4.aspx.cs" Inherits="frm_Period"  EnableEventValidation="false"%>
                ...
                <div class="box box-solid shadowbox " style="border-radius: 15px;">
                    <div class="box-header with-border" style="height: 75px;">
                     ...
                     <i class="fas fa-remove"></i>&nbsp Update PO
                            ...
                            <asp:LinkButton ID="btnShowJV" Height="40" CssClass="btn btn-app" runat="server" Style="left: 180px; background-color: #1f4f8a; color: white; right: 556px;" OnClick="btnShowJV_Click">
                     <i class="fas fa-remove"></i>&nbsp Show JV
                            </asp:LinkButton>



                               <asp:LinkButton ID="LinkButton1" Height="40" CssClass="btn btn-app" runat="server" Style="left: 180px; background-color: #1f4f8a; color: white;" OnClick="LinkButton1_Click" >
                     <i class="fas fa-remove"></i>&nbsp En
                            </asp:LinkButton>
                                  <asp:LinkButton ID="LinkButton2" Height="40" CssClass="btn btn-app" runat="server" Style="left: 180px; background-color: #1f4f8a; color: white;" OnClick="LinkButton2_Click" >
                     <i class="fas fa-remove"></i>&nbsp de
                            </asp:LinkButton>
                        </div>
                        ...
                        <div class="box-body" style="background-color: #cddbf2;">
                            <div id="fieldbox" runat="server">
                                ...
                                <table id="tablecontent1" runat="server" style="width: 100%;">
                                    ...
                                    <tr>
                                        <td class="auto-style6"><strong>Total val</strong></td>
                                        <td class="auto-style11">
                                    ...
                                    <ContentTemplate>
                                        ...
                                        <asp:GridView ID="GridView11" AutoGenerateColumns="False" CssClass="table table-bordered table-hover tableFixHead" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" runat="server" DataKeyNames="Sno" OnRowCancelingEdit="GridView10_RowCancelingEdit" OnRowEditing="GridView10_RowEditing" OnRowUpdating="GridView10_RowUpdating" OnRowDeleting="GridView10_RowDeleting">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Qty" SortExpression="RequiredQuantity" Visible="true">
                                                    <EditItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Rate" SortExpression="CostCenter" Visible="true">
                                                ...
                                                <asp:TemplateField HeaderText="Value" SortExpression="Project" Visible="true">
                                                    <EditItemTemplate>
                                    ...
                                    <ContentTemplate>
                                        <asp:GridView ID="GridView4" AutoGenerateColumns="False" CssClass="table table-bordered table-hover tableFixHead" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" runat="server" DataKeyNames="Sno" OnRowDataBound="GridView4_RowDataBound" OnRowCancelingEdit="GridView4_RowCancelingEdit" OnRowEditing="GridView4_RowEditing" OnRowUpdating="GridView4_RowUpdating">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Qty" SortExpression="RequiredQuantity">
                                                    <EditItemTemplate>
                ...
                <asp:GridView ID="GridView13" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-hover tableFixHead" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" ShowFooter="True" ShowHeaderWhenEmpty="True" DataKeyNames="Sno" DataSourceID="SqlDataSource1">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="AccountCode" SortExpression="AccountCode">
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("AccountCode") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="Label1" runat="server" Text='<%# Bind("AccountCode") %>'></asp:Label>
                            </ItemTemplate>
                      <FooterTemplate>
                        ...
                        <asp:TemplateField HeaderText="AccntDesc" SortExpression="AccntDesc">
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("AccntDesc") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="Label2" runat="server" Text='<%# Bind("AccntDesc") %>'></asp:Label>
                            </ItemTemplate>
                            <FooterTemplate>
                           <asp:TextBox ID="txtDesc" runat="server" Text=""></asp:TextBox>
                      </FooterTemplate>
                        ...
                        <asp:TemplateField HeaderText="Narration" SortExpression="Narration">
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox3" runat="server" Text='<%# Bind("Narration") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                        ...
                        <FooterTemplate>
                         ...
                         <asp:TemplateField HeaderText="Rowsno_RowsAll" SortExpression="Rowsno_RowsAll">
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox4" runat="server" Text='<%# Bind("Rowsno_RowsAll") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="Label4" runat="server" Text='<%# Bind("Rowsno_RowsAll") %>'></asp:Label>
                            </ItemTemplate>
                             <FooterTemplate>
                           <asp:TextBox ID="txtRow" runat="server" Text=""></asp:TextBox>
                      </FooterTemplate>
                    
                        </asp:TemplateField>


                        <asp:TemplateField HeaderText="ChangeToCost" SortExpression="ChangeToCost">
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox5" runat="server" Text='<%# Bind("ChangeToCost") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="Label5" runat="server" Text='<%# Bind("ChangeToCost") %>'></asp:Label>
                            </ItemTemplate>
                        <FooterTemplate>
                           <asp:TextBox ID="txtChange" runat="server" Text=""></asp:TextBox>
                      </FooterTemplate>
                        </asp:TemplateField>
