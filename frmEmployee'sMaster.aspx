<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frmEmployee'sMaster.aspx.cs" Inherits="frm_Period" %>
                ...
                <div class="box box-solid shadowbox " style="border-radius: 15px;">
                    <div class="box-header with-border" style="height: 75px;">
                        <div style="padding-top: 0px; width: 120px; float: left;">
                            <div id="tabmenu">
                                <h3 class="box-title" style="color: #fff; padding-left: 10px;"><strong>Employee's Master</strong></h3>
                            </div>
                        </div>
                        ...
                        <div class="box-body" style="background-color: #cddbf2;">
                            <div id="fieldbox" runat="server">
                                ...
                                <table id="tablecontent1" runat="server" style="width: 100%;">
                                      <tr>
                                                <td class="auto-style1"><strong>Employee No.</strong></td>
                                                <td class="auto-style1">
                                                    <asp:TextBox ID="txtEmpl" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                                     
                                                     
                                                </td>
                                               <td class="auto-style1"><strong>Employee</strong> <strong>Name</strong></td>
                                                <td class="auto-style1">
                                                    <asp:TextBox ID="txtTranStatus" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                     ...
                                     <tr>
                                                ...
                                                <td class="auto-style1">
                                                    <asp:TextBox ID="txtEmpName" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                                     
                                                     
                                                </td>
                                               <td class="auto-style6"><strong>Designation</strong></td>
                                                <td class="auto-style1">
                                                    <asp:TextBox ID="txtfileNo" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                    ...
                                    <tr>
                                                <td class="auto-style3"><strong>Father&#39;s</strong> <strong>Name </strong></td>
                                                <td class="auto-style3">
                                                    <asp:DropDownList ID="ddlDesignation" Width="250px" CssClass=" form-control select2" runat="server" ValidationGroup="aaa"></asp:DropDownList>
                                                     
                                                     
                                                </td>
                                               <td class="auto-style3"><strong>Family</strong> <strong>Code</strong></td>
                                                <td class="auto-style3">
                                                    <asp:TextBox ID="txtfileNo0" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                                    
                                                   </td>  
                                                <td class="auto-style3"><strong>Natioality<asp:TextBox ID="txtfileNo1" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                     ...
                                     <tr>
                                                <td class="auto-style6"><strong>Appoint Date </strong></td>
                                                <td class="auto-style1">
                                                    <asp:DropDownList ID="ddlappointmentDate" Width="250px" CssClass=" form-control select2" runat="server" ValidationGroup="aaa"></asp:DropDownList>
                                                     
                                                     
                                                </td>
                                               <td class="auto-style6"><strong>Date</strong> <strong>of</strong> <strong>Birth</strong></td>
                                                <td class="auto-style1">
                                                     <asp:DropDownList ID="ddlsalaryCode" Width="250px" CssClass=" form-control select2" runat="server" ValidationGroup="aaa"></asp:DropDownList>
                                                    
                                                   </td>  
                                                <td><strong>NTN #<asp:TextBox ID="txtfileNo2" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                     ...
                                     <tr>
                                                ...
                                                <td class="auto-style1">
                                                    <asp:TextBox ID="txtEmpName0" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                                     
                                                     
                                                </td>
                                               <td class="auto-style6"><strong>Sex</strong></td>
                                                <td class="auto-style1">
                                     ...
                                     <tr>
                                                <td class="auto-style6"><strong>Postal</strong> <strong>Code</strong></td>
                                                <td class="auto-style1">
                                                    <asp:TextBox ID="txtEmpName1" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                                     
                                                     
                                                </td>
                                               <td class="auto-style6"><strong>Country</strong></td>
                                                <td class="auto-style1">
                                                     <asp:TextBox ID="TextCNIC" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                                    
                                                   </td>  
                                                <td><strong>Religion<asp:RadioButton ID="Muslim" runat="server" Text="Muslim" />&nbsp;
                                                    <asp:RadioButton ID="Non_Muslim" runat="server" Text="Non-Muslim" />
                                                    </strong></td>
                                                <td></td>
                                     </tr>
                                        
                                     <tr>
                                                <td class="auto-style6"><strong>NIC #</strong></td>
                                                <td class="auto-style1">
                                                    <asp:TextBox ID="TextphoneNo" CssClass="auto-style2" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                                     
                                                     
                                                </td>
                                               <td class="auto-style6" style="font-weight: bold">Phone #</td>
                                                <td class="auto-style1">
                                                     <asp:TextBox ID="TextLeftDate" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                                    
                                                   </td>  
                                                <td>&nbsp;<strong>Mobile #
                                                    <asp:TextBox ID="TextSex0" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                     ...
                                     <tr>
                                                <td class="auto-style6"><strong>EODI Date</strong></td>
                                                <td class="auto-style1">
                                                    <asp:TextBox ID="TextphoneNo0" CssClass="auto-style2" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                                     
                                                     
                                                </td>
                                               <td class="auto-style6" style="font-weight: bold">EOBI #</td>
                                                <td class="auto-style1">
                                                     <asp:TextBox ID="TextLeftDate0" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                                    
                                                   </td>  
                                                <td><strong>EOBI Code<asp:TextBox ID="TextSex1" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                     ...
                                     <tr>
                                                <td class="auto-style6"><strong>Sessi Date</strong></td>
                                                <td class="auto-style1">
                                                    <asp:TextBox ID="TxtSessidste" CssClass="auto-style2" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                                     
                                                     
                                                </td>
                                               <td class="auto-style6" style="font-weight: bold">Sessi #</td>
                                                <td class="auto-style1">
                                                     <asp:TextBox ID="txtSessiNo" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                                    
                                                   </td>  
                                                <td><strong>Sessi Code<asp:TextBox ID="txtSessiCode" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                    ...
                                    <tr>
                                                <td class="auto-style6"><strong>G.Insr Date</strong></td>
                                                <td class="auto-style1">
                                                    <asp:TextBox ID="txtGinsDate" CssClass="auto-style2" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                                     
                                                     
                                                </td>
                                               <td class="auto-style6" style="font-weight: bold">Insr #</td>
                                                <td class="auto-style1">
                                                     <asp:TextBox ID="txtInsrNo" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                                    
                                                   </td>  
                                                <td><strong>Insr Code<asp:TextBox ID="txtInsrCode" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                    ...
                                    <tr>
                                                ...
                                                <td class="auto-style1">
                                                    <asp:TextBox ID="txtemail" CssClass="auto-style2" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                                     
                                                     
                                                </td>
                                               <td class="auto-style6" style="font-weight: bold">Account No</td>
                                                <td class="auto-style1">
                                                     <asp:TextBox ID="TextBox2" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                     ...
                                     <tr>
                                               <td class="auto-style6"><strong>Overtime Entitle</strong></td>
                                                <td class="auto-style1">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table style="width: 100%;">
                        <tr>
                            <td class="rowpadd"><strong>Employee ID</strong> </td>
                            <td class="rowpadd" >
                                
                                <asp:TextBox ID="txtempid" CssClass="texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                            </td>
                        </tr>
                       <tr>
    ...
    <div class="modal fade" id="modal_find">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <butaton type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</butaton>
