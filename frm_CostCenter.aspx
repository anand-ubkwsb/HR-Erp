<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frm_CostCenter.aspx.cs" Inherits="frm_Period" %>
                ...
                <div class="box box-solid shadowbox " style="border-radius: 15px;">
                    <div class="box-header with-border" style="height:75px;">
                        <div style="padding-top:0px; width: 120px; float: left;">
                            <div id="tabmenu">
                                <h3 class="box-title" style="color: #fff; padding-left: 10px;"><strong>COST CENTER</strong></h3>
                            </div>
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <ContentTemplate>
                            ...
                            <table id="tablecontent1" runat="server" style="width: 100%;">
                                <tr>
                                    <td class="auto-style6"><strong>Cost Center Name</strong></td>
                                    <td class="auto-style11">
                                        <asp:TextBox ID="txtCostCntrName" CssClass="texthieht" Width="250px" runat="server" onfocus="myfocus(this)" onblur="myblur(this)" Font-Bold="False" Font-Italic="False" ForeColor="Black" Height="25px"></asp:TextBox>
                                        <asp:RequiredFieldValidator runat="server" ID="Req" ControlToValidate="txtCostCntrName" Display="None" ErrorMessage="<b> Missing Field</b><br />Please input Cost Center name." ValidationGroup="aaa" />
                                    ...
                                    <td class="auto-style10">Heading Cosst Center Name</td>
                                    <td class="padspace">
                                        <div class="texthieht">
                                      <asp:DropDownList ID="ddlHeadingCost" Width="250px" runat="server" TabIndex="1"></asp:DropDownList>
                                      <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1" ControlToValidate="ddlHeadingCost" InitialValue="Please select..." Display="None" ErrorMessage="<b> Missing Field</b><br />Please select Heading Cosst Center Name." ValidationGroup="aaa" />
                                ...
                                <tr>
                                    <td class="auto-style3"><span class="auto-style9">Department</span></td>
                                    <td class="auto-style11">
                                       
                                        <asp:DropDownList ID="ddlDeparment" Width="250px" runat="server" TabIndex="2"></asp:DropDownList>
                                        <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator2" ControlToValidate="ddlDeparment" InitialValue="Please select..." Display="None" ErrorMessage="<b> Missing Field</b><br />Please Select Department." ValidationGroup="aaa" />
                                ...
                                <tr>
                                    ...
                                    <td class="padspace">
                                        <asp:TextBox ID="txtSystemDate" CssClass="form-control texthieht" Width="250px" runat="server" Font-Bold="False" Font-Italic="False" ForeColor="Black" TabIndex="5"></asp:TextBox>
                                    </td>
                                </tr>
                ...
                <div class="modal-body">
                    ...
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td>
                               <%-- <asp:TextBox ID="txtEdit_CostCenterName" CssClass="form-control gap" runat="server"></asp:TextBox>--%>
                                <asp:DropDownList ID="txtEdit_CostCenterName" CssClass="form-control select2" Width="100%" runat="server"></asp:DropDownList>
                               
                                </td>
                            </tr>
                        <tr><td><strong>Heading Cost Center Name :</strong> </td>
                            <td>
                               <%-- <asp:TextBox ID="txtEdit_HeadingCostCenterName" CssClass="form-control gap" runat="server"></asp:TextBox>--%>
                                <asp:DropDownList ID="txtEdit_HeadingCostCenterName" CssClass="form-control select2" Width="100%" runat="server"></asp:DropDownList>
                            </td>
                ...
                <div class="modal-body">
                    ...
                    <table style="width: 100%;">
                        <tr>
                            <td><strong>Cost Center Name</strong> </td>
                            <td>
                                <%--<asp:TextBox ID="txtFind_CostCenterName" CssClass="form-control gap" runat="server"></asp:TextBox>--%>
                                <asp:DropDownList ID="txtFind_CostCenterName" CssClass="form-control select2" Width="100%" runat="server"></asp:DropDownList>
                               
                                </td>
                            </tr>
                        <tr><td><strong>Heading Cost Center Name:</strong> </td>
                            <td>
                               <%-- <asp:TextBox ID="txtFind_HeadingCostCenterName" CssClass="form-control gap" runat="server"></asp:TextBox>--%>
                                <asp:DropDownList ID="txtFind_HeadingCostCenterName" CssClass="form-control select2" Width="100%" runat="server"></asp:DropDownList>
                            </td>
                ...
                <div class="modal-body">
                   ...
                   <table style="width: 100%;">
                        <tr>
                            <td><strong>Cost Center Name</strong> </td>
                            <td>
                                <%--<asp:TextBox ID="txtdelete_CostCenterName" CssClass="form-control gap" runat="server"></asp:TextBox>--%>
                                <asp:DropDownList ID="txtdelete_CostCenterName" CssClass="form-control select2" Width="100%" runat="server"></asp:DropDownList>
                               
                                </td>
                            </tr>
                        <tr><td><strong>Heading Cost Center Name</strong> </td>
                            <td>
                                <%--<asp:TextBox ID="txtdelete_HeadingCostCenterName" CssClass="form-control gap" runat="server"></asp:TextBox>--%>
                                <asp:DropDownList ID="txtdelete_HeadingCostCenterName" CssClass="form-control select2" Width="100%" runat="server"></asp:DropDownList>
                            </td>
